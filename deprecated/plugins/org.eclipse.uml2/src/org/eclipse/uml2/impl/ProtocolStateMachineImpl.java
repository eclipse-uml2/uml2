 ...
 *
 * $Id: ProtocolStateMachineImpl.java,v 1.16.2.1 2004/08/24 01:03:45 khussey Exp $
 */
...
public class ProtocolStateMachineImpl extends StateMachineImpl implements ProtocolStateMachine {
	...
	public EList getConformances() {
		if (conformance == null) {
			conformance = new EObjectContainmentWithInverseEList(ProtocolConformance.class, this, UML2Package.PROTOCOL_STATE_MACHINE__CONFORMANCE, UML2Package.PROTOCOL_CONFORMANCE__SPECIFIC_MACHINE);
		}
		return conformance;
	}
