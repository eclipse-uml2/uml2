 ...
 *
 * $Id: InvocationActionImpl.java,v 1.6.2.1 2004/08/24 01:03:44 khussey Exp $
 */
...
public abstract class InvocationActionImpl extends ActionImpl implements InvocationAction {
	...
	public EList getArguments() {
		if (argument == null) {
			argument = new EObjectContainmentEList(InputPin.class, this, UML2Package.INVOCATION_ACTION__ARGUMENT);
		}
		return argument;
	}
