...
public class ReclassifyObjectActionImpl extends ActionImpl implements ReclassifyObjectAction {
	...
	public EList getOldClassifiers() {
		if (oldClassifier == null) {
			oldClassifier = new EObjectResolvingEList(Classifier.class, this, UML2Package.RECLASSIFY_OBJECT_ACTION__OLD_CLASSIFIER);
		}
	...
	public EList getNewClassifiers() {
		if (newClassifier == null) {
			newClassifier = new EObjectResolvingEList(Classifier.class, this, UML2Package.RECLASSIFY_OBJECT_ACTION__NEW_CLASSIFIER);
		}
