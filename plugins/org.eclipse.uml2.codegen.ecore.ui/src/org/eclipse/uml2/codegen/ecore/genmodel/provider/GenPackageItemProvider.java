...
public class GenPackageItemProvider
	...
	protected void addResourceInterfacesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
			...
			getString("_UI_PropertyDescriptor_description", //$NON-NLS-1$
				"_UI_GenPackage_resourceInterfaces_feature", //$NON-NLS-1$
				"_UI_GenPackage_type"), //$NON-NLS-1$
			GenModelPackage.Literals.GEN_PACKAGE__RESOURCE_INTERFACES, true,
	...
	protected void addOperationsPackagePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
			...
			getString("_UI_PropertyDescriptor_description", //$NON-NLS-1$
				"_UI_GenPackage_operationsPackage_feature", //$NON-NLS-1$
				"_UI_GenPackage_type"), //$NON-NLS-1$
