...
public interface Activity extends Behavior {
   ...
   * @generated
   */
  ActivityGroup getOwnedGroup(String name, boolean ignoreCase, EClass eClass, boolean createOnDemand);
   ...
   * @generated
   */
  ActivityNode getOwnedNode(String name, boolean ignoreCase, EClass eClass, boolean createOnDemand);
   ...
   * @generated
   */
  StructuredActivityNode getStructuredNode(String name, boolean ignoreCase, EClass eClass, boolean createOnDemand);
   ...
   * @generated
   */
  boolean validateMaximumOneParameterNode(DiagnosticChain diagnostics, Map<Object, Object> context);
   ...
   * @generated
   */
  boolean validateMaximumTwoParameterNodes(DiagnosticChain diagnostics, Map<Object, Object> context);
