 ...
 * @generated
 */
public interface Class extends EncapsulatedClassifier, BehavioredClassifier, OperationOwner {
   ...
   * @generated
   */
  Reception createOwnedReception(String name, EList<String> ownedParameterNames, EList<Type> ownedParameterTypes);
   ...
   * @generated
   */
  Reception getOwnedReception(String name, EList<String> ownedParameterNames, EList<Type> ownedParameterTypes);
   ...
   * @generated
   */
  boolean validatePassiveClass(DiagnosticChain diagnostics, Map<Object, Object> context);
   ...
   * @generated
   */
  Operation createOwnedOperation(String name, EList<String> parameterNames, EList<Type> parameterTypes,
      Type returnType);
