 ...
 * @generated
 */
public interface Node extends org.eclipse.uml2.uml.Class, DeploymentTarget {
   ...
   * @generated
   */
  Node getNestedNode(String name, boolean ignoreCase, EClass eClass, boolean createOnDemand);
   ...
   * @generated
   */
  boolean validateInternalStructure(DiagnosticChain diagnostics, Map<Object, Object> context);
   ...
   * @generated
   */
  CommunicationPath createCommunicationPath(boolean end1IsNavigable, AggregationKind end1Aggregation, String end1Name,
      int end1Lower, int end1Upper, Node end1Node, boolean end2IsNavigable, AggregationKind end2Aggregation,
