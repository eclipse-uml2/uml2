 ...
 * @generated
 */
public interface OpaqueAction extends Action, BodyOwner {
   ...
   * @generated NOT
   */
  InputPin getInputValue(String name, Type type, boolean ignoreCase, EClass eClass);
   ...
   * @generated
   */
  OutputPin getOutputValue(String name, Type type, boolean ignoreCase, boolean createOnDemand);
