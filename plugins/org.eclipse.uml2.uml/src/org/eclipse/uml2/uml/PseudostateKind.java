...
public enum PseudostateKind implements Enumerator {
   ...
   * @generated
   */
  private static final PseudostateKind[] VALUES_ARRAY = new PseudostateKind[] { INITIAL_LITERAL, DEEP_HISTORY_LITERAL,
      SHALLOW_HISTORY_LITERAL, JOIN_LITERAL, FORK_LITERAL, JUNCTION_LITERAL, CHOICE_LITERAL, ENTRY_POINT_LITERAL,
      EXIT_POINT_LITERAL, TERMINATE_LITERAL, };
