 ...
 * @generated
 */
public class ReceptionOperations extends BehavioralFeatureOperations {
   ...
   * @generated
   */
  public static boolean validateSameNameAsSignal(Reception reception, DiagnosticChain diagnostics,
        ...
        diagnostics.add(new BasicDiagnostic(Diagnostic.ERROR, UMLValidator.DIAGNOSTIC_SOURCE,
            ...
            org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", //$NON-NLS-1$
                new Object[] { "validateSameNameAsSignal", //$NON-NLS-1$
                    org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(reception, context) }), new Object[] { reception }));
      }
      return false;
    }
    return true;
   ...
   * @generated
   */
  public static boolean validateSameStructureAsSignal(Reception reception, DiagnosticChain diagnostics,
      Map<Object, Object> context) {
    // TODO: implement this method
    // -> specify the condition that violates the invariant
    // -> verify the details of the diagnostic, including severity and message
