...
public class StateOperations extends NamespaceOperations {
   ...
   * @generated
   */
  public static boolean validateSubmachineStates(State state, DiagnosticChain diagnostics,
    ...
    if (false) {
      if (diagnostics != null) {
        diagnostics.add(
            new BasicDiagnostic(Diagnostic.ERROR, UMLValidator.DIAGNOSTIC_SOURCE, UMLValidator.STATE__SUBMACHINE_STATES,
                org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", //$NON-NLS-1$
                    new Object[] { "validateSubmachineStates", //$NON-NLS-1$
                        org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(state, context) }), new Object[] { state }));
      }
      return false;
    }
    return true;
   ...
   * @generated
   */
  public static boolean validateDestinationsOrSourcesOfTransitions(State state, DiagnosticChain diagnostics,
      Map<Object, Object> context) {
    // TODO: implement this method
    // -> specify the condition that violates the invariant
    // -> verify the details of the diagnostic, including severity and message
    ...
    if (false) {
      if (diagnostics != null) {
        diagnostics.add(new BasicDiagnostic(Diagnostic.ERROR, UMLValidator.DIAGNOSTIC_SOURCE,
            ...
            org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", //$NON-NLS-1$
                new Object[] { "validateDestinationsOrSourcesOfTransitions", //$NON-NLS-1$
                    org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(state, context) }), new Object[] { state }));
      }
      return false;
    }
   ...
   * @generated
   */
  public static boolean validateSubmachineOrRegions(State state, DiagnosticChain diagnostics,
      Map<Object, Object> context) {
    // TODO: implement this method
    // -> specify the condition that violates the invariant
    // -> verify the details of the diagnostic, including severity and message
   ...
   * @generated
   */
  public static boolean validateCompositeStates(State state, DiagnosticChain diagnostics, Map<Object, Object> context) {
    // TODO: implement this method
    // -> specify the condition that violates the invariant
    // -> verify the details of the diagnostic, including severity and message
    // Ensure that you remove @generated or mark it @generated NOT
    if (false) {
      if (diagnostics != null) {
        diagnostics.add(
            new BasicDiagnostic(Diagnostic.ERROR, UMLValidator.DIAGNOSTIC_SOURCE, UMLValidator.STATE__COMPOSITE_STATES,
                org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", //$NON-NLS-1$
   ...
   * @generated
   */
  public static boolean validateEntryOrExit(State state, DiagnosticChain diagnostics, Map<Object, Object> context) {
    // TODO: implement this method
    // -> specify the condition that violates the invariant
    // -> verify the details of the diagnostic, including severity and message
    // Ensure that you remove @generated or mark it @generated NOT
    if (false) {
      if (diagnostics != null) {
        diagnostics.add(
            new BasicDiagnostic(Diagnostic.ERROR, UMLValidator.DIAGNOSTIC_SOURCE, UMLValidator.STATE__ENTRY_OR_EXIT,
                org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", //$NON-NLS-1$
   ...
   * @generated NOT
   */
  public static boolean isConsistentWith(State state, RedefinableElement redefiningElement) {

    if (redefiningElement != null && redefiningElement.isRedefinitionContextValid(state)) {
      ...
      for (Region redefiningRegion : redefiningState.getRegions()) {
        ...
        if (allRegions.contains(extendedRegion) && !extendedRegion.isConsistentWith(redefiningRegion)) {
   ...
   * @generated NOT
   */
  public static boolean isRedefinitionContextValid(State state, RedefinableElement redefinedElement) {
    ...
    if (redefinedElement instanceof State) {
      ...
      if (container != null) {
        ...
        for (RedefinableElement redefinedRegion : container.getRedefinedElements()) {

          if (redefinedRegion instanceof Region
              && ((Region) redefinedRegion).getSubvertices().contains((State) redefinedElement)) {
  ...
  protected static EList<State> getAllRedefinedStates(State state, EList<State> allRedefinedStates) {
  ...
  protected static EList<State> getAllRedefinedStates(State state) {
    return getAllRedefinedStates(state, new UniqueEList.FastCompare<State>());
  }

  protected static EList<Region> getAllRegions(State state) {
    EList<Region> allRegions = new UniqueEList.FastCompare<Region>(state.getRegions());
