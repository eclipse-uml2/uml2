 ...
 * @generated
 */
public class ActionExecutionSpecificationImpl extends ExecutionSpecificationImpl
    ...
    if (action != null && action.eIsProxy()) {
      ...
      if (action != oldAction) {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, UMLPackage.ACTION_EXECUTION_SPECIFICATION__ACTION,
              oldAction, action));
      }
    }
    return action;
  ...
  public void setAction(Action newAction) {
    ...
    action = newAction;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, UMLPackage.ACTION_EXECUTION_SPECIFICATION__ACTION,
          oldAction, action));
  }
   ...
   * @generated
   */
  public boolean validateActionReferenced(DiagnosticChain diagnostics, Map<Object, Object> context) {
