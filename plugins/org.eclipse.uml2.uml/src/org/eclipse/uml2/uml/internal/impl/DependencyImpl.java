...
public class DependencyImpl extends PackageableElementImpl implements Dependency {
  ...
  public EList<Element> getRelatedElements() {
    ...
    return new DerivedUnionEObjectEList<Element>(Element.class, this, UMLPackage.DEPENDENCY__RELATED_ELEMENT,
    ...
    if (cache != null) {
      ...
      if (sources == null) {
        cache.put(eResource, this, UMLPackage.Literals.DIRECTED_RELATIONSHIP__SOURCE,
            sources = new DerivedUnionEObjectEList<Element>(Element.class, this, UMLPackage.DEPENDENCY__SOURCE,
                SOURCE_ESUBSETS));
      }
      return sources;
    }
    ...
    if (cache != null) {
      ...
      if (targets == null) {
        cache.put(eResource, this, UMLPackage.Literals.DIRECTED_RELATIONSHIP__TARGET,
            targets = new DerivedUnionEObjectEList<Element>(Element.class, this, UMLPackage.DEPENDENCY__TARGET,
                TARGET_ESUBSETS));
      }
      return targets;
    }
  ...
  public EList<NamedElement> getSuppliers() {
    if (suppliers == null) {
      suppliers = new EObjectResolvingEList<NamedElement>(NamedElement.class, this, UMLPackage.DEPENDENCY__SUPPLIER);
    }
    return suppliers;
  }
  ...
  public EList<NamedElement> getClients() {
    if (clients == null) {
      clients = new EObjectResolvingEList<NamedElement>(NamedElement.class, this, UMLPackage.DEPENDENCY__CLIENT);
    }
    return clients;
  }
