...
public class ClassifierOperations extends NamespaceOperations {
    ...
    if (classifier.allParents().contains(classifier)) {
      ...
      if (diagnostics != null) {
        diagnostics.add(new BasicDiagnostic(Diagnostic.WARNING, UMLValidator.DIAGNOSTIC_SOURCE,
            ...
            UMLPlugin.INSTANCE.getString("_UI_Classifier_NoCyclesInGeneralization_diagnostic", //$NON-NLS-1$
      ...
      if (!classifier.maySpecializeType(parent)) {
        ...
        if (diagnostics == null) {
          ...
          diagnostics.add(new BasicDiagnostic(Diagnostic.WARNING, UMLValidator.DIAGNOSTIC_SOURCE,
              ...
              UMLPlugin.INSTANCE.getString("_UI_Classifier_SpecializeType_diagnostic", //$NON-NLS-1$
                  getMessageSubstitutions(context, classifier, parent)),
        ...
        diagnostics.add(new BasicDiagnostic(Diagnostic.ERROR, UMLValidator.DIAGNOSTIC_SOURCE,
            ...
            org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", //$NON-NLS-1$
                new Object[] { "validateMapsToGeneralizationSet", //$NON-NLS-1$
                    org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(classifier, context) }), new Object[] { classifier }));
      }
      return false;
    }
    return true;
  ...
  public static Operation getOperation(Classifier classifier, String name, EList<String> parameterNames,
    ...
    operationLoop: for (Operation operation : classifier.getOperations()) {
      ...
      if (parameterNames != null && parameterNames.size() != ownedParameterListSize
      ...
      for (int j = 0; j < ownedParameterListSize; j++) {
        ...
        if (parameterNames != null && !(ignoreCase ? parameterNames.get(j).equalsIgnoreCase(ownedParameter.getName())
            : parameterNames.get(j).equals(ownedParameter.getName())))

          continue operationLoop;

        if (parameterTypes != null && !parameterTypes.get(j).equals(ownedParameter.getType()))
  ...
  protected static class GeneralEList extends DerivedSubsetEObjectEList<Object> {
    ...
    public List<Object> basicList() {
      return new GeneralEList(dataClass, owner, featureID, sourceFeatureIDs) {
  ...
  public static EList<Classifier> getGenerals(Classifier classifier) {
    return (EList<Classifier>) ((EList<?>) new GeneralEList(Classifier.class, (InternalEObject) classifier,
  ...
  public static EList<NamedElement> getInheritedMembers(Classifier classifier) {
    ...
    return new UnionEObjectEList<NamedElement>((InternalEObject) classifier,
        UMLPackage.Literals.CLASSIFIER__INHERITED_MEMBER, inherit.size(), inherit.toArray());
  }
  ...
  public static EList<Interface> directlyRealizedInterfaces(Classifier classifier) {
    return ECollections.unmodifiableEList(directlyRealizedInterfaces(classifier, true));
  }

  protected static EList<Interface> directlyRealizedInterfaces(Classifier classifier, boolean resolve) {
    return directlyRealizedInterfaces(classifier, resolve, new UniqueEList.FastCompare<Interface>());
  }
  ...
  protected static EList<Interface> directlyRealizedInterfaces(Classifier classifier, boolean resolve,
    ...
    for (Dependency clientDependency : classifier.getClientDependencies()) {
      ...
      if (clientDependency instanceof Realization) {
        Iterator<NamedElement> suppliers = resolve ? clientDependency.getSuppliers().iterator()
            : ((InternalEList<NamedElement>) clientDependency.getSuppliers()).basicIterator();
  ...
  public static EList<Interface> directlyUsedInterfaces(Classifier classifier) {
    return ECollections.unmodifiableEList(directlyUsedInterfaces(classifier, true));
  }

  protected static EList<Interface> directlyUsedInterfaces(Classifier classifier, boolean resolve) {
    return directlyUsedInterfaces(classifier, resolve, new UniqueEList.FastCompare<Interface>());
  }
  ...
  public static EList<Interface> allRealizedInterfaces(Classifier classifier) {
    return allRealizedInterfaces(classifier, true, new UniqueEList.FastCompare<Interface>());
  }

  protected static EList<Interface> allRealizedInterfaces(Classifier classifier, boolean resolve,
  ...
  public static EList<Interface> allUsedInterfaces(Classifier classifier) {
    return allUsedInterfaces(classifier, true, new UniqueEList.FastCompare<Interface>());
  }

  protected static EList<Interface> allUsedInterfaces(Classifier classifier, boolean resolve,
  ...
  public static EList<Property> allAttributes(Classifier classifier) {
    EList<Property> allAttributes = new UniqueEList.FastCompare<Property>(classifier.getAttributes());
    ...
    for (ListIterator<Property> attribute = allAttributes.listIterator(); attribute.hasNext();) {
  ...
  public static EList<StructuralFeature> allSlottableFeatures(Classifier classifier) {
    ...
    allSlottableFeatures.addAll((Collection<? extends StructuralFeature>) inherit(classifier, parentAttributes));
  ...
  public static EList<Classifier> allParents(Classifier classifier) {
    return ECollections.unmodifiableEList(allParents(classifier, new UniqueEList.FastCompare<Classifier>()));
  }
