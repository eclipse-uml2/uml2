 ...
 * @generated
 */
public class ActionInputPinOperations extends InputPinOperations {
   ...
   * @generated
   */
  public static boolean validateOneOutputPin(ActionInputPin actionInputPin, DiagnosticChain diagnostics,
        ...
        diagnostics.add(new BasicDiagnostic(Diagnostic.ERROR, UMLValidator.DIAGNOSTIC_SOURCE,
            ...
            org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", //$NON-NLS-1$
                new Object[] { "validateOneOutputPin", //$NON-NLS-1$
                    org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(actionInputPin, context) }), new Object[] { actionInputPin }));
      }
      return false;
    }
    return true;
   ...
   * @generated
   */
  public static boolean validateNoControlOrObjectFlow(ActionInputPin actionInputPin, DiagnosticChain diagnostics,
      Map<Object, Object> context) {
    // TODO: implement this method
    // -> specify the condition that violates the invariant
    // -> verify the details of the diagnostic, including severity and message
   ...
   * @generated
   */
  public static boolean validateInputPin(ActionInputPin actionInputPin, DiagnosticChain diagnostics,
      Map<Object, Object> context) {
    // TODO: implement this method
    // -> specify the condition that violates the invariant
    // -> verify the details of the diagnostic, including severity and message
