 ...
 * @generated
 */
public class CreateLinkObjectActionOperations extends CreateLinkActionOperations {
   ...
   * @generated
   */
  public static boolean validateAssociationClass(CreateLinkObjectAction createLinkObjectAction,
        ...
        diagnostics.add(new BasicDiagnostic(Diagnostic.ERROR, UMLValidator.DIAGNOSTIC_SOURCE,
            ...
            org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", //$NON-NLS-1$
                new Object[] { "validateAssociationClass", //$NON-NLS-1$
                    org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(createLinkObjectAction, context) }), new Object[] { createLinkObjectAction }));
      }
      return false;
    }
    return true;
   ...
   * @generated
   */
  public static boolean validateTypeOfResult(CreateLinkObjectAction createLinkObjectAction, DiagnosticChain diagnostics,
   ...
   * @generated
   */
  public static boolean validateMultiplicity(CreateLinkObjectAction createLinkObjectAction, DiagnosticChain diagnostics,
      Map<Object, Object> context) {
    // TODO: implement this method
    // -> specify the condition that violates the invariant
    // -> verify the details of the diagnostic, including severity and message
