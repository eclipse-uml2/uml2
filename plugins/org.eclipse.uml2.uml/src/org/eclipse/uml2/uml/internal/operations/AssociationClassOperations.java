...
public class AssociationClassOperations extends ClassOperations {
   ...
   * @generated NOT
   */
  public static boolean validateCannotBeDefined(AssociationClass associationClass, DiagnosticChain diagnostics,
    ...
    for (Type endType : associationClass.getEndTypes()) {
      ...
      if (endType == associationClass
          || (endType instanceof Classifier && ((Classifier) endType).allParents().contains(associationClass))) {
    ...
    if (!result && diagnostics != null) {
      diagnostics.add(new BasicDiagnostic(Diagnostic.WARNING, UMLValidator.DIAGNOSTIC_SOURCE,
          ...
          UMLPlugin.INSTANCE.getString("_UI_AssociationClass_CannotBeDefined_diagnostic", //$NON-NLS-1$
   ...
   * @generated NOT
   */
  public static boolean validateDisjointAttributesEnds(AssociationClass associationClass, DiagnosticChain diagnostics,
      Map<Object, Object> context) {
    ...
    if (!result && diagnostics != null) {
      diagnostics.add(new BasicDiagnostic(Diagnostic.WARNING, UMLValidator.DIAGNOSTIC_SOURCE,
          ...
          UMLPlugin.INSTANCE.getString("_UI_AssociationClass_DisjointAttributesEnds_diagnostic", //$NON-NLS-1$
              getMessageSubstitutions(context, associationClass)),
          new Object[] { associationClass }));
    }
