...
public class LinkEndDestructionDataOperations extends LinkEndDataOperations {
   ...
   * @generated
   */
  public static boolean validateDestroyAtPin(LinkEndDestructionData linkEndDestructionData, DiagnosticChain diagnostics,
        ...
        diagnostics.add(new BasicDiagnostic(Diagnostic.ERROR, UMLValidator.DIAGNOSTIC_SOURCE,
            ...
            org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", //$NON-NLS-1$
                new Object[] { "validateDestroyAtPin", //$NON-NLS-1$
                    org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(linkEndDestructionData, context) }), new Object[] { linkEndDestructionData }));
      }
      return false;
    }
    return true;
