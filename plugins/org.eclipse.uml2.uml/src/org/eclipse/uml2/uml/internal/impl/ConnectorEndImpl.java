...
public class ConnectorEndImpl extends MultiplicityElementImpl implements ConnectorEnd {
  ...
  public Property getDefiningEnd() {
    ...
    return definingEnd != null && definingEnd.eIsProxy() ? (Property) eResolveProxy((InternalEObject) definingEnd)
        : definingEnd;
  }
    ...
    if (partWithPort != null && partWithPort.eIsProxy()) {
      ...
      if (partWithPort != oldPartWithPort) {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, UMLPackage.CONNECTOR_END__PART_WITH_PORT,
  ...
  public void setPartWithPort(Property newPartWithPort) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, UMLPackage.CONNECTOR_END__PART_WITH_PORT, oldPartWithPort,
          partWithPort));
  }
