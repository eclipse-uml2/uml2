...
public class StereotypeOperations extends ClassOperations {
   ...
   * @generated
   */
  public static boolean validateBinaryAssociationsOnly(Stereotype stereotype, DiagnosticChain diagnostics,
        ...
        diagnostics.add(new BasicDiagnostic(Diagnostic.ERROR, UMLValidator.DIAGNOSTIC_SOURCE,
            ...
            org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", //$NON-NLS-1$
                new Object[] { "validateBinaryAssociationsOnly", //$NON-NLS-1$
                    org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(stereotype, context) }), new Object[] { stereotype }));
      }
      return false;
    }
    return true;
   ...
   * @generated
   */
  public static boolean validateNameNotClash(Stereotype stereotype, DiagnosticChain diagnostics,
      Map<Object, Object> context) {
    // TODO: implement this method
    // -> specify the condition that violates the invariant
    // -> verify the details of the diagnostic, including severity and message
   ...
   * @generated
   */
  public static boolean validateAssociationEndOwnership(Stereotype stereotype, DiagnosticChain diagnostics,
      Map<Object, Object> context) {
    // TODO: implement this method
    // -> specify the condition that violates the invariant
    // -> verify the details of the diagnostic, including severity and message
   ...
   * @generated
   */
  public static boolean validateBasePropertyUpperBound(Stereotype stereotype, DiagnosticChain diagnostics,
      Map<Object, Object> context) {
    // TODO: implement this method
    // -> specify the condition that violates the invariant
    // -> verify the details of the diagnostic, including severity and message
   ...
   * @generated
   */
  public static boolean validateBasePropertyMultiplicitySingleExtension(Stereotype stereotype,
    ...
    if (false) {
      if (diagnostics != null) {
        diagnostics.add(new BasicDiagnostic(Diagnostic.ERROR, UMLValidator.DIAGNOSTIC_SOURCE,
            ...
            org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", //$NON-NLS-1$
                new Object[] { "validateBasePropertyMultiplicitySingleExtension", //$NON-NLS-1$
                    org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(stereotype, context) }), new Object[] { stereotype }));
      }
      return false;
    }
   ...
   * @generated
   */
  public static boolean validateBasePropertyMultiplicityMultipleExtension(Stereotype stereotype,
      DiagnosticChain diagnostics, Map<Object, Object> context) {
    // TODO: implement this method
    // -> specify the condition that violates the invariant
    // -> verify the details of the diagnostic, including severity and message
    ...
    if (false) {
      if (diagnostics != null) {
        diagnostics.add(new BasicDiagnostic(Diagnostic.ERROR, UMLValidator.DIAGNOSTIC_SOURCE,
            ...
            org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", //$NON-NLS-1$
                new Object[] { "validateBasePropertyMultiplicityMultipleExtension", //$NON-NLS-1$
                    org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(stereotype, context) }), new Object[] { stereotype }));
      }
      return false;
    }
   ...
   * @generated
   */
  public static boolean validateGeneralize(Stereotype stereotype, DiagnosticChain diagnostics,
      Map<Object, Object> context) {
    // TODO: implement this method
    // -> specify the condition that violates the invariant
    // -> verify the details of the diagnostic, including severity and message
    ...
    if (false) {
      if (diagnostics != null) {
        diagnostics.add(
            new BasicDiagnostic(Diagnostic.ERROR, UMLValidator.DIAGNOSTIC_SOURCE, UMLValidator.STEREOTYPE__GENERALIZE,
                org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", //$NON-NLS-1$
   ...
   * @generated NOT
   */
  public static Extension createExtension(Stereotype stereotype, org.eclipse.uml2.uml.Class metaclass,
      boolean isRequired) {
    ...
    Extension extension = (Extension) stereotype.getNearestPackage().createOwnedType(metaclassName + '_' + name,
        UMLPackage.Literals.EXTENSION);

    ExtensionEnd extensionEnd = (ExtensionEnd) extension.createOwnedEnd(Extension.STEREOTYPE_ROLE_PREFIX + name,
        stereotype, UMLPackage.Literals.EXTENSION_END);
    ...
    Property property = stereotype.createOwnedAttribute(Extension.METACLASS_ROLE_PREFIX + metaclassName, metaclass);
  ...
  public static String getKeyword(Stereotype stereotype, boolean localize) {
    ...
    String keyword = getString(stereotype,
        getValidJavaIdentifier(isEmpty(qualifiedName) ? EMPTY_STRING : qualifiedName.replace(':', '_')), EMPTY_STRING,
        localize);
   ...
   * @generated NOT
   */
  public static EList<org.eclipse.uml2.uml.Class> getExtendedMetaclasses(Stereotype stereotype) {
    return ECollections.unmodifiableEList(
        getExtendedMetaclasses(stereotype, new UniqueEList.FastCompare<org.eclipse.uml2.uml.Class>()));
  }
   ...
   * @generated NOT
   */
  public static EList<org.eclipse.uml2.uml.Class> getAllExtendedMetaclasses(Stereotype stereotype) {
    EList<org.eclipse.uml2.uml.Class> allExtendedMetaclasses = getExtendedMetaclasses(stereotype,
