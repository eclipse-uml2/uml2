...
public class StartClassifierBehaviorActionImpl extends ActionImpl implements StartClassifierBehaviorAction {
    ...
    if (object != null && object.eIsProxy()) {
      ...
      if (object != oldObject) {
        ...
        NotificationChain msgs = oldObject.eInverseRemove(this,
            EOPPOSITE_FEATURE_BASE - UMLPackage.START_CLASSIFIER_BEHAVIOR_ACTION__OBJECT, null, null);
        if (newObject.eInternalContainer() == null) {
          msgs = newObject.eInverseAdd(this,
              EOPPOSITE_FEATURE_BASE - UMLPackage.START_CLASSIFIER_BEHAVIOR_ACTION__OBJECT, null, msgs);
        }
        if (msgs != null)
          msgs.dispatch();
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, UMLPackage.START_CLASSIFIER_BEHAVIOR_ACTION__OBJECT,
              oldObject, object));
      }
    }
    return object;
  ...
  public NotificationChain basicSetObject(InputPin newObject, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          UMLPackage.START_CLASSIFIER_BEHAVIOR_ACTION__OBJECT, oldObject, newObject);
      if (msgs == null)
        msgs = notification;
      else
  ...
  public void setObject(InputPin newObject) {
    if (newObject != object) {
      ...
      eNotify(new ENotificationImpl(this, Notification.SET, UMLPackage.START_CLASSIFIER_BEHAVIOR_ACTION__OBJECT,
          newObject, newObject));
  }
   ...
   * @generated
   */
  public boolean validateTypeHasClassifier(DiagnosticChain diagnostics, Map<Object, Object> context) {
  ...
  public boolean isSetInputs() {
    return super.isSetInputs() || eIsSet(UMLPackage.START_CLASSIFIER_BEHAVIOR_ACTION__OBJECT);
  }
