...
public class GateOperations extends MessageEndOperations {
        ...
        diagnostics.add(new BasicDiagnostic(Diagnostic.ERROR, UMLValidator.DIAGNOSTIC_SOURCE,
            ...
            org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", //$NON-NLS-1$
                new Object[] { "validateActualGateMatched", //$NON-NLS-1$
                    org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(gate, context) }), new Object[] { gate }));
      }
      return false;
    }
    return true;
  ...
  public static boolean validateInsideCfMatched(Gate gate, DiagnosticChain diagnostics, Map<Object, Object> context) {
    ...
    if (false) {
      if (diagnostics != null) {
        diagnostics.add(
            new BasicDiagnostic(Diagnostic.ERROR, UMLValidator.DIAGNOSTIC_SOURCE, UMLValidator.GATE__INSIDE_CF_MATCHED,
                org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", //$NON-NLS-1$
  ...
  public static boolean validateOutsideCfMatched(Gate gate, DiagnosticChain diagnostics, Map<Object, Object> context) {
    ...
    if (false) {
      if (diagnostics != null) {
        diagnostics.add(
            new BasicDiagnostic(Diagnostic.ERROR, UMLValidator.DIAGNOSTIC_SOURCE, UMLValidator.GATE__OUTSIDE_CF_MATCHED,
                org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", //$NON-NLS-1$
   ...
   * @generated
   */
  public static boolean validateFormalGateDistinguishable(Gate gate, DiagnosticChain diagnostics,
   ...
   * @generated
   */
  public static boolean validateActualGateDistinguishable(Gate gate, DiagnosticChain diagnostics,
      Map<Object, Object> context) {
    // TODO: implement this method
    // -> specify the condition that violates the invariant
    // -> verify the details of the diagnostic, including severity and message
   ...
   * @generated
   */
  public static boolean validateOutsideCfGateDistinguishable(Gate gate, DiagnosticChain diagnostics,
      Map<Object, Object> context) {
    // TODO: implement this method
    // -> specify the condition that violates the invariant
    // -> verify the details of the diagnostic, including severity and message
   ...
   * @generated
   */
  public static boolean validateInsideCfGateDistinguishable(Gate gate, DiagnosticChain diagnostics,
      Map<Object, Object> context) {
    // TODO: implement this method
    // -> specify the condition that violates the invariant
    // -> verify the details of the diagnostic, including severity and message
  ...
  public static boolean isOutsideCF(Gate gate) {
    ...
    if (oppositeEnd.size() > 0 && eContainer instanceof CombinedFragment) {
      ...
      InteractionFragment cfEnclosingInteraction = combinedFragment.getEnclosingInteraction();

      if (cfEnclosingInteraction != null) {
        cfFragments.add(cfEnclosingInteraction);
      }

      InteractionFragment cfEnclosingOperand = combinedFragment.getEnclosingOperand();
      ...
      if (oppEnd instanceof MessageOccurrenceSpecification) {
        ...
        InteractionFragment oppEnclosingInteraction = oppMOS.getEnclosingInteraction();

        if (oppEnclosingInteraction != null) {
          oppFragments.add(oppEnclosingInteraction);
        }

        InteractionFragment oppEnclosingOperand = oppMOS.getEnclosingOperand();
        ...
        if (oppGateEContainer instanceof CombinedFragment) {
          ...
          InteractionFragment oppEnclosingInteraction = oppGateCF.getEnclosingInteraction();

          if (oppEnclosingInteraction != null) {
            oppFragments.add(oppEnclosingInteraction);
          }

          InteractionFragment oppEnclosingOperand = oppGateCF.getEnclosingOperand();
  ...
  public static boolean isInsideCF(Gate gate) {
    ...
    if (oppositeEnd.size() > 0 && eContainer instanceof CombinedFragment) {
      ...
      if (oppEnd instanceof MessageOccurrenceSpecification) {
        InteractionFragment oppEnclosingOperand = ((MessageOccurrenceSpecification) oppEnd).getEnclosingOperand();
        ...
        if (oppGateEContainer instanceof CombinedFragment) {
          InteractionFragment oppEnclosingOperand = ((CombinedFragment) oppGateEContainer).getEnclosingOperand();
    ...
    if (safeEquals(gate.getName(), gateToMatch.getName())) {
      ...
      if (message == null) {
        ...
        if (messageToMatch == null) {
          ...
          return safeEquals(message.getMessageSort(), messageToMatch.getMessageSort())
              && safeEquals(message.getName(), messageToMatch.getName())
              && (message.getSendEvent() == gate ? messageToMatch.getReceiveEvent() == gateToMatch : true)
              && (message.getReceiveEvent() == gate ? messageToMatch.getSendEvent() == gateToMatch : true)
              && safeEquals(message.getSignature(), messageToMatch.getSignature());
        }
      }
    }
