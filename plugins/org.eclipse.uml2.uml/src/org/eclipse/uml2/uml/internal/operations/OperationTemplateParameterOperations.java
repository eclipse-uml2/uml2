 ...
 * @generated
 */
public class OperationTemplateParameterOperations extends TemplateParameterOperations {
   ...
   * @generated
   */
  public static boolean validateMatchDefaultSignature(OperationTemplateParameter operationTemplateParameter,
        ...
        diagnostics.add(new BasicDiagnostic(Diagnostic.ERROR, UMLValidator.DIAGNOSTIC_SOURCE,
            ...
            org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", //$NON-NLS-1$
                new Object[] { "validateMatchDefaultSignature", //$NON-NLS-1$
                    org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(operationTemplateParameter, context) }), new Object[] { operationTemplateParameter }));
      }
      return false;
    }
    return true;
