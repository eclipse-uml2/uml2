...
public class ConnectorImpl extends FeatureImpl implements Connector {
  ...
  public EList<Element> getOwnedElements() {
    ...
    return new DerivedUnionEObjectEList<Element>(Element.class, this, UMLPackage.CONNECTOR__OWNED_ELEMENT,
  ...
  public EList<Connector> getRedefinedConnectors() {
    if (redefinedConnectors == null) {
      redefinedConnectors = new EObjectResolvingEList<Connector>(Connector.class, this,
  ...
  public EList<ConnectorEnd> getEnds() {
    if (ends == null) {
      ends = new EObjectContainmentEList.Resolving<ConnectorEnd>(ConnectorEnd.class, this, UMLPackage.CONNECTOR__END);
    }
    return ends;
  }
  ...
  public EList<Behavior> getContracts() {
    if (contracts == null) {
      contracts = new EObjectResolvingEList<Behavior>(Behavior.class, this, UMLPackage.CONNECTOR__CONTRACT);
    }
    return contracts;
  }
