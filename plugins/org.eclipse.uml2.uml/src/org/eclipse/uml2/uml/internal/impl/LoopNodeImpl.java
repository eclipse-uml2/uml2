...
public class LoopNodeImpl extends StructuredActivityNodeImpl implements LoopNode {
  ...
  public EList<Element> getOwnedElements() {
    ...
    return new DerivedUnionEObjectEList<Element>(Element.class, this, UMLPackage.LOOP_NODE__OWNED_ELEMENT,
   ...
   * @ordered
   */
  protected static final int[] OWNED_ELEMENT_ESUBSETS = new int[] { UMLPackage.LOOP_NODE__OWNED_COMMENT,
      UMLPackage.LOOP_NODE__NAME_EXPRESSION, UMLPackage.LOOP_NODE__HANDLER, UMLPackage.LOOP_NODE__INPUT,
      UMLPackage.LOOP_NODE__LOCAL_POSTCONDITION, UMLPackage.LOOP_NODE__LOCAL_PRECONDITION, UMLPackage.LOOP_NODE__OUTPUT,
      UMLPackage.LOOP_NODE__ELEMENT_IMPORT, UMLPackage.LOOP_NODE__PACKAGE_IMPORT, UMLPackage.LOOP_NODE__OWNED_MEMBER,
      UMLPackage.LOOP_NODE__SUBGROUP, UMLPackage.LOOP_NODE__EDGE, UMLPackage.LOOP_NODE__NODE,
  ...
  public void setIsTestedFirst(boolean newIsTestedFirst) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, UMLPackage.LOOP_NODE__IS_TESTED_FIRST, oldIsTestedFirst,
          newIsTestedFirst));
  }
  ...
  public EList<ExecutableNode> getBodyParts() {
    if (bodyParts == null) {
      bodyParts = new EObjectResolvingEList<ExecutableNode>(ExecutableNode.class, this,
   ...
   * @generated
   */
  public ExecutableNode getBodyPart(String name, boolean ignoreCase, EClass eClass) {
  ...
  public EList<ExecutableNode> getSetupParts() {
    if (setupParts == null) {
      setupParts = new EObjectResolvingEList<ExecutableNode>(ExecutableNode.class, this,
   ...
   * @generated
   */
  public ExecutableNode getSetupPart(String name, boolean ignoreCase, EClass eClass) {
  ...
  public OutputPin getDecider() {
    if (decider != null && decider.eIsProxy()) {
      ...
      if (decider != oldDecider) {
        if (eNotificationRequired())
          eNotify(
              new ENotificationImpl(this, Notification.RESOLVE, UMLPackage.LOOP_NODE__DECIDER, oldDecider, decider));
      }
    }
    return decider;
  }
  ...
  public EList<ExecutableNode> getTests() {
    if (tests == null) {
      tests = new EObjectResolvingEList<ExecutableNode>(ExecutableNode.class, this, UMLPackage.LOOP_NODE__TEST);
    }
    return tests;
  }
  ...
  public EList<OutputPin> getResults() {
    if (results == null) {
      results = new EObjectContainmentEList.Resolving<OutputPin>(OutputPin.class, this, UMLPackage.LOOP_NODE__RESULT);
    }
    return results;
  }
  ...
  public EList<OutputPin> getLoopVariables() {
    if (loopVariables == null) {
      loopVariables = new EObjectContainmentEList.Resolving<OutputPin>(OutputPin.class, this,
          UMLPackage.LOOP_NODE__LOOP_VARIABLE);
    }
   ...
   * @generated
   */
  public OutputPin getLoopVariable(String name, Type type, boolean ignoreCase, boolean createOnDemand) {
    loopVariableLoop: for (OutputPin loopVariable : getLoopVariables()) {
      if (name != null
          && !(ignoreCase ? name.equalsIgnoreCase(loopVariable.getName()) : name.equals(loopVariable.getName())))
  ...
  public EList<OutputPin> getBodyOutputs() {
    if (bodyOutputs == null) {
      bodyOutputs = new EObjectResolvingEList<OutputPin>(OutputPin.class, this, UMLPackage.LOOP_NODE__BODY_OUTPUT);
    }
    return bodyOutputs;
  }
  ...
  public OutputPin getBodyOutput(String name, Type type, boolean ignoreCase) {
    bodyOutputLoop: for (OutputPin bodyOutput : getBodyOutputs()) {
      if (name != null
          && !(ignoreCase ? name.equalsIgnoreCase(bodyOutput.getName()) : name.equals(bodyOutput.getName())))
  ...
  public EList<InputPin> getLoopVariableInputs() {
    if (loopVariableInputs == null) {
      loopVariableInputs = new EObjectContainmentEList.Resolving<InputPin>(InputPin.class, this,
   ...
   * @generated
   */
  public InputPin createLoopVariableInput(String name, Type type, EClass eClass) {
   ...
   * @generated
   */
  public InputPin getLoopVariableInput(String name, Type type, boolean ignoreCase, EClass eClass,
    ...
    loopVariableInputLoop: for (InputPin loopVariableInput : getLoopVariableInputs()) {
      ...
      if (name != null && !(ignoreCase ? name.equalsIgnoreCase(loopVariableInput.getName())
   ...
   * @generated
   */
  public boolean validateInputEdges(DiagnosticChain diagnostics, Map<Object, Object> context) {
   ...
   * @generated
   */
  public boolean validateExecutableNodes(DiagnosticChain diagnostics, Map<Object, Object> context) {
   ...
   * @generated
   */
  public boolean validateBodyOutputPins(DiagnosticChain diagnostics, Map<Object, Object> context) {
   ...
   * @generated
   */
  public boolean validateSetupTestAndBody(DiagnosticChain diagnostics, Map<Object, Object> context) {
   ...
   * @generated
   */
  public boolean validateMatchingOutputPins(DiagnosticChain diagnostics, Map<Object, Object> context) {
   ...
   * @generated
   */
  public boolean validateMatchingLoopVariables(DiagnosticChain diagnostics, Map<Object, Object> context) {
   ...
   * @generated
   */
  public boolean validateMatchingResultPins(DiagnosticChain diagnostics, Map<Object, Object> context) {
   ...
   * @generated
   */
  public boolean validateLoopVariableOutgoing(DiagnosticChain diagnostics, Map<Object, Object> context) {
   ...
   * @generated
   */
  public boolean validateResultNoIncoming(DiagnosticChain diagnostics, Map<Object, Object> context) {
  ...
  public boolean isSetOwnedElements() {
    return super.isSetOwnedElements() || eIsSet(UMLPackage.LOOP_NODE__LOOP_VARIABLE);
  }
    ...
    if (cache != null) {
      ...
      if (inputs == null) {
        cache.put(eResource, this, UMLPackage.Literals.ACTION__INPUT,
            inputs = new DerivedUnionEObjectEList<InputPin>(InputPin.class, this, UMLPackage.LOOP_NODE__INPUT,
                INPUT_ESUBSETS));
      }
      return inputs;
    }
    return new DerivedUnionEObjectEList<InputPin>(InputPin.class, this, UMLPackage.LOOP_NODE__INPUT, INPUT_ESUBSETS);
  }
    ...
    if (cache != null) {
      ...
      if (outputs == null) {
        cache.put(eResource, this, UMLPackage.Literals.ACTION__OUTPUT,
            outputs = new DerivedUnionEObjectEList<OutputPin>(OutputPin.class, this, UMLPackage.LOOP_NODE__OUTPUT,
                OUTPUT_ESUBSETS));
      }
      return outputs;
    }
    return new DerivedUnionEObjectEList<OutputPin>(OutputPin.class, this, UMLPackage.LOOP_NODE__OUTPUT,
        OUTPUT_ESUBSETS);
  }
