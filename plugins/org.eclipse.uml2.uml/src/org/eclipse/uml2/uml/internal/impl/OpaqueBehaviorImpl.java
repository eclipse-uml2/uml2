...
public class OpaqueBehaviorImpl extends BehaviorImpl implements OpaqueBehavior {
  ...
  public EList<String> getBodies() {
    if (bodies == null) {
      bodies = new EDataTypeEList.Unsettable<String>(String.class, this, UMLPackage.OPAQUE_BEHAVIOR__BODY);
    }
    return bodies;
  }
  ...
  public EList<String> getLanguages() {
    if (languages == null) {
      languages = new EDataTypeUniqueEList.Unsettable<String>(String.class, this, UMLPackage.OPAQUE_BEHAVIOR__LANGUAGE);
    }
    return languages;
  }
