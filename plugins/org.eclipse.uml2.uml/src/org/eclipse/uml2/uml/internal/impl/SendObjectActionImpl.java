...
public class SendObjectActionImpl extends InvocationActionImpl implements SendObjectAction {
    ...
    if (cache != null) {
      ...
      if (inputs == null) {
        cache.put(eResource, this, UMLPackage.Literals.ACTION__INPUT,
            inputs = new DerivedUnionEObjectEList<InputPin>(InputPin.class, this, UMLPackage.SEND_OBJECT_ACTION__INPUT,
                INPUT_ESUBSETS));
      }
      return inputs;
    }
    return new DerivedUnionEObjectEList<InputPin>(InputPin.class, this, UMLPackage.SEND_OBJECT_ACTION__INPUT,
        INPUT_ESUBSETS);
  }
    ...
    if (target != null && target.eIsProxy()) {
      ...
      if (target != oldTarget) {
        ...
        NotificationChain msgs = oldTarget.eInverseRemove(this,
            EOPPOSITE_FEATURE_BASE - UMLPackage.SEND_OBJECT_ACTION__TARGET, null, null);
        if (newTarget.eInternalContainer() == null) {
          msgs = newTarget.eInverseAdd(this, EOPPOSITE_FEATURE_BASE - UMLPackage.SEND_OBJECT_ACTION__TARGET, null,
              msgs);
        }
        if (msgs != null)
          msgs.dispatch();
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, UMLPackage.SEND_OBJECT_ACTION__TARGET, oldTarget,
              target));
      }
    }
    return target;
  ...
  public NotificationChain basicSetTarget(InputPin newTarget, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          UMLPackage.SEND_OBJECT_ACTION__TARGET, oldTarget, newTarget);
      if (msgs == null)
        msgs = notification;
      else
    ...
    if (newTarget != target) {
      ...
      if (target != null)
        msgs = ((InternalEObject) target).eInverseRemove(this,
            EOPPOSITE_FEATURE_BASE - UMLPackage.SEND_OBJECT_ACTION__TARGET, null, msgs);
      if (newTarget != null)
      ...
      eNotify(
          new ENotificationImpl(this, Notification.SET, UMLPackage.SEND_OBJECT_ACTION__TARGET, newTarget, newTarget));
  }
   ...
   * @generated
   */
  public boolean validateTypeTargetPin(DiagnosticChain diagnostics, Map<Object, Object> context) {
    ...
    if (request != null && request.eIsProxy()) {
      ...
      if (request != oldRequest) {
        ...
        NotificationChain msgs = oldRequest.eInverseRemove(this,
            EOPPOSITE_FEATURE_BASE - UMLPackage.SEND_OBJECT_ACTION__REQUEST, null, null);
        if (newRequest.eInternalContainer() == null) {
          msgs = newRequest.eInverseAdd(this, EOPPOSITE_FEATURE_BASE - UMLPackage.SEND_OBJECT_ACTION__REQUEST, null,
              msgs);
        }
        if (msgs != null)
          msgs.dispatch();
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, UMLPackage.SEND_OBJECT_ACTION__REQUEST, oldRequest,
              request));
      }
    }
    return request;
  ...
  public NotificationChain basicSetRequest(InputPin newRequest, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          UMLPackage.SEND_OBJECT_ACTION__REQUEST, oldRequest, newRequest);
      if (msgs == null)
        msgs = notification;
      else
        msgs.add(notification);
    ...
    if (newRequest != request) {
      ...
      if (request != null)
        msgs = ((InternalEObject) request).eInverseRemove(this,
            EOPPOSITE_FEATURE_BASE - UMLPackage.SEND_OBJECT_ACTION__REQUEST, null, msgs);
      if (newRequest != null)
      ...
      eNotify(new ENotificationImpl(this, Notification.SET, UMLPackage.SEND_OBJECT_ACTION__REQUEST, newRequest,
          newRequest));
  }
   ...
   * @ordered
   */
  protected static final int[] INPUT_ESUBSETS = new int[] { UMLPackage.SEND_OBJECT_ACTION__ARGUMENT,
  ...
  public boolean isSetInputs() {
    return super.isSetInputs() || eIsSet(UMLPackage.SEND_OBJECT_ACTION__TARGET);
  }
  ...
  public EList<InputPin> getArguments() {
    ...
    return new UnionEObjectEList<InputPin>(this, UMLPackage.Literals.INVOCATION_ACTION__ARGUMENT, argument.size(),
        argument.toArray());
  }
