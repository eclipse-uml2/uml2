...
public class ClauseImpl extends ElementImpl implements Clause {
  ...
  public EList<ExecutableNode> getTests() {
    if (tests == null) {
      tests = new EObjectResolvingEList<ExecutableNode>(ExecutableNode.class, this, UMLPackage.CLAUSE__TEST);
    }
    return tests;
  }
  ...
  public EList<ExecutableNode> getBodies() {
    if (bodies == null) {
      bodies = new EObjectResolvingEList<ExecutableNode>(ExecutableNode.class, this, UMLPackage.CLAUSE__BODY);
    }
    return bodies;
  }
  ...
  public EList<Clause> getPredecessorClauses() {
    if (predecessorClauses == null) {
      predecessorClauses = new EObjectWithInverseResolvingEList.ManyInverse<Clause>(Clause.class, this,
          UMLPackage.CLAUSE__PREDECESSOR_CLAUSE, UMLPackage.CLAUSE__SUCCESSOR_CLAUSE);
    }
  ...
  public EList<Clause> getSuccessorClauses() {
    if (successorClauses == null) {
      successorClauses = new EObjectWithInverseResolvingEList.ManyInverse<Clause>(Clause.class, this,
          UMLPackage.CLAUSE__SUCCESSOR_CLAUSE, UMLPackage.CLAUSE__PREDECESSOR_CLAUSE);
    }
  ...
  public EList<OutputPin> getBodyOutputs() {
    if (bodyOutputs == null) {
      bodyOutputs = new EObjectResolvingEList<OutputPin>(OutputPin.class, this, UMLPackage.CLAUSE__BODY_OUTPUT);
    }
    return bodyOutputs;
  }
   ...
   * @generated
   */
  public boolean validateDeciderOutput(DiagnosticChain diagnostics, Map<Object, Object> context) {
   ...
   * @generated
   */
  public boolean validateTestAndBody(DiagnosticChain diagnostics, Map<Object, Object> context) {
