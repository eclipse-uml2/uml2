...
public class ExtendImpl extends NamedElementImpl implements Extend {
  ...
  public EList<Element> getRelatedElements() {
    ...
    return new DerivedUnionEObjectEList<Element>(Element.class, this, UMLPackage.EXTEND__RELATED_ELEMENT,
    ...
    if (cache != null) {
      ...
      if (sources == null) {
        cache.put(eResource, this, UMLPackage.Literals.DIRECTED_RELATIONSHIP__SOURCE,
            sources = new DerivedUnionEObjectEList<Element>(Element.class, this, UMLPackage.EXTEND__SOURCE,
                SOURCE_ESUBSETS));
      }
      return sources;
    }
    ...
    if (cache != null) {
      ...
      if (targets == null) {
        cache.put(eResource, this, UMLPackage.Literals.DIRECTED_RELATIONSHIP__TARGET,
            targets = new DerivedUnionEObjectEList<Element>(Element.class, this, UMLPackage.EXTEND__TARGET,
                TARGET_ESUBSETS));
      }
      return targets;
    }
    ...
    if (cache != null) {
      ...
      if (ownedElements == null) {
        cache.put(eResource, this, UMLPackage.Literals.ELEMENT__OWNED_ELEMENT,
            ownedElements = new DerivedUnionEObjectEList<Element>(Element.class, this, UMLPackage.EXTEND__OWNED_ELEMENT,
                OWNED_ELEMENT_ESUBSETS));
      }
      return ownedElements;
    }
    return new DerivedUnionEObjectEList<Element>(Element.class, this, UMLPackage.EXTEND__OWNED_ELEMENT,
        OWNED_ELEMENT_ESUBSETS);
  }
    ...
    if (extendedCase != null && extendedCase.eIsProxy()) {
      ...
      if (extendedCase != oldExtendedCase) {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, UMLPackage.EXTEND__EXTENDED_CASE, oldExtendedCase,
              extendedCase));
      }
    }
    return extendedCase;
  ...
  public void setExtendedCase(UseCase newExtendedCase) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, UMLPackage.EXTEND__EXTENDED_CASE, oldExtendedCase,
          extendedCase));
  }
    ...
    if (condition != null && condition.eIsProxy()) {
      ...
      if (condition != oldCondition) {
        ...
        NotificationChain msgs = oldCondition.eInverseRemove(this,
            EOPPOSITE_FEATURE_BASE - UMLPackage.EXTEND__CONDITION, null, null);
        if (newCondition.eInternalContainer() == null) {
          msgs = newCondition.eInverseAdd(this, EOPPOSITE_FEATURE_BASE - UMLPackage.EXTEND__CONDITION, null, msgs);
        }
        if (msgs != null)
          msgs.dispatch();
        if (eNotificationRequired())
          eNotify(
              new ENotificationImpl(this, Notification.RESOLVE, UMLPackage.EXTEND__CONDITION, oldCondition, condition));
      }
    }
    return condition;
  }
  ...
  public NotificationChain basicSetCondition(Constraint newCondition, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, UMLPackage.EXTEND__CONDITION,
  ...
  public void setCondition(Constraint newCondition) {
    if (newCondition != condition) {
      ...
      if (condition != null)
        msgs = ((InternalEObject) condition).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - UMLPackage.EXTEND__CONDITION,
            null, msgs);
      if (newCondition != null)
        msgs = ((InternalEObject) newCondition).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - UMLPackage.EXTEND__CONDITION,
            null, msgs);
  ...
  public EList<ExtensionPoint> getExtensionLocations() {
    if (extensionLocations == null) {
      extensionLocations = new EObjectResolvingEList<ExtensionPoint>(ExtensionPoint.class, this,
  ...
  public ExtensionPoint getExtensionLocation(String name, boolean ignoreCase) {
    extensionLocationLoop: for (ExtensionPoint extensionLocation : getExtensionLocations()) {
      if (name != null && !(ignoreCase ? name.equalsIgnoreCase(extensionLocation.getName())
   ...
   * @generated
   */
  public boolean validateExtensionPoints(DiagnosticChain diagnostics, Map<Object, Object> context) {
   ...
   * @ordered
   */
  protected static final int[] RELATED_ELEMENT_ESUBSETS = new int[] { UMLPackage.EXTEND__SOURCE,
   ...
   * @ordered
   */
  protected static final int[] OWNED_ELEMENT_ESUBSETS = new int[] { UMLPackage.EXTEND__OWNED_COMMENT,
      UMLPackage.EXTEND__NAME_EXPRESSION, UMLPackage.EXTEND__CONDITION };
  ...
  public boolean isSetOwnedElements() {
    return super.isSetOwnedElements() || eIsSet(UMLPackage.EXTEND__CONDITION);
  }
