 ...
 * @generated
 */
public class TimeEventOperations extends PackageableElementOperations {
   ...
   * @generated
   */
  public static boolean validateWhenNonNegative(TimeEvent timeEvent, DiagnosticChain diagnostics,
        ...
        diagnostics.add(new BasicDiagnostic(Diagnostic.ERROR, UMLValidator.DIAGNOSTIC_SOURCE,
            ...
            org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", //$NON-NLS-1$
                new Object[] { "validateWhenNonNegative", //$NON-NLS-1$
                    org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(timeEvent, context) }), new Object[] { timeEvent }));
      }
      return false;
    }
    return true;
