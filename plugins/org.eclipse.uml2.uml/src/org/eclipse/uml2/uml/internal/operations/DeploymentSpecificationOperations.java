 ...
 * @generated
 */
public class DeploymentSpecificationOperations extends ArtifactOperations {
   ...
   * @generated
   */
  public static boolean validateDeployedElements(DeploymentSpecification deploymentSpecification,
        ...
        diagnostics.add(new BasicDiagnostic(Diagnostic.ERROR, UMLValidator.DIAGNOSTIC_SOURCE,
            ...
            org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", //$NON-NLS-1$
                new Object[] { "validateDeployedElements", //$NON-NLS-1$
                    org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(deploymentSpecification, context) }), new Object[] { deploymentSpecification }));
      }
      return false;
    }
    return true;
   ...
   * @generated
   */
  public static boolean validateDeploymentTarget(DeploymentSpecification deploymentSpecification,
      DiagnosticChain diagnostics, Map<Object, Object> context) {
    // TODO: implement this method
    // -> specify the condition that violates the invariant
    // -> verify the details of the diagnostic, including severity and message
