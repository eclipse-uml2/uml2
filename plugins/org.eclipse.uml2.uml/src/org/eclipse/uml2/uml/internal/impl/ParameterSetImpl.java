...
public class ParameterSetImpl extends NamedElementImpl implements ParameterSet {
  ...
  public EList<Element> getOwnedElements() {
    ...
    return new DerivedUnionEObjectEList<Element>(Element.class, this, UMLPackage.PARAMETER_SET__OWNED_ELEMENT,
  ...
  public EList<Parameter> getParameters() {
    if (parameters == null) {
      parameters = new EObjectWithInverseResolvingEList.ManyInverse<Parameter>(Parameter.class, this,
          UMLPackage.PARAMETER_SET__PARAMETER, UMLPackage.PARAMETER__PARAMETER_SET);
    }
    return parameters;
  }
  ...
  public EList<Constraint> getConditions() {
    if (conditions == null) {
      conditions = new EObjectContainmentEList.Resolving<Constraint>(Constraint.class, this,
   ...
   * @generated
   */
  public Constraint getCondition(String name, boolean ignoreCase, EClass eClass, boolean createOnDemand) {
   ...
   * @generated
   */
  public boolean validateSameParameterizedEntity(DiagnosticChain diagnostics, Map<Object, Object> context) {
   ...
   * @generated
   */
  public boolean validateInput(DiagnosticChain diagnostics, Map<Object, Object> context) {
   ...
   * @generated
   */
  public boolean validateTwoParameterSets(DiagnosticChain diagnostics, Map<Object, Object> context) {
  ...
  public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
    ...
    case UMLPackage.PARAMETER_SET___VALIDATE_SAME_PARAMETERIZED_ENTITY__DIAGNOSTICCHAIN_MAP:
      return validateSameParameterizedEntity((DiagnosticChain) arguments.get(0),
          (Map<Object, Object>) arguments.get(1));
   ...
   * @ordered
   */
  protected static final int[] OWNED_ELEMENT_ESUBSETS = new int[] { UMLPackage.PARAMETER_SET__OWNED_COMMENT,
      UMLPackage.PARAMETER_SET__NAME_EXPRESSION, UMLPackage.PARAMETER_SET__CONDITION };
  ...
  public boolean isSetOwnedElements() {
    return super.isSetOwnedElements() || eIsSet(UMLPackage.PARAMETER_SET__CONDITION);
  }
