...
public class RemoveVariableValueActionImpl extends WriteVariableActionImpl implements RemoveVariableValueAction {
  ...
  public EList<InputPin> getInputs() {
    ...
    return new DerivedUnionEObjectEList<InputPin>(InputPin.class, this, UMLPackage.REMOVE_VARIABLE_VALUE_ACTION__INPUT,
        INPUT_ESUBSETS);
  }
  ...
  public void setIsRemoveDuplicates(boolean newIsRemoveDuplicates) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET,
          UMLPackage.REMOVE_VARIABLE_VALUE_ACTION__IS_REMOVE_DUPLICATES, oldIsRemoveDuplicates, newIsRemoveDuplicates));
  }
    ...
    if (removeAt != null && removeAt.eIsProxy()) {
      ...
      if (removeAt != oldRemoveAt) {
        ...
        NotificationChain msgs = oldRemoveAt.eInverseRemove(this,
            EOPPOSITE_FEATURE_BASE - UMLPackage.REMOVE_VARIABLE_VALUE_ACTION__REMOVE_AT, null, null);
        if (newRemoveAt.eInternalContainer() == null) {
          msgs = newRemoveAt.eInverseAdd(this,
              EOPPOSITE_FEATURE_BASE - UMLPackage.REMOVE_VARIABLE_VALUE_ACTION__REMOVE_AT, null, msgs);
        }
        if (msgs != null)
          msgs.dispatch();
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, UMLPackage.REMOVE_VARIABLE_VALUE_ACTION__REMOVE_AT,
  ...
  public NotificationChain basicSetRemoveAt(InputPin newRemoveAt, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          UMLPackage.REMOVE_VARIABLE_VALUE_ACTION__REMOVE_AT, oldRemoveAt, newRemoveAt);
      if (msgs == null)
        msgs = notification;
      else
  ...
  public void setRemoveAt(InputPin newRemoveAt) {
    if (newRemoveAt != removeAt) {
      ...
      eNotify(new ENotificationImpl(this, Notification.SET, UMLPackage.REMOVE_VARIABLE_VALUE_ACTION__REMOVE_AT,
   ...
   * @ordered
   */
  protected static final int[] INPUT_ESUBSETS = new int[] { UMLPackage.REMOVE_VARIABLE_VALUE_ACTION__VALUE,
  ...
  public boolean isSetInputs() {
    return super.isSetInputs() || eIsSet(UMLPackage.REMOVE_VARIABLE_VALUE_ACTION__REMOVE_AT);
  }
