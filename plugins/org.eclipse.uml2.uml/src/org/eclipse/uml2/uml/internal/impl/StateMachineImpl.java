...
public class StateMachineImpl extends BehaviorImpl implements StateMachine {
  ...
  public EList<NamedElement> getOwnedMembers() {
    ...
    return new DerivedUnionEObjectEList<NamedElement>(NamedElement.class, this, UMLPackage.STATE_MACHINE__OWNED_MEMBER,
  ...
  public EList<Region> getRegions() {
    if (regions == null) {
      regions = new EObjectContainmentWithInverseEList.Resolving<Region>(Region.class, this,
          UMLPackage.STATE_MACHINE__REGION, UMLPackage.REGION__STATE_MACHINE);
    }
    return regions;
  }
  ...
  public EList<State> getSubmachineStates() {
    if (submachineStates == null) {
      submachineStates = new EObjectWithInverseResolvingEList<State>(State.class, this,
  ...
  public State getSubmachineState(String name, boolean ignoreCase, EClass eClass) {
    submachineStateLoop: for (State submachineState : getSubmachineStates()) {
      ...
      if (name != null
          && !(ignoreCase ? name.equalsIgnoreCase(submachineState.getName()) : name.equals(submachineState.getName())))
        continue submachineStateLoop;
  ...
  public EList<Pseudostate> getConnectionPoints() {
    if (connectionPoints == null) {
      connectionPoints = new EObjectContainmentWithInverseEList.Resolving<Pseudostate>(Pseudostate.class, this,
          UMLPackage.STATE_MACHINE__CONNECTION_POINT, UMLPackage.PSEUDOSTATE__STATE_MACHINE);
    }
  ...
  private EList<StateMachine> createExtendedStateMachinesList() {
    return new SubsetSupersetEObjectResolvingEList<StateMachine>(StateMachine.class, this,
        UMLPackage.STATE_MACHINE__EXTENDED_STATE_MACHINE, EXTENDED_STATE_MACHINE_ESUPERSETS, null);
  }
  ...
  public StateMachine getExtendedStateMachine(String name, boolean ignoreCase, EClass eClass) {
    extendedStateMachineLoop: for (StateMachine extendedStateMachine : getExtendedStateMachines()) {
      ...
      if (name != null && !(ignoreCase ? name.equalsIgnoreCase(extendedStateMachine.getName())
   ...
   * @generated
   */
  public boolean validateClassifierContext(DiagnosticChain diagnostics, Map<Object, Object> context) {
   ...
   * @generated
   */
  public boolean validateContextClassifier(DiagnosticChain diagnostics, Map<Object, Object> context) {
   ...
   * @generated
   */
  public boolean validateConnectionPoints(DiagnosticChain diagnostics, Map<Object, Object> context) {
   ...
   * @generated
   */
  public boolean validateMethod(DiagnosticChain diagnostics, Map<Object, Object> context) {
    ...
    case UMLPackage.STATE_MACHINE__OWNED_TEMPLATE_SIGNATURE:
      if (ownedTemplateSignature != null)
        msgs = ((InternalEObject) ownedTemplateSignature).eInverseRemove(this,
            EOPPOSITE_FEATURE_BASE - UMLPackage.STATE_MACHINE__OWNED_TEMPLATE_SIGNATURE, null, msgs);
   ...
   * @ordered
   */
  protected static final int[] OWNED_MEMBER_ESUBSETS = new int[] { UMLPackage.STATE_MACHINE__OWNED_RULE,
      UMLPackage.STATE_MACHINE__OWNED_USE_CASE, UMLPackage.STATE_MACHINE__OWNED_ATTRIBUTE,
      UMLPackage.STATE_MACHINE__OWNED_CONNECTOR, UMLPackage.STATE_MACHINE__OWNED_BEHAVIOR,
      UMLPackage.STATE_MACHINE__OWNED_OPERATION, UMLPackage.STATE_MACHINE__NESTED_CLASSIFIER,
      UMLPackage.STATE_MACHINE__OWNED_RECEPTION, UMLPackage.STATE_MACHINE__OWNED_PARAMETER,
      UMLPackage.STATE_MACHINE__OWNED_PARAMETER_SET, UMLPackage.STATE_MACHINE__CONNECTION_POINT,
  ...
  private EList<Classifier> createRedefinedClassifiersList() {
    return new SubsetSupersetEObjectResolvingEList<Classifier>(Classifier.class, this,
        UMLPackage.STATE_MACHINE__REDEFINED_CLASSIFIER, null, REDEFINED_CLASSIFIER_ESUBSETS);
  }
   ...
   * @ordered
   */
  protected static final int[] REDEFINED_CLASSIFIER_ESUBSETS = new int[] { UMLPackage.STATE_MACHINE__REDEFINED_BEHAVIOR,
  ...
  public boolean isSetOwnedMembers() {
    return super.isSetOwnedMembers() || eIsSet(UMLPackage.STATE_MACHINE__CONNECTION_POINT)
