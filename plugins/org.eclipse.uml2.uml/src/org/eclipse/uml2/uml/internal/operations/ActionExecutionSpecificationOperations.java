 ...
 * @generated
 */
public class ActionExecutionSpecificationOperations extends ExecutionSpecificationOperations {
   ...
   * @generated
   */
  public static boolean validateActionReferenced(ActionExecutionSpecification actionExecutionSpecification,
        ...
        diagnostics.add(new BasicDiagnostic(Diagnostic.ERROR, UMLValidator.DIAGNOSTIC_SOURCE,
            ...
            org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", //$NON-NLS-1$
                new Object[] { "validateActionReferenced", //$NON-NLS-1$
                    org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(actionExecutionSpecification,
