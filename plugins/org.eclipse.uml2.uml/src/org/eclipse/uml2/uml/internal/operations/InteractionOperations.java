...
/**
 * <!-- begin-user-doc -->
 * A static utility class that provides operations related to '<em><b>Interaction</b></em>' model objects.
 * <!-- end-user-doc -->
 *
 * <p>
 ...
 * @generated
 */
public class InteractionOperations extends BehaviorOperations {
   ...
   * @generated
   */
  protected InteractionOperations() {
    super();
  }
   ...
   * @param interaction The receiving '<em><b>Interaction</b></em>' model object.
   * @param diagnostics The chain of diagnostics to which problems are to be appended.
   * @param context The cache of context-specific information.
   * <!-- end-model-doc -->
   * @generated
   */
  public static boolean validateNotContained(Interaction interaction, DiagnosticChain diagnostics,
        ...
        diagnostics.add(new BasicDiagnostic(Diagnostic.ERROR, UMLValidator.DIAGNOSTIC_SOURCE,
            ...
            org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", //$NON-NLS-1$
                new Object[] { "validateNotContained", //$NON-NLS-1$
                    org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(interaction, context) }), new Object[] { interaction }));
      }
      return false;
    }
    return true;
