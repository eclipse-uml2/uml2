...
public class PackageImpl extends NamespaceImpl implements org.eclipse.uml2.uml.Package {
    ...
    if (templateParameter != null && templateParameter.eIsProxy()) {
      ...
      if (templateParameter != oldTemplateParameter) {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, UMLPackage.PACKAGE__TEMPLATE_PARAMETER,
  ...
  public NotificationChain basicSetTemplateParameter(TemplateParameter newTemplateParameter, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          UMLPackage.PACKAGE__TEMPLATE_PARAMETER, oldTemplateParameter, newTemplateParameter);
      if (msgs == null)
        msgs = notification;
      else
  ...
  public void setTemplateParameter(TemplateParameter newTemplateParameter) {
    if (newTemplateParameter != templateParameter) {
      ...
      eNotify(new ENotificationImpl(this, Notification.SET, UMLPackage.PACKAGE__TEMPLATE_PARAMETER,
  ...
  public void setOwningTemplateParameter(TemplateParameter newOwningTemplateParameter) {
    if (newOwningTemplateParameter != eInternalContainer()
      ...
      eNotify(new ENotificationImpl(this, Notification.SET, UMLPackage.PACKAGE__OWNING_TEMPLATE_PARAMETER,
  ...
  public void setVisibility(VisibilityKind newVisibility) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, UMLPackage.PACKAGE__VISIBILITY, oldVisibility,
  ...
  public void unsetVisibility() {
    ...
    eFlags &= ~VISIBILITY_ESETFLAG;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.UNSET, UMLPackage.PACKAGE__VISIBILITY, oldVisibility,
  ...
  public EList<Element> getOwnedElements() {
    ...
    return new DerivedUnionEObjectEList<Element>(Element.class, this, UMLPackage.PACKAGE__OWNED_ELEMENT,
  ...
  public EList<TemplateBinding> getTemplateBindings() {
    if (templateBindings == null) {
      templateBindings = new EObjectContainmentWithInverseEList.Resolving<TemplateBinding>(TemplateBinding.class, this,
          UMLPackage.PACKAGE__TEMPLATE_BINDING, UMLPackage.TEMPLATE_BINDING__BOUND_ELEMENT);
    }
    ...
    if (ownedTemplateSignature != null && ownedTemplateSignature.eIsProxy()) {
      ...
      if (ownedTemplateSignature != oldOwnedTemplateSignature) {
        ...
        if (msgs != null)
          msgs.dispatch();
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, UMLPackage.PACKAGE__OWNED_TEMPLATE_SIGNATURE,
  ...
  public NotificationChain basicSetOwnedTemplateSignature(TemplateSignature newOwnedTemplateSignature,
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          UMLPackage.PACKAGE__OWNED_TEMPLATE_SIGNATURE, oldOwnedTemplateSignature, newOwnedTemplateSignature);
      if (msgs == null)
        msgs = notification;
      else
        msgs.add(notification);
  ...
  public void setOwnedTemplateSignature(TemplateSignature newOwnedTemplateSignature) {
    if (newOwnedTemplateSignature != ownedTemplateSignature) {
      ...
      eNotify(new ENotificationImpl(this, Notification.SET, UMLPackage.PACKAGE__OWNED_TEMPLATE_SIGNATURE,
  ...
  public EList<NamedElement> getOwnedMembers() {
    ...
    return new DerivedUnionEObjectEList<NamedElement>(NamedElement.class, this, UMLPackage.PACKAGE__OWNED_MEMBER,
  ...
  public EList<PackageableElement> getPackagedElements() {
    if (packagedElements == null) {
      packagedElements = new EObjectContainmentEList.Resolving<PackageableElement>(PackageableElement.class, this,
   ...
   * @generated
   */
  public PackageableElement getPackagedElement(String name, boolean ignoreCase, EClass eClass, boolean createOnDemand) {
    packagedElementLoop: for (PackageableElement packagedElement : getPackagedElements()) {
      ...
      if (name != null
          && !(ignoreCase ? name.equalsIgnoreCase(packagedElement.getName()) : name.equals(packagedElement.getName())))
        continue packagedElementLoop;
  ...
  public void setURI(String newURI) {
    ...
    uri = newURI;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, UMLPackage.PACKAGE__URI, oldURI, uri));
  }
  ...
  public EList<PackageMerge> getPackageMerges() {
    if (packageMerges == null) {
      packageMerges = new EObjectContainmentWithInverseEList.Resolving<PackageMerge>(PackageMerge.class, this,
          UMLPackage.PACKAGE__PACKAGE_MERGE, UMLPackage.PACKAGE_MERGE__RECEIVING_PACKAGE);
    }
  ...
  public EList<Type> getOwnedTypes() {
    ...
    if (cache != null) {
      Resource eResource = eResource();
      @SuppressWarnings("unchecked")
      EList<Type> ownedTypes = (EList<Type>) cache.get(eResource, this, UMLPackage.Literals.PACKAGE__OWNED_TYPE);
      if (ownedTypes == null) {
        cache.put(eResource, this, UMLPackage.Literals.PACKAGE__OWNED_TYPE,
            ownedTypes = new DerivedSubsetEObjectEList<Type>(Type.class, this, UMLPackage.PACKAGE__OWNED_TYPE,
                OWNED_TYPE_ESUPERSETS));
      }
      return ownedTypes;
    }
    return new DerivedSubsetEObjectEList<Type>(Type.class, this, UMLPackage.PACKAGE__OWNED_TYPE, OWNED_TYPE_ESUPERSETS);
  }
  ...
  public EList<org.eclipse.uml2.uml.Package> getNestedPackages() {
    ...
    if (cache != null) {
      Resource eResource = eResource();
      @SuppressWarnings("unchecked")
      EList<org.eclipse.uml2.uml.Package> nestedPackages = (EList<org.eclipse.uml2.uml.Package>) cache.get(eResource,
          this, UMLPackage.Literals.PACKAGE__NESTED_PACKAGE);
      if (nestedPackages == null) {
        cache.put(eResource, this, UMLPackage.Literals.PACKAGE__NESTED_PACKAGE,
            nestedPackages = new DerivedSubsetEObjectEList<org.eclipse.uml2.uml.Package>(
                org.eclipse.uml2.uml.Package.class, this, UMLPackage.PACKAGE__NESTED_PACKAGE,
                NESTED_PACKAGE_ESUPERSETS));
      }
      return nestedPackages;
    }
    return new DerivedSubsetEObjectEList<org.eclipse.uml2.uml.Package>(org.eclipse.uml2.uml.Package.class, this,
  ...
  public void setNestingPackage(org.eclipse.uml2.uml.Package newNestingPackage) {
    if (newNestingPackage != eInternalContainer()) {
      ...
      if (newNestingPackage != null)
        msgs = ((InternalEList<org.eclipse.uml2.uml.Package>) newNestingPackage.getNestedPackages()).basicAdd(this,
            msgs);
      ...
      eNotify(new ENotificationImpl(this, Notification.SET, UMLPackage.PACKAGE__NESTING_PACKAGE, newNestingPackage,
          newNestingPackage));
  }
  ...
  public EList<Stereotype> getOwnedStereotypes() {
    ...
    if (cache != null) {
      Resource eResource = eResource();
      @SuppressWarnings("unchecked")
      EList<Stereotype> ownedStereotypes = (EList<Stereotype>) cache.get(eResource, this,
          UMLPackage.Literals.PACKAGE__OWNED_STEREOTYPE);
      if (ownedStereotypes == null) {
        cache.put(eResource, this, UMLPackage.Literals.PACKAGE__OWNED_STEREOTYPE,
            ownedStereotypes = new DerivedSubsetEObjectEList<Stereotype>(Stereotype.class, this,
                UMLPackage.PACKAGE__OWNED_STEREOTYPE, OWNED_STEREOTYPE_ESUPERSETS));
      }
      return ownedStereotypes;
    }
    return new DerivedSubsetEObjectEList<Stereotype>(Stereotype.class, this, UMLPackage.PACKAGE__OWNED_STEREOTYPE,
  ...
  public EList<ProfileApplication> getProfileApplications() {
    if (profileApplications == null) {
      profileApplications = new EObjectContainmentWithInverseEList.Resolving<ProfileApplication>(
          ProfileApplication.class, this, UMLPackage.PACKAGE__PROFILE_APPLICATION,
    ...
    case UMLPackage.PACKAGE__OWNED_TEMPLATE_SIGNATURE:
      if (ownedTemplateSignature != null)
        msgs = ((InternalEObject) ownedTemplateSignature).eInverseRemove(this,
            EOPPOSITE_FEATURE_BASE - UMLPackage.PACKAGE__OWNED_TEMPLATE_SIGNATURE, null, msgs);
  ...
  public org.eclipse.uml2.uml.Package getNestedPackage(String name, boolean ignoreCase, EClass eClass,
    ...
    nestedPackageLoop: for (org.eclipse.uml2.uml.Package nestedPackage : getNestedPackages()) {
      ...
      if (name != null
          && !(ignoreCase ? name.equalsIgnoreCase(nestedPackage.getName()) : name.equals(nestedPackage.getName())))
        continue nestedPackageLoop;
  ...
  public Stereotype getOwnedStereotype(String name, boolean ignoreCase) {
    ownedStereotypeLoop: for (Stereotype ownedStereotype : getOwnedStereotypes()) {
      if (name != null
          && !(ignoreCase ? name.equalsIgnoreCase(ownedStereotype.getName()) : name.equals(ownedStereotype.getName())))
