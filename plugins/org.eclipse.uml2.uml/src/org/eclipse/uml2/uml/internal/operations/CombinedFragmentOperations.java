...
public class CombinedFragmentOperations extends NamedElementOperations {
   ...
   * @generated NOT
   */
  public static boolean validateOptLoopBreakNeg(CombinedFragment combinedFragment, DiagnosticChain diagnostics,
      ...
      if (combinedFragment.getOperands().size() != 1) {
        ...
        if (diagnostics != null) {
          diagnostics.add(new BasicDiagnostic(Diagnostic.WARNING, UMLValidator.DIAGNOSTIC_SOURCE,
              ...
              UMLPlugin.INSTANCE.getString("_UI_CombinedFragment_OptLoopBreakNeg_diagnostic", //$NON-NLS-1$
                  getMessageSubstitutions(context, combinedFragment)),
   ...
   * @generated
   */
  public static boolean validateBreak(CombinedFragment combinedFragment, DiagnosticChain diagnostics,
      Map<Object, Object> context) {
    ...
    if (false) {
      if (diagnostics != null) {
        diagnostics.add(
            new BasicDiagnostic(Diagnostic.ERROR, UMLValidator.DIAGNOSTIC_SOURCE, UMLValidator.COMBINED_FRAGMENT__BREAK,
                org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", //$NON-NLS-1$
                    new Object[] { "validateBreak", //$NON-NLS-1$
                        org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(combinedFragment, context) }), new Object[] { combinedFragment }));
      }
      return false;
    }
    return true;
   ...
   * @generated
   */
  public static boolean validateConsiderAndIgnore(CombinedFragment combinedFragment, DiagnosticChain diagnostics,
      Map<Object, Object> context) {
    // TODO: implement this method
    // -> specify the condition that violates the invariant
    // -> verify the details of the diagnostic, including severity and message
