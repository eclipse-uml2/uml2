 ...
 * @generated
 */
public class OpaqueActionOperations extends ActionOperations {
   ...
   * @generated
   */
  public static boolean validateLanguageBodySize(OpaqueAction opaqueAction, DiagnosticChain diagnostics,
        ...
        diagnostics.add(new BasicDiagnostic(Diagnostic.ERROR, UMLValidator.DIAGNOSTIC_SOURCE,
            ...
            org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", //$NON-NLS-1$
                new Object[] { "validateLanguageBodySize", //$NON-NLS-1$
                    org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(opaqueAction, context) }), new Object[] { opaqueAction }));
      }
      return false;
    }
    return true;
