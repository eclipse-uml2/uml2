...
public class OpaqueActionImpl extends ActionImpl implements OpaqueAction {
    ...
    if (cache != null) {
      ...
      if (inputs == null) {
        cache.put(eResource, this, UMLPackage.Literals.ACTION__INPUT,
            inputs = new DerivedUnionEObjectEList<InputPin>(InputPin.class, this, UMLPackage.OPAQUE_ACTION__INPUT,
                INPUT_ESUBSETS));
      }
      return inputs;
    }
    return new DerivedUnionEObjectEList<InputPin>(InputPin.class, this, UMLPackage.OPAQUE_ACTION__INPUT,
        INPUT_ESUBSETS);
  }
    ...
    if (cache != null) {
      ...
      if (outputs == null) {
        cache.put(eResource, this, UMLPackage.Literals.ACTION__OUTPUT,
            outputs = new DerivedUnionEObjectEList<OutputPin>(OutputPin.class, this, UMLPackage.OPAQUE_ACTION__OUTPUT,
                OUTPUT_ESUBSETS));
      }
      return outputs;
    }
    return new DerivedUnionEObjectEList<OutputPin>(OutputPin.class, this, UMLPackage.OPAQUE_ACTION__OUTPUT,
        OUTPUT_ESUBSETS);
  }
  ...
  public EList<String> getBodies() {
    if (bodies == null) {
      bodies = new EDataTypeEList.Unsettable<String>(String.class, this, UMLPackage.OPAQUE_ACTION__BODY);
    }
    return bodies;
  }
  ...
  public EList<String> getLanguages() {
    if (languages == null) {
      languages = new EDataTypeUniqueEList.Unsettable<String>(String.class, this, UMLPackage.OPAQUE_ACTION__LANGUAGE);
    }
    return languages;
  }
  ...
  public boolean isSetLanguages() {
    return languages != null && ((InternalEList.Unsettable<?>) languages).isSet();
  }
  ...
  public EList<InputPin> getInputValues() {
    if (inputValues == null) {
      inputValues = new EObjectContainmentEList.Resolving<InputPin>(InputPin.class, this,
  ...
  public InputPin getInputValue(String name, Type type, boolean ignoreCase, EClass eClass, boolean createOnDemand) {
    inputValueLoop: for (InputPin inputValue : getInputValues()) {
      ...
      if (name != null
          && !(ignoreCase ? name.equalsIgnoreCase(inputValue.getName()) : name.equals(inputValue.getName())))
        continue inputValueLoop;
  ...
  public EList<OutputPin> getOutputValues() {
    if (outputValues == null) {
      outputValues = new EObjectContainmentEList.Resolving<OutputPin>(OutputPin.class, this,
  ...
  public OutputPin getOutputValue(String name, Type type, boolean ignoreCase, boolean createOnDemand) {
    outputValueLoop: for (OutputPin outputValue : getOutputValues()) {
      if (name != null
          && !(ignoreCase ? name.equalsIgnoreCase(outputValue.getName()) : name.equals(outputValue.getName())))
  ...
  public boolean isSetInputs() {
    return super.isSetInputs() || eIsSet(UMLPackage.OPAQUE_ACTION__INPUT_VALUE);
  }
  ...
  public boolean isSetOutputs() {
    return super.isSetOutputs() || eIsSet(UMLPackage.OPAQUE_ACTION__OUTPUT_VALUE);
  }
