...
public class TriggerOperations extends NamedElementOperations {
   ...
   * @generated
   */
  public static boolean validateTriggerWithPorts(Trigger trigger, DiagnosticChain diagnostics,
        ...
        diagnostics.add(new BasicDiagnostic(Diagnostic.ERROR, UMLValidator.DIAGNOSTIC_SOURCE,
            ...
            org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", //$NON-NLS-1$
                new Object[] { "validateTriggerWithPorts", //$NON-NLS-1$
                    org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(trigger, context) }), new Object[] { trigger }));
      }
      return false;
    }
    return true;
