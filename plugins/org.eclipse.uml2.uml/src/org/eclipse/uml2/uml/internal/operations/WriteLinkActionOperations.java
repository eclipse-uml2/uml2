 ...
 * @generated
 */
public class WriteLinkActionOperations extends LinkActionOperations {
   ...
   * @generated
   */
  public static boolean validateAllowAccess(WriteLinkAction writeLinkAction, DiagnosticChain diagnostics,
        ...
        diagnostics.add(new BasicDiagnostic(Diagnostic.ERROR, UMLValidator.DIAGNOSTIC_SOURCE,
            ...
            org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", //$NON-NLS-1$
                new Object[] { "validateAllowAccess", //$NON-NLS-1$
                    org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(writeLinkAction, context) }), new Object[] { writeLinkAction }));
      }
      return false;
    }
    return true;
