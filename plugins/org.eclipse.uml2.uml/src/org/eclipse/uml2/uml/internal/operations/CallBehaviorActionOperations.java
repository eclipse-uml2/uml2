 ...
 * @generated
 */
public class CallBehaviorActionOperations extends CallActionOperations {
   ...
   * @generated
   */
  public static boolean validateNoOnport(CallBehaviorAction callBehaviorAction, DiagnosticChain diagnostics,
        ...
        diagnostics.add(new BasicDiagnostic(Diagnostic.ERROR, UMLValidator.DIAGNOSTIC_SOURCE,
            ...
            org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", //$NON-NLS-1$
                new Object[] { "validateNoOnport", //$NON-NLS-1$
                    org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(callBehaviorAction, context) }), new Object[] { callBehaviorAction }));
      }
      return false;
    }
    return true;
   ...
   * @generated NOT
   */
  public static EList<Parameter> outputParameters(CallBehaviorAction callBehaviorAction) {
   ...
   * @generated NOT
   */
  public static EList<Parameter> inputParameters(CallBehaviorAction callBehaviorAction) {
    Behavior behavior = callBehaviorAction.getBehavior();
