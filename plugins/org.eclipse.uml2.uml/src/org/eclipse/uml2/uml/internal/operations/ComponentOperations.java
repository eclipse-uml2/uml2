...
public class ComponentOperations extends ClassOperations {
   ...
   * @generated
   */
  public static boolean validateNoNestedClassifiers(Component component, DiagnosticChain diagnostics,
        ...
        diagnostics.add(new BasicDiagnostic(Diagnostic.ERROR, UMLValidator.DIAGNOSTIC_SOURCE,
            ...
            org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", //$NON-NLS-1$
                new Object[] { "validateNoNestedClassifiers", //$NON-NLS-1$
                    org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(component, context) }), new Object[] { component }));
      }
      return false;
    }
    return true;
   ...
   * @generated
   */
  public static boolean validateNoPackagedElements(Component component, DiagnosticChain diagnostics,
      Map<Object, Object> context) {
    // TODO: implement this method
    // -> specify the condition that violates the invariant
    // -> verify the details of the diagnostic, including severity and message
   ...
   * @generated NOT
   */
  public static org.eclipse.uml2.uml.Class createOwnedClass(Component component, String name, boolean isAbstract) {
    org.eclipse.uml2.uml.Class ownedClass = (org.eclipse.uml2.uml.Class) component.createPackagedElement(name,
  ...
  public static EList<Interface> getRequireds(Component component) {
    EList<Interface> requireds = allUsedInterfaces(component, false, new UniqueEList.FastCompare<Interface>());
    ...
    for (EncapsulatedClassifier c : classifiers) {
      ...
      for (Port ownedPort : c.getOwnedPorts()) {
        requireds.addAll(((InternalEList<Interface>) ownedPort.getRequireds()).basicList());
      }
    }

    return new UnionEObjectEList<Interface>((InternalEObject) component, UMLPackage.Literals.COMPONENT__REQUIRED,
  ...
  public static EList<Interface> getProvideds(Component component) {
    EList<Interface> provideds = allRealizedInterfaces(component, false, new UniqueEList.FastCompare<Interface>());
    ...
    for (Component c : components) {
      ...
      for (ComponentRealization realization : c.getRealizations()) {
        ...
        for (Classifier realizingClassifier : realization.getRealizingClassifiers()) {
          ...
          if (realizingClassifier != null) {
            allRealizedInterfaces(realizingClassifier, false, provideds);
          }
        }
      }
    }
    ...
    for (EncapsulatedClassifier c : classifiers) {
      ...
      for (Port ownedPort : c.getOwnedPorts()) {
        provideds.addAll(((InternalEList<Interface>) ownedPort.getProvideds()).basicList());
      }
    }

    return new UnionEObjectEList<Interface>((InternalEObject) component, UMLPackage.Literals.COMPONENT__PROVIDED,
