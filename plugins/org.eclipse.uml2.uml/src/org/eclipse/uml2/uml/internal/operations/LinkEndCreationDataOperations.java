 ...
 * @generated
 */
public class LinkEndCreationDataOperations extends LinkEndDataOperations {
   ...
   * @generated
   */
  public static boolean validateInsertAtPin(LinkEndCreationData linkEndCreationData, DiagnosticChain diagnostics,
        ...
        diagnostics.add(new BasicDiagnostic(Diagnostic.ERROR, UMLValidator.DIAGNOSTIC_SOURCE,
            ...
            org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", //$NON-NLS-1$
                new Object[] { "validateInsertAtPin", //$NON-NLS-1$
                    org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(linkEndCreationData, context) }), new Object[] { linkEndCreationData }));
      }
      return false;
    }
    return true;
   ...
   * @generated NOT
   */
  public static EList<InputPin> allPins(LinkEndCreationData linkEndCreationData) {
    EList<InputPin> allPins = new UniqueEList.FastCompare<InputPin>(LinkEndDataOperations.allPins(linkEndCreationData));
