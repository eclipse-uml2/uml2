...
public class ConsiderIgnoreFragmentImpl extends CombinedFragmentImpl implements ConsiderIgnoreFragment {
  ...
  public EList<NamedElement> getMessages() {
    if (messages == null) {
      messages = new EObjectResolvingEList<NamedElement>(NamedElement.class, this,
   ...
   * @generated
   */
  public NamedElement getMessage(String name, boolean ignoreCase, EClass eClass) {
   ...
   * @generated
   */
  public boolean validateConsiderOrIgnore(DiagnosticChain diagnostics, Map<Object, Object> context) {
