...
public class ConnectionPointReferenceImpl extends VertexImpl implements ConnectionPointReference {
  ...
  public EList<Pseudostate> getEntries() {
    if (entries == null) {
      entries = new EObjectResolvingEList<Pseudostate>(Pseudostate.class, this,
  ...
  public EList<Pseudostate> getExits() {
    if (exits == null) {
      exits = new EObjectResolvingEList<Pseudostate>(Pseudostate.class, this,
  ...
  public void setState(State newState) {
    if (newState != eInternalContainer()
      ...
      eNotify(new ENotificationImpl(this, Notification.SET, UMLPackage.CONNECTION_POINT_REFERENCE__STATE, newState,
          newState));
  }
   ...
   * @generated
   */
  public boolean validateEntryPseudostates(DiagnosticChain diagnostics, Map<Object, Object> context) {
   ...
   * @generated
   */
  public boolean validateExitPseudostates(DiagnosticChain diagnostics, Map<Object, Object> context) {
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType) {
    ...
    case UMLPackage.CONNECTION_POINT_REFERENCE__IS_LEAF:
      return isLeaf();
    case UMLPackage.CONNECTION_POINT_REFERENCE__REDEFINED_ELEMENT:
      return getRedefinedElements();
    case UMLPackage.CONNECTION_POINT_REFERENCE__REDEFINITION_CONTEXT:
    ...
    case UMLPackage.CONNECTION_POINT_REFERENCE__OUTGOING:
      return getOutgoings();
    case UMLPackage.CONNECTION_POINT_REFERENCE__REDEFINED_VERTEX:
      if (resolve)
  ...
  public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
    ...
    case UMLPackage.CONNECTION_POINT_REFERENCE___GET_CLIENT_DEPENDENCIES:
      return getClientDependencies();
    case UMLPackage.CONNECTION_POINT_REFERENCE___VALIDATE_REDEFINITION_CONSISTENT__DIAGNOSTICCHAIN_MAP:
      return validateRedefinitionConsistent((DiagnosticChain) arguments.get(0), (Map<Object, Object>) arguments.get(1));
    case UMLPackage.CONNECTION_POINT_REFERENCE___VALIDATE_NON_LEAF_REDEFINITION__DIAGNOSTICCHAIN_MAP:
      return validateNonLeafRedefinition((DiagnosticChain) arguments.get(0), (Map<Object, Object>) arguments.get(1));
    case UMLPackage.CONNECTION_POINT_REFERENCE___VALIDATE_REDEFINITION_CONTEXT_VALID__DIAGNOSTICCHAIN_MAP:
      return validateRedefinitionContextValid((DiagnosticChain) arguments.get(0),
          (Map<Object, Object>) arguments.get(1));
    case UMLPackage.CONNECTION_POINT_REFERENCE___IS_CONSISTENT_WITH__REDEFINABLEELEMENT:
      return isConsistentWith((RedefinableElement) arguments.get(0));
    case UMLPackage.CONNECTION_POINT_REFERENCE___IS_REDEFINITION_CONTEXT_VALID__REDEFINABLEELEMENT:
  ...
  public boolean isSetNamespace() {
    return super.isSetNamespace() || eIsSet(UMLPackage.CONNECTION_POINT_REFERENCE__STATE);
  }
