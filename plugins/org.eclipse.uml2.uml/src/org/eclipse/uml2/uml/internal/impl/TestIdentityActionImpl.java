...
public class TestIdentityActionImpl extends ActionImpl implements TestIdentityAction {
  ...
  public EList<InputPin> getInputs() {
    ...
    return new DerivedUnionEObjectEList<InputPin>(InputPin.class, this, UMLPackage.TEST_IDENTITY_ACTION__INPUT,
        INPUT_ESUBSETS);
  }
  ...
  public EList<OutputPin> getOutputs() {
    ...
    return new DerivedUnionEObjectEList<OutputPin>(OutputPin.class, this, UMLPackage.TEST_IDENTITY_ACTION__OUTPUT,
        OUTPUT_ESUBSETS);
  }
    ...
    if (first != null && first.eIsProxy()) {
      ...
      if (first != oldFirst) {
        ...
        NotificationChain msgs = oldFirst.eInverseRemove(this,
            EOPPOSITE_FEATURE_BASE - UMLPackage.TEST_IDENTITY_ACTION__FIRST, null, null);
        if (newFirst.eInternalContainer() == null) {
          msgs = newFirst.eInverseAdd(this, EOPPOSITE_FEATURE_BASE - UMLPackage.TEST_IDENTITY_ACTION__FIRST, null,
              msgs);
        }
        if (msgs != null)
          msgs.dispatch();
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, UMLPackage.TEST_IDENTITY_ACTION__FIRST, oldFirst,
              first));
      }
    }
    return first;
  ...
  public NotificationChain basicSetFirst(InputPin newFirst, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          UMLPackage.TEST_IDENTITY_ACTION__FIRST, oldFirst, newFirst);
      if (msgs == null)
        msgs = notification;
      else
    ...
    if (newFirst != first) {
      ...
      if (first != null)
        msgs = ((InternalEObject) first).eInverseRemove(this,
            EOPPOSITE_FEATURE_BASE - UMLPackage.TEST_IDENTITY_ACTION__FIRST, null, msgs);
      if (newFirst != null)
      ...
      eNotify(
          new ENotificationImpl(this, Notification.SET, UMLPackage.TEST_IDENTITY_ACTION__FIRST, newFirst, newFirst));
  }
    ...
    if (second != null && second.eIsProxy()) {
      ...
      if (second != oldSecond) {
        ...
        NotificationChain msgs = oldSecond.eInverseRemove(this,
            EOPPOSITE_FEATURE_BASE - UMLPackage.TEST_IDENTITY_ACTION__SECOND, null, null);
        if (newSecond.eInternalContainer() == null) {
          msgs = newSecond.eInverseAdd(this, EOPPOSITE_FEATURE_BASE - UMLPackage.TEST_IDENTITY_ACTION__SECOND, null,
              msgs);
        }
        if (msgs != null)
          msgs.dispatch();
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, UMLPackage.TEST_IDENTITY_ACTION__SECOND, oldSecond,
              second));
      }
    }
    return second;
  ...
  public NotificationChain basicSetSecond(InputPin newSecond, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          UMLPackage.TEST_IDENTITY_ACTION__SECOND, oldSecond, newSecond);
      if (msgs == null)
        msgs = notification;
      else
        msgs.add(notification);
    ...
    if (newSecond != second) {
      ...
      if (second != null)
        msgs = ((InternalEObject) second).eInverseRemove(this,
            EOPPOSITE_FEATURE_BASE - UMLPackage.TEST_IDENTITY_ACTION__SECOND, null, msgs);
      if (newSecond != null)
      ...
      eNotify(
          new ENotificationImpl(this, Notification.SET, UMLPackage.TEST_IDENTITY_ACTION__SECOND, newSecond, newSecond));
  }
    ...
    if (result != null && result.eIsProxy()) {
      ...
      if (result != oldResult) {
        ...
        NotificationChain msgs = oldResult.eInverseRemove(this,
            EOPPOSITE_FEATURE_BASE - UMLPackage.TEST_IDENTITY_ACTION__RESULT, null, null);
        if (newResult.eInternalContainer() == null) {
          msgs = newResult.eInverseAdd(this, EOPPOSITE_FEATURE_BASE - UMLPackage.TEST_IDENTITY_ACTION__RESULT, null,
              msgs);
        }
        if (msgs != null)
          msgs.dispatch();
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, UMLPackage.TEST_IDENTITY_ACTION__RESULT, oldResult,
              result));
      }
    }
    return result;
  ...
  public NotificationChain basicSetResult(OutputPin newResult, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          UMLPackage.TEST_IDENTITY_ACTION__RESULT, oldResult, newResult);
      if (msgs == null)
        msgs = notification;
      else
        msgs.add(notification);
    ...
    if (newResult != result) {
      ...
      if (result != null)
        msgs = ((InternalEObject) result).eInverseRemove(this,
            EOPPOSITE_FEATURE_BASE - UMLPackage.TEST_IDENTITY_ACTION__RESULT, null, msgs);
      if (newResult != null)
      ...
      eNotify(
          new ENotificationImpl(this, Notification.SET, UMLPackage.TEST_IDENTITY_ACTION__RESULT, newResult, newResult));
  }
   ...
   * @generated
   */
  public boolean validateNoType(DiagnosticChain diagnostics, Map<Object, Object> context) {
   ...
   * @generated
   */
  public boolean validateResultIsBoolean(DiagnosticChain diagnostics, Map<Object, Object> context) {
   ...
   * @ordered
   */
  protected static final int[] INPUT_ESUBSETS = new int[] { UMLPackage.TEST_IDENTITY_ACTION__FIRST,
  ...
  public boolean isSetInputs() {
    return super.isSetInputs() || eIsSet(UMLPackage.TEST_IDENTITY_ACTION__FIRST)
  ...
  public boolean isSetOutputs() {
    return super.isSetOutputs() || eIsSet(UMLPackage.TEST_IDENTITY_ACTION__RESULT);
  }
