...
public class SendSignalActionImpl extends InvocationActionImpl implements SendSignalAction {
    ...
    if (cache != null) {
      ...
      if (inputs == null) {
        cache.put(eResource, this, UMLPackage.Literals.ACTION__INPUT,
            inputs = new DerivedUnionEObjectEList<InputPin>(InputPin.class, this, UMLPackage.SEND_SIGNAL_ACTION__INPUT,
                INPUT_ESUBSETS));
      }
      return inputs;
    }
    return new DerivedUnionEObjectEList<InputPin>(InputPin.class, this, UMLPackage.SEND_SIGNAL_ACTION__INPUT,
        INPUT_ESUBSETS);
  }
    ...
    if (target != null && target.eIsProxy()) {
      ...
      if (target != oldTarget) {
        ...
        NotificationChain msgs = oldTarget.eInverseRemove(this,
            EOPPOSITE_FEATURE_BASE - UMLPackage.SEND_SIGNAL_ACTION__TARGET, null, null);
        if (newTarget.eInternalContainer() == null) {
          msgs = newTarget.eInverseAdd(this, EOPPOSITE_FEATURE_BASE - UMLPackage.SEND_SIGNAL_ACTION__TARGET, null,
              msgs);
        }
        if (msgs != null)
          msgs.dispatch();
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, UMLPackage.SEND_SIGNAL_ACTION__TARGET, oldTarget,
              target));
      }
    }
    return target;
  ...
  public NotificationChain basicSetTarget(InputPin newTarget, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          UMLPackage.SEND_SIGNAL_ACTION__TARGET, oldTarget, newTarget);
      if (msgs == null)
        msgs = notification;
      else
    ...
    if (newTarget != target) {
      ...
      if (target != null)
        msgs = ((InternalEObject) target).eInverseRemove(this,
            EOPPOSITE_FEATURE_BASE - UMLPackage.SEND_SIGNAL_ACTION__TARGET, null, msgs);
      if (newTarget != null)
      ...
      eNotify(
          new ENotificationImpl(this, Notification.SET, UMLPackage.SEND_SIGNAL_ACTION__TARGET, newTarget, newTarget));
  }
  ...
  public Signal getSignal() {
    if (signal != null && signal.eIsProxy()) {
      ...
      if (signal != oldSignal) {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, UMLPackage.SEND_SIGNAL_ACTION__SIGNAL, oldSignal,
              signal));
      }
    }
    return signal;
   ...
   * @generated
   */
  public boolean validateNumberOrder(DiagnosticChain diagnostics, Map<Object, Object> context) {
  ...
  public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
    ...
    case UMLPackage.SEND_SIGNAL_ACTION___VALIDATE_TYPE_ORDERING_MULTIPLICITY__DIAGNOSTICCHAIN_MAP:
      return validateTypeOrderingMultiplicity((DiagnosticChain) arguments.get(0),
          (Map<Object, Object>) arguments.get(1));
   ...
   * @ordered
   */
  protected static final int[] INPUT_ESUBSETS = new int[] { UMLPackage.SEND_SIGNAL_ACTION__ARGUMENT,
  ...
  public boolean isSetInputs() {
    return super.isSetInputs() || eIsSet(UMLPackage.SEND_SIGNAL_ACTION__TARGET);
  }
