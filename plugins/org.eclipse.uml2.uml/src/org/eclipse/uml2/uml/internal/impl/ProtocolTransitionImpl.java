...
public class ProtocolTransitionImpl extends TransitionImpl implements ProtocolTransition {
  ...
  private EList<Constraint> createOwnedRulesList() {
    return new SubsetSupersetEObjectContainmentWithInverseEList.Resolving<Constraint>(Constraint.class, this,
        UMLPackage.PROTOCOL_TRANSITION__OWNED_RULE, null, OWNED_RULE_ESUBSETS, UMLPackage.CONSTRAINT__CONTEXT);
  }
   ...
   * @ordered
   */
  protected static final int[] OWNED_RULE_ESUBSETS = new int[] { UMLPackage.PROTOCOL_TRANSITION__GUARD,
    ...
    if (guard != null && guard.eIsProxy()) {
      ...
      if (guard != oldGuard) {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, UMLPackage.PROTOCOL_TRANSITION__GUARD, oldGuard,
              guard));
      }
    }
    return guard;
  ...
  public void setGuard(Constraint newGuard) {
    ...
    guard = newGuard;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, UMLPackage.PROTOCOL_TRANSITION__GUARD, oldGuard, guard));
  ...
  public Constraint getPostCondition() {
    if (postCondition != null && postCondition.eIsProxy()) {
      ...
      if (postCondition != oldPostCondition) {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, UMLPackage.PROTOCOL_TRANSITION__POST_CONDITION,
  ...
  public void setPostCondition(Constraint newPostCondition) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, UMLPackage.PROTOCOL_TRANSITION__POST_CONDITION,
          oldPostCondition, postCondition));
    Resource.Internal eInternalResource = eInternalResource();
    if (eInternalResource == null || !eInternalResource.isLoading()) {
  ...
  protected static class ReferredEList extends DerivedEObjectEList<Operation> {

    protected ReferredEList(Class<?> dataClass, InternalEObject owner, int featureID, int[] sourceFeatureIDs) {
      super(dataClass, owner, featureID, sourceFeatureIDs);
    }

    @Override
    public List<Operation> basicList() {
      return new ReferredEList(dataClass, owner, featureID, sourceFeatureIDs) {
    ...
    protected Operation derive(Object object) {
      ...
      return event instanceof CallEvent ? ((CallEvent) event).getOperation() : null;
    }
  ...
  public EList<Operation> getReferreds() {
    ...
    if (cache != null) {
      ...
      EList<Operation> referreds = (EList<Operation>) cache.get(eResource, this,
          UMLPackage.Literals.PROTOCOL_TRANSITION__REFERRED);
      if (referreds == null) {
        cache.put(eResource, this, UMLPackage.Literals.PROTOCOL_TRANSITION__REFERRED,
            referreds = new ReferredEList(Operation.class, this, UMLPackage.PROTOCOL_TRANSITION__REFERRED,
                REFERRED_ESUPERSETS));
      }
      return referreds;
    }
    return new ReferredEList(Operation.class, this, UMLPackage.PROTOCOL_TRANSITION__REFERRED, REFERRED_ESUPERSETS);
  }
   ...
   * @generated
   */
  public Operation getReferred(String name, EList<String> ownedParameterNames, EList<Type> ownedParameterTypes) {
  ...
  public Constraint getPreCondition() {
    if (preCondition != null && preCondition.eIsProxy()) {
      ...
      if (preCondition != oldPreCondition) {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, UMLPackage.PROTOCOL_TRANSITION__PRE_CONDITION,
  ...
  public void setPreCondition(Constraint newPreCondition) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, UMLPackage.PROTOCOL_TRANSITION__PRE_CONDITION,
          oldPreCondition, preCondition));
    Resource.Internal eInternalResource = eInternalResource();
    if (eInternalResource == null || !eInternalResource.isLoading()) {
   ...
   * @generated
   */
  public boolean validateBelongsToPsm(DiagnosticChain diagnostics, Map<Object, Object> context) {
   ...
   * @generated
   */
  public boolean validateAssociatedActions(DiagnosticChain diagnostics, Map<Object, Object> context) {
   ...
   * @generated
   */
  public boolean validateRefersToOperation(DiagnosticChain diagnostics, Map<Object, Object> context) {
