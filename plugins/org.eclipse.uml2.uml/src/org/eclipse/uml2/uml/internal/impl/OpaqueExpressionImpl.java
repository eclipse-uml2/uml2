...
public class OpaqueExpressionImpl extends ValueSpecificationImpl implements OpaqueExpression {
  ...
  public EList<String> getBodies() {
    if (bodies == null) {
      bodies = new EDataTypeEList.Unsettable<String>(String.class, this, UMLPackage.OPAQUE_EXPRESSION__BODY);
    }
    return bodies;
  }
  ...
  public EList<String> getLanguages() {
    if (languages == null) {
      languages = new EDataTypeUniqueEList.Unsettable<String>(String.class, this,
    ...
    if (behavior != null && behavior.eIsProxy()) {
      ...
      if (behavior != oldBehavior) {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, UMLPackage.OPAQUE_EXPRESSION__BEHAVIOR, oldBehavior,
              behavior));
      }
    }
    return behavior;
  ...
  public void setBehavior(Behavior newBehavior) {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(this, Notification.SET, UMLPackage.OPAQUE_EXPRESSION__BEHAVIOR, oldBehavior, behavior));
  }
   ...
   * @generated
   */
  public boolean validateOnlyReturnResultParameters(DiagnosticChain diagnostics, Map<Object, Object> context) {
   ...
   * @generated
   */
  public boolean validateOneReturnResultParameter(DiagnosticChain diagnostics, Map<Object, Object> context) {
  ...
  public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
    ...
    case UMLPackage.OPAQUE_EXPRESSION___VALIDATE_ONE_RETURN_RESULT_PARAMETER__DIAGNOSTICCHAIN_MAP:
      return validateOneReturnResultParameter((DiagnosticChain) arguments.get(0),
          (Map<Object, Object>) arguments.get(1));
    case UMLPackage.OPAQUE_EXPRESSION___VALIDATE_ONLY_RETURN_RESULT_PARAMETERS__DIAGNOSTICCHAIN_MAP:
      return validateOnlyReturnResultParameters((DiagnosticChain) arguments.get(0),
          (Map<Object, Object>) arguments.get(1));
