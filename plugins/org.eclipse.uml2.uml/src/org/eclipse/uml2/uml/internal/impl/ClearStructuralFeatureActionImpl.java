 ...
 * @generated
 */
public class ClearStructuralFeatureActionImpl extends StructuralFeatureActionImpl
    ...
    if (result != null && result.eIsProxy()) {
      ...
      if (result != oldResult) {
        ...
        NotificationChain msgs = oldResult.eInverseRemove(this,
            EOPPOSITE_FEATURE_BASE - UMLPackage.CLEAR_STRUCTURAL_FEATURE_ACTION__RESULT, null, null);
        if (newResult.eInternalContainer() == null) {
          msgs = newResult.eInverseAdd(this,
              EOPPOSITE_FEATURE_BASE - UMLPackage.CLEAR_STRUCTURAL_FEATURE_ACTION__RESULT, null, msgs);
        }
        if (msgs != null)
          msgs.dispatch();
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, UMLPackage.CLEAR_STRUCTURAL_FEATURE_ACTION__RESULT,
              oldResult, result));
      }
    }
    return result;
  ...
  public NotificationChain basicSetResult(OutputPin newResult, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          UMLPackage.CLEAR_STRUCTURAL_FEATURE_ACTION__RESULT, oldResult, newResult);
      if (msgs == null)
        msgs = notification;
      else
  ...
  public void setResult(OutputPin newResult) {
    if (newResult != result) {
      ...
      eNotify(new ENotificationImpl(this, Notification.SET, UMLPackage.CLEAR_STRUCTURAL_FEATURE_ACTION__RESULT,
          newResult, newResult));
  }
  ...
  public boolean isSetOutputs() {
    return super.isSetOutputs() || eIsSet(UMLPackage.CLEAR_STRUCTURAL_FEATURE_ACTION__RESULT);
  }
