...
public class StateMachineOperations extends BehaviorOperations {
   ...
   * @generated
   */
  public static boolean validateClassifierContext(StateMachine stateMachine, DiagnosticChain diagnostics,
        ...
        diagnostics.add(new BasicDiagnostic(Diagnostic.ERROR, UMLValidator.DIAGNOSTIC_SOURCE,
            ...
            org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", //$NON-NLS-1$
                new Object[] { "validateClassifierContext", //$NON-NLS-1$
                    org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(stateMachine, context) }), new Object[] { stateMachine }));
      }
      return false;
    }
    return true;
   ...
   * @generated
   */
  public static boolean validateContextClassifier(StateMachine stateMachine, DiagnosticChain diagnostics,
      Map<Object, Object> context) {
    // TODO: implement this method
    // -> specify the condition that violates the invariant
    // -> verify the details of the diagnostic, including severity and message
  ...
  public static Region LCA(StateMachine stateMachine, Vertex s1, Vertex s2) {
    ...
    if (ancestor(stateMachine, s1, s2)) {
      ...
      return state1 != null && state2 != null ? LCA(stateMachine, state1, state2) : null;
    }
  }
  ...
  public static State LCAState(StateMachine stateMachine, Vertex v1, Vertex v2) {
    ...
    if (v2 instanceof State && ancestor(stateMachine, v1, v2)) {
      ...
      return state1 == null || state2 == null ? null : LCAState(stateMachine, state1, state2);
    }
  }
   ...
   * @generated
   */
  public static boolean validateConnectionPoints(StateMachine stateMachine, DiagnosticChain diagnostics,
      Map<Object, Object> context) {
    // TODO: implement this method
    // -> specify the condition that violates the invariant
    // -> verify the details of the diagnostic, including severity and message
   ...
   * @generated
   */
  public static boolean validateMethod(StateMachine stateMachine, DiagnosticChain diagnostics,
      Map<Object, Object> context) {
    // TODO: implement this method
    // -> specify the condition that violates the invariant
    // -> verify the details of the diagnostic, including severity and message
    ...
    if (false) {
      if (diagnostics != null) {
        diagnostics.add(
            new BasicDiagnostic(Diagnostic.ERROR, UMLValidator.DIAGNOSTIC_SOURCE, UMLValidator.STATE_MACHINE__METHOD,
                org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", //$NON-NLS-1$
  ...
  public static boolean isRedefinitionContextValid(StateMachine stateMachine, RedefinableElement redefinedElement) {
    ...
    if (redefinedElement instanceof StateMachine) {
      ...
      BehavioredClassifier parentContext = ((StateMachine) redefinedElement).getContext();

      return context == null ? parentContext == null && stateMachine.allParents().contains(redefinedElement)
  ...
  protected static EList<StateMachine> getAllExtendedStateMachines(StateMachine stateMachine,
    ...
    for (StateMachine extendedStateMachine : stateMachine.getExtendedStateMachines()) {
      ...
      if (allExtendedStateMachines.add(extendedStateMachine)) {
        getAllExtendedStateMachines(extendedStateMachine, allExtendedStateMachines);
      }
    }
  ...
  protected static EList<StateMachine> getAllExtendedStateMachines(StateMachine stateMachine) {
    return getAllExtendedStateMachines(stateMachine, new UniqueEList.FastCompare<StateMachine>());
  }

  protected static EList<Region> getAllRegions(StateMachine stateMachine) {
    EList<Region> allRegions = new UniqueEList.FastCompare<Region>(stateMachine.getRegions());
