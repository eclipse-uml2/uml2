 ...
 * @generated
 */
public class AddStructuralFeatureValueActionImpl extends WriteStructuralFeatureActionImpl
      ...
      if (inputs == null) {
        cache.put(eResource, this, UMLPackage.Literals.ACTION__INPUT,
            inputs = new DerivedUnionEObjectEList<InputPin>(InputPin.class, this,
                UMLPackage.ADD_STRUCTURAL_FEATURE_VALUE_ACTION__INPUT, INPUT_ESUBSETS));
      }
      return inputs;
    }
  ...
  public void setIsReplaceAll(boolean newIsReplaceAll) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET,
          UMLPackage.ADD_STRUCTURAL_FEATURE_VALUE_ACTION__IS_REPLACE_ALL, oldIsReplaceAll, newIsReplaceAll));
  }
    ...
    if (insertAt != null && insertAt.eIsProxy()) {
      ...
      if (insertAt != oldInsertAt) {
        ...
        NotificationChain msgs = oldInsertAt.eInverseRemove(this,
            EOPPOSITE_FEATURE_BASE - UMLPackage.ADD_STRUCTURAL_FEATURE_VALUE_ACTION__INSERT_AT, null, null);
        if (newInsertAt.eInternalContainer() == null) {
          msgs = newInsertAt.eInverseAdd(this,
              EOPPOSITE_FEATURE_BASE - UMLPackage.ADD_STRUCTURAL_FEATURE_VALUE_ACTION__INSERT_AT, null, msgs);
        }
        if (msgs != null)
          msgs.dispatch();
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE,
              UMLPackage.ADD_STRUCTURAL_FEATURE_VALUE_ACTION__INSERT_AT, oldInsertAt, insertAt));
      }
    }
    return insertAt;
  }
  ...
  public NotificationChain basicSetInsertAt(InputPin newInsertAt, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          UMLPackage.ADD_STRUCTURAL_FEATURE_VALUE_ACTION__INSERT_AT, oldInsertAt, newInsertAt);
      if (msgs == null)
        msgs = notification;
      else
  ...
  public void setInsertAt(InputPin newInsertAt) {
    if (newInsertAt != insertAt) {
      ...
      eNotify(new ENotificationImpl(this, Notification.SET, UMLPackage.ADD_STRUCTURAL_FEATURE_VALUE_ACTION__INSERT_AT,
   ...
   * @ordered
   */
  protected static final int[] INPUT_ESUBSETS = new int[] { UMLPackage.ADD_STRUCTURAL_FEATURE_VALUE_ACTION__OBJECT,
  ...
  public boolean isSetInputs() {
    return super.isSetInputs() || eIsSet(UMLPackage.ADD_STRUCTURAL_FEATURE_VALUE_ACTION__INSERT_AT);
  }
