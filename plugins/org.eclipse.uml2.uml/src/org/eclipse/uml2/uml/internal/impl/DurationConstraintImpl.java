...
public class DurationConstraintImpl extends IntervalConstraintImpl implements DurationConstraint {
  ...
  public EList<Boolean> getFirstEvents() {
    if (firstEvents == null) {
      firstEvents = new EDataTypeUniqueEList<Boolean>(Boolean.class, this, UMLPackage.DURATION_CONSTRAINT__FIRST_EVENT);
    }
    return firstEvents;
  }
    ...
    if (specification != null && specification.eIsProxy()) {
      ...
      if (specification != oldSpecification) {
        ...
        NotificationChain msgs = oldSpecification.eInverseRemove(this,
            EOPPOSITE_FEATURE_BASE - UMLPackage.DURATION_CONSTRAINT__SPECIFICATION, null, null);
        if (newSpecification.eInternalContainer() == null) {
          msgs = newSpecification.eInverseAdd(this,
              EOPPOSITE_FEATURE_BASE - UMLPackage.DURATION_CONSTRAINT__SPECIFICATION, null, msgs);
        }
        if (msgs != null)
          msgs.dispatch();
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, UMLPackage.DURATION_CONSTRAINT__SPECIFICATION,
  ...
  public NotificationChain basicSetSpecification(ValueSpecification newSpecification, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          UMLPackage.DURATION_CONSTRAINT__SPECIFICATION, oldSpecification, newSpecification);
      if (msgs == null)
        msgs = notification;
      else
  ...
  public void setSpecification(ValueSpecification newSpecification) {
    ...
    if (newSpecification != specification) {
      ...
      eNotify(new ENotificationImpl(this, Notification.SET, UMLPackage.DURATION_CONSTRAINT__SPECIFICATION,
   ...
   * @generated
   */
  public boolean validateFirstEventMultiplicity(DiagnosticChain diagnostics, Map<Object, Object> context) {
   ...
   * @generated
   */
  public boolean validateHasOneOrTwoConstrainedElements(DiagnosticChain diagnostics, Map<Object, Object> context) {
  ...
  public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
    ...
    case UMLPackage.DURATION_CONSTRAINT___VALIDATE_HAS_ONE_OR_TWO_CONSTRAINED_ELEMENTS__DIAGNOSTICCHAIN_MAP:
      return validateHasOneOrTwoConstrainedElements((DiagnosticChain) arguments.get(0),
          (Map<Object, Object>) arguments.get(1));
    }
