...
public class StateInvariantImpl extends InteractionFragmentImpl implements StateInvariant {
  ...
  public EList<Element> getOwnedElements() {
    ...
    return new DerivedUnionEObjectEList<Element>(Element.class, this, UMLPackage.STATE_INVARIANT__OWNED_ELEMENT,
    ...
    if (invariant != null && invariant.eIsProxy()) {
      ...
      if (invariant != oldInvariant) {
        ...
        NotificationChain msgs = oldInvariant.eInverseRemove(this,
            EOPPOSITE_FEATURE_BASE - UMLPackage.STATE_INVARIANT__INVARIANT, null, null);
        if (newInvariant.eInternalContainer() == null) {
          msgs = newInvariant.eInverseAdd(this, EOPPOSITE_FEATURE_BASE - UMLPackage.STATE_INVARIANT__INVARIANT, null,
              msgs);
        }
        if (msgs != null)
          msgs.dispatch();
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, UMLPackage.STATE_INVARIANT__INVARIANT, oldInvariant,
              invariant));
      }
    }
    return invariant;
  ...
  public NotificationChain basicSetInvariant(Constraint newInvariant, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          UMLPackage.STATE_INVARIANT__INVARIANT, oldInvariant, newInvariant);
      if (msgs == null)
        msgs = notification;
      else
    ...
    if (newInvariant != invariant) {
      ...
      if (invariant != null)
        msgs = ((InternalEObject) invariant).eInverseRemove(this,
            EOPPOSITE_FEATURE_BASE - UMLPackage.STATE_INVARIANT__INVARIANT, null, msgs);
      ...
      eNotify(new ENotificationImpl(this, Notification.SET, UMLPackage.STATE_INVARIANT__INVARIANT, newInvariant,
          newInvariant));
  }
  ...
  public EList<Lifeline> getCovereds() {
    if (covereds == null) {
      covereds = new EObjectWithInverseResolvingEList.ManyInverse<Lifeline>(Lifeline.class, this,
          UMLPackage.STATE_INVARIANT__COVERED, UMLPackage.LIFELINE__COVERED_BY);
    }
    return covereds;
  }
   ...
   * @ordered
   */
  protected static final int[] OWNED_ELEMENT_ESUBSETS = new int[] { UMLPackage.STATE_INVARIANT__OWNED_COMMENT,
      UMLPackage.STATE_INVARIANT__NAME_EXPRESSION, UMLPackage.STATE_INVARIANT__GENERAL_ORDERING,
  ...
  public boolean isSetOwnedElements() {
    return super.isSetOwnedElements() || eIsSet(UMLPackage.STATE_INVARIANT__INVARIANT);
  }
