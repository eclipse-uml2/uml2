...
public class ClearAssociationActionImpl extends ActionImpl implements ClearAssociationAction {
  ...
  public EList<InputPin> getInputs() {
    ...
    return new DerivedUnionEObjectEList<InputPin>(InputPin.class, this, UMLPackage.CLEAR_ASSOCIATION_ACTION__INPUT,
        INPUT_ESUBSETS);
  }
    ...
    if (object != null && object.eIsProxy()) {
      ...
      if (object != oldObject) {
        ...
        NotificationChain msgs = oldObject.eInverseRemove(this,
            EOPPOSITE_FEATURE_BASE - UMLPackage.CLEAR_ASSOCIATION_ACTION__OBJECT, null, null);
        if (newObject.eInternalContainer() == null) {
          msgs = newObject.eInverseAdd(this, EOPPOSITE_FEATURE_BASE - UMLPackage.CLEAR_ASSOCIATION_ACTION__OBJECT, null,
              msgs);
        }
        if (msgs != null)
          msgs.dispatch();
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, UMLPackage.CLEAR_ASSOCIATION_ACTION__OBJECT,
              oldObject, object));
      }
    }
    return object;
  ...
  public NotificationChain basicSetObject(InputPin newObject, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          UMLPackage.CLEAR_ASSOCIATION_ACTION__OBJECT, oldObject, newObject);
      if (msgs == null)
        msgs = notification;
      else
    ...
    if (newObject != object) {
      ...
      if (object != null)
        msgs = ((InternalEObject) object).eInverseRemove(this,
            EOPPOSITE_FEATURE_BASE - UMLPackage.CLEAR_ASSOCIATION_ACTION__OBJECT, null, msgs);
      if (newObject != null)
      ...
      eNotify(new ENotificationImpl(this, Notification.SET, UMLPackage.CLEAR_ASSOCIATION_ACTION__OBJECT, newObject,
          newObject));
  }
  ...
  public Association getAssociation() {
    if (association != null && association.eIsProxy()) {
      ...
      if (association != oldAssociation) {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, UMLPackage.CLEAR_ASSOCIATION_ACTION__ASSOCIATION,
  ...
  public void setAssociation(Association newAssociation) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, UMLPackage.CLEAR_ASSOCIATION_ACTION__ASSOCIATION,
          oldAssociation, association));
  }
  ...
  public boolean isSetInputs() {
    return super.isSetInputs() || eIsSet(UMLPackage.CLEAR_ASSOCIATION_ACTION__OBJECT);
  }
