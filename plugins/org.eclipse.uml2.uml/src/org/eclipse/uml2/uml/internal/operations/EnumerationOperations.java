 ...
 * @generated
 */
public class EnumerationOperations extends DataTypeOperations {
   ...
   * @param enumeration The receiving '<em><b>Enumeration</b></em>' model object.
   * @param diagnostics The chain of diagnostics to which problems are to be appended.
   * @param context The cache of context-specific information.
   * <!-- end-model-doc -->
   * @generated
   */
  public static boolean validateImmutable(Enumeration enumeration, DiagnosticChain diagnostics,
    ...
    if (false) {
      if (diagnostics != null) {
        diagnostics.add(
            new BasicDiagnostic(Diagnostic.ERROR, UMLValidator.DIAGNOSTIC_SOURCE, UMLValidator.ENUMERATION__IMMUTABLE,
                org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", //$NON-NLS-1$
                    new Object[] { "validateImmutable", //$NON-NLS-1$
                        org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(enumeration, context) }), new Object[] { enumeration }));
      }
      return false;
    }
    return true;
