...
public class ObjectFlowImpl extends ActivityEdgeImpl implements ObjectFlow {
  ...
  public void setIsMulticast(boolean newIsMulticast) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, UMLPackage.OBJECT_FLOW__IS_MULTICAST, oldIsMulticast,
          newIsMulticast));
  }
  ...
  public void setIsMultireceive(boolean newIsMultireceive) {
    ...
    if (newIsMultireceive)
      ...
      eFlags &= ~IS_MULTIRECEIVE_EFLAG;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, UMLPackage.OBJECT_FLOW__IS_MULTIRECEIVE, oldIsMultireceive,
          newIsMultireceive));
  }
  ...
  public Behavior getTransformation() {
    if (transformation != null && transformation.eIsProxy()) {
      ...
      if (transformation != oldTransformation) {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, UMLPackage.OBJECT_FLOW__TRANSFORMATION,
  ...
  public void setTransformation(Behavior newTransformation) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, UMLPackage.OBJECT_FLOW__TRANSFORMATION, oldTransformation,
          transformation));
  }
  ...
  public Behavior getSelection() {
    if (selection != null && selection.eIsProxy()) {
      ...
      if (selection != oldSelection) {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, UMLPackage.OBJECT_FLOW__SELECTION, oldSelection,
              selection));
      }
    }
    return selection;
  ...
  public void setSelection(Behavior newSelection) {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(this, Notification.SET, UMLPackage.OBJECT_FLOW__SELECTION, oldSelection, selection));
  }
   ...
   * @generated
   */
  public boolean validateCompatibleTypes(DiagnosticChain diagnostics, Map<Object, Object> context) {
   ...
   * @generated
   */
  public boolean validateSameUpperBounds(DiagnosticChain diagnostics, Map<Object, Object> context) {
   ...
   * @generated
   */
  public boolean validateTarget(DiagnosticChain diagnostics, Map<Object, Object> context) {
   ...
   * @generated
   */
  public boolean validateInputAndOutputParameter(DiagnosticChain diagnostics, Map<Object, Object> context) {
   ...
   * @generated
   */
  public boolean validateNoExecutableNodes(DiagnosticChain diagnostics, Map<Object, Object> context) {
   ...
   * @generated
   */
  public boolean validateTransformationBehavior(DiagnosticChain diagnostics, Map<Object, Object> context) {
   ...
   * @generated
   */
  public boolean validateIsMulticastOrIsMultireceive(DiagnosticChain diagnostics, Map<Object, Object> context) {
  ...
  public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
    ...
    case UMLPackage.OBJECT_FLOW___VALIDATE_INPUT_AND_OUTPUT_PARAMETER__DIAGNOSTICCHAIN_MAP:
      return validateInputAndOutputParameter((DiagnosticChain) arguments.get(0),
          (Map<Object, Object>) arguments.get(1));
    ...
    case UMLPackage.OBJECT_FLOW___VALIDATE_IS_MULTICAST_OR_IS_MULTIRECEIVE__DIAGNOSTICCHAIN_MAP:
      return validateIsMulticastOrIsMultireceive((DiagnosticChain) arguments.get(0),
          (Map<Object, Object>) arguments.get(1));
    }
