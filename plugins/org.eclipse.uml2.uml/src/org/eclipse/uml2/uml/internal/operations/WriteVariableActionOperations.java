 ...
 * @generated
 */
public class WriteVariableActionOperations extends VariableActionOperations {
   ...
   * @generated
   */
  public static boolean validateValueType(WriteVariableAction writeVariableAction, DiagnosticChain diagnostics,
        ...
        diagnostics.add(new BasicDiagnostic(Diagnostic.ERROR, UMLValidator.DIAGNOSTIC_SOURCE,
            ...
            org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", //$NON-NLS-1$
                new Object[] { "validateValueType", //$NON-NLS-1$
                    org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(writeVariableAction, context) }), new Object[] { writeVariableAction }));
      }
      return false;
    }
    return true;
   ...
   * @generated
   */
  public static boolean validateMultiplicity(WriteVariableAction writeVariableAction, DiagnosticChain diagnostics,
      Map<Object, Object> context) {
    // TODO: implement this method
    // -> specify the condition that violates the invariant
    // -> verify the details of the diagnostic, including severity and message
