 ...
 * @generated
 */
public class InitialNodeOperations extends ActivityNodeOperations {
   ...
   * @generated
   */
  public static boolean validateNoIncomingEdges(InitialNode initialNode, DiagnosticChain diagnostics,
        ...
        diagnostics.add(new BasicDiagnostic(Diagnostic.ERROR, UMLValidator.DIAGNOSTIC_SOURCE,
            ...
            org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", //$NON-NLS-1$
                new Object[] { "validateNoIncomingEdges", //$NON-NLS-1$
                    org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(initialNode, context) }), new Object[] { initialNode }));
      }
      return false;
    }
    return true;
   ...
   * @generated
   */
  public static boolean validateControlEdges(InitialNode initialNode, DiagnosticChain diagnostics,
      Map<Object, Object> context) {
    // TODO: implement this method
    // -> specify the condition that violates the invariant
    // -> verify the details of the diagnostic, including severity and message
