...
public class QualifierValueImpl extends ElementImpl implements QualifierValue {
    ...
    if (qualifier != null && qualifier.eIsProxy()) {
      ...
      if (qualifier != oldQualifier) {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, UMLPackage.QUALIFIER_VALUE__QUALIFIER, oldQualifier,
              qualifier));
      }
    }
    return qualifier;
  ...
  public void setQualifier(Property newQualifier) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, UMLPackage.QUALIFIER_VALUE__QUALIFIER, oldQualifier,
          qualifier));
  }
  ...
  public InputPin getValue() {
    if (value != null && value.eIsProxy()) {
      ...
      if (value != oldValue) {
        if (eNotificationRequired())
          eNotify(
              new ENotificationImpl(this, Notification.RESOLVE, UMLPackage.QUALIFIER_VALUE__VALUE, oldValue, value));
      }
    }
    return value;
  }
