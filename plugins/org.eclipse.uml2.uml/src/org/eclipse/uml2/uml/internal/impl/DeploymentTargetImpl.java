...
public abstract class DeploymentTargetImpl extends NamedElementImpl implements DeploymentTarget {
  ...
  public EList<Element> getOwnedElements() {
    ...
    return new DerivedUnionEObjectEList<Element>(Element.class, this, UMLPackage.DEPLOYMENT_TARGET__OWNED_ELEMENT,
  ...
  public EList<Deployment> getDeployments() {
    if (deployments == null) {
      deployments = new EObjectContainmentWithInverseEList.Resolving<Deployment>(Deployment.class, this,
          UMLPackage.DEPLOYMENT_TARGET__DEPLOYMENT, UMLPackage.DEPLOYMENT__LOCATION);
    }
    return deployments;
  }
