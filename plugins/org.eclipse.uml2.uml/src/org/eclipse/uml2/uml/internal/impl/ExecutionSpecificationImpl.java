...
public abstract class ExecutionSpecificationImpl extends InteractionFragmentImpl implements ExecutionSpecification {
    ...
    if (start != null && start.eIsProxy()) {
      ...
      if (start != oldStart) {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, UMLPackage.EXECUTION_SPECIFICATION__START, oldStart,
              start));
      }
    }
    return start;
  ...
  public void setStart(OccurrenceSpecification newStart) {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(this, Notification.SET, UMLPackage.EXECUTION_SPECIFICATION__START, oldStart, start));
  }
  ...
  public OccurrenceSpecification getFinish() {
    if (finish != null && finish.eIsProxy()) {
      ...
      if (finish != oldFinish) {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, UMLPackage.EXECUTION_SPECIFICATION__FINISH,
              oldFinish, finish));
      }
    }
    return finish;
  ...
  public void setFinish(OccurrenceSpecification newFinish) {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(this, Notification.SET, UMLPackage.EXECUTION_SPECIFICATION__FINISH, oldFinish, finish));
  }
   ...
   * @generated
   */
  public boolean validateSameLifeline(DiagnosticChain diagnostics, Map<Object, Object> context) {
