...
public abstract class InvocationActionImpl extends ActionImpl implements InvocationAction {
    ...
    if (cache != null) {
      ...
      if (inputs == null) {
        cache.put(eResource, this, UMLPackage.Literals.ACTION__INPUT,
            inputs = new DerivedUnionEObjectEList<InputPin>(InputPin.class, this, UMLPackage.INVOCATION_ACTION__INPUT,
                INPUT_ESUBSETS));
      }
      return inputs;
    }
    return new DerivedUnionEObjectEList<InputPin>(InputPin.class, this, UMLPackage.INVOCATION_ACTION__INPUT,
        INPUT_ESUBSETS);
  }
  ...
  public EList<InputPin> getArguments() {
    if (arguments == null) {
      arguments = new EObjectContainmentEList.Resolving<InputPin>(InputPin.class, this,
   ...
   * @generated
   */
  public InputPin getArgument(String name, Type type, boolean ignoreCase, EClass eClass, boolean createOnDemand) {
    ...
    if (onPort != null && onPort.eIsProxy()) {
      ...
      if (onPort != oldOnPort) {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, UMLPackage.INVOCATION_ACTION__ON_PORT, oldOnPort,
              onPort));
      }
    }
    return onPort;
  ...
  public boolean isSetInputs() {
    return super.isSetInputs() || eIsSet(UMLPackage.INVOCATION_ACTION__ARGUMENT);
  }
