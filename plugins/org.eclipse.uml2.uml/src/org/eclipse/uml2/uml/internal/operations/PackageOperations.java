/*
 * Copyright (c) 2005, 2025 IBM Corporation, Embarcadero Technologies, CEA, and others.
 ...
 *   Kenn Hussey - 323181, 348433, 535301
...
public class PackageOperations extends NamespaceOperations {
  ...
  protected static class StereotypeApplicationCopier extends EcoreUtil.Copier {
    ...
    protected StereotypeApplicationCopier(Profile profile) {
      this(profile == null ? Collections.<Profile>emptyList() : Collections.singletonList(profile));
    }
    ...
    protected EObject createCopy(EObject eObject) {
      ...
      return baseElement == null ? super.createCopy(eObject)
    ...
    protected EClass getTarget(EClass eClass) {
      ...
      if (definition != null) {
        ...
        String qualifiedName = (namedElement != null) ? getQualifiedName(namedElement)
    ...
    protected EStructuralFeature getTarget(EStructuralFeature eStructuralFeature) {
      ...
      if (definition != null) {
        ...
        String qualifiedName = (namedElement != null) ? getQualifiedName(namedElement)
            : getQualifiedName(eStructuralFeature, NamedElement.SEPARATOR);
    ...
    protected NamedElement getNamedElement(ENamedElement element) {
      ...
      if (element != null) {
        ...
        for (Profile profile : profiles) {
          NamedElement namedElement = UMLUtil.getNamedElement(element, profile);
    ...
    protected void copyEDataTypeAttribute(EAttribute eAttribute, EObject eObject, EObject copyEObject) {
      ...
      if (targetEAttribute != null && targetEAttribute.isChangeable()) {
        ...
        if (targetEAttribute.isMany()) {
          ...
          EList<Object> copyValues = (EList<Object>) copyEObject.eGet(targetEAttribute);
          ...
          if (eAttribute.isMany()) {
            ...
            for (int i = 0, size = values.size(); i < size; i++) {
              copyValues.add(i,
                  targetEFactory.createFromString(targetEDataType, eFactory.convertToString(eDataType, values.get(i))));
            }
          } else {
            copyValues.add(targetEFactory.createFromString(targetEDataType,
                eFactory.convertToString(eDataType, eObject.eGet(eAttribute))));
          }
        } else {
          copyEObject.eSet(targetEAttribute,
              targetEFactory.createFromString(targetEDataType, eFactory.convertToString(eDataType,
                  eAttribute.isMany() ? ((EList<?>) eObject.eGet(eAttribute)).get(0) : eObject.eGet(eAttribute))));
        }
      }
    }
    ...
    protected void copyEEnumAttribute(EAttribute eAttribute, EObject eObject, EObject copyEObject) {
      ...
      if (targetEAttribute != null && targetEAttribute.isChangeable()) {
        EEnum targetEEnum = UMLUtil.getEnumType(targetEAttribute.getEAttributeType());

        if (targetEAttribute.isMany()) {
          @SuppressWarnings("unchecked")
          EList<Enumerator> copyValues = (EList<Enumerator>) copyEObject.eGet(targetEAttribute);

          if (eAttribute.isMany()) {
            @SuppressWarnings("unchecked")
            EList<Enumerator> values = (EList<Enumerator>) eObject.eGet(eAttribute);

            for (int i = 0, size = values.size(); i < size; i++) {
              EEnumLiteral targetEEnumLiteral = targetEEnum.getEEnumLiteral(values.get(i).getName());

              if (targetEEnumLiteral != null) {
                copyValues.add(targetEEnumLiteral.getInstance());
              }
            }
          } else {
            ...
            if (value != null) {
              EEnumLiteral targetEEnumLiteral = targetEEnum.getEEnumLiteral(value.getName());
          ...
          Enumerator value = (Enumerator) (eAttribute.isMany() ? ((EList<?>) eObject.eGet(eAttribute)).get(0)
          ...
          if (value != null) {
            ...
            if (targetEEnumLiteral != null) {
              copyEObject.eSet(targetEAttribute, targetEEnumLiteral.getInstance());
            }
          }
        }
      }
  ...
  public static boolean validateElementsPublicOrPrivate(org.eclipse.uml2.uml.Package package_,
    ...
    for (Element ownedElement : package_.getOwnedElements()) {
      ...
      if (ownedElement instanceof NamedElement) {
        VisibilityKind visibility = ((NamedElement) ownedElement).getVisibility();
        ...
        if (visibility != null && visibility != VisibilityKind.PUBLIC_LITERAL
          ...
          if (diagnostics == null) {
            ...
            diagnostics.add(new BasicDiagnostic(Diagnostic.WARNING, UMLValidator.DIAGNOSTIC_SOURCE,
                ...
                UMLPlugin.INSTANCE.getString("_UI_Package_ElementsPublicOrPrivate_diagnostic", //$NON-NLS-1$
                    getMessageSubstitutions(context, ownedElement, package_)),
  ...
  public static org.eclipse.uml2.uml.Class createOwnedClass(org.eclipse.uml2.uml.Package package_, String name,
      boolean isAbstract) {
    org.eclipse.uml2.uml.Class ownedClass = (org.eclipse.uml2.uml.Class) package_.createOwnedType(name,
  ...
  public static EList<EObject> applyProfile(org.eclipse.uml2.uml.Package package_, Profile profile) {
    return applyProfiles(package_,
        profile == null ? ECollections.<Profile>emptyEList() : ECollections.singletonEList(profile));
  }
  ...
  public static EList<EObject> unapplyProfile(org.eclipse.uml2.uml.Package package_, Profile profile) {
    ...
    if (package_.getProfileApplication(profile) == null) {
      throw new IllegalArgumentException(String.format("profile \"%s\" is not applied", profile.getQualifiedName())); //$NON-NLS-1$
    }
    ...
    return package_.getAllAppliedProfiles().contains(profile) ? ECollections.<EObject>emptyEList()
  ...
  public static EList<EObject> applyProfiles(org.eclipse.uml2.uml.Package package_, EList<Profile> profiles) {
    ...
    for (Profile profile : profiles) {
      ...
      if (profileDefinition == null) {
        throw new IllegalArgumentException(String.format("profile \"%s\" has no Ecore definition", //$NON-NLS-1$
    ...
    StereotypeApplicationCopier copier = new StereotypeApplicationCopier(profiles);
    ...
    for (TreeIterator<EObject> allContents = getAllContents(package_, true, false); allContents.hasNext();) {
      ...
      if (eObject instanceof Element) {
        ...
        if (element instanceof org.eclipse.uml2.uml.Package) {
          ...
          for (ProfileApplication profileApplication : ((org.eclipse.uml2.uml.Package) element)
            ...
            if (profiles.contains(appliedProfile)) {
              EList<EObject> references = getEAnnotation(profileApplication, UML2_UML_PACKAGE_2_0_NS_URI, true)
                  .getReferences();

              if (references.isEmpty()) {
                references.add(appliedProfile.getDefinition());
              } else {
                references.set(0, appliedProfile.getDefinition());
              }
            }
          }
        }
        ...
        for (EObject stereotypeApplication : element.getStereotypeApplications()) {
          ...
          if (stereotype != null && profiles.contains(stereotype.getProfile())) {
    ...
    for (EObject key : copier.keySet()) {
      ...
      for (Setting setting : new ArrayList<EStructuralFeature.Setting>(getNonNavigableInverseReferences(key))) {
  ...
  public static EList<Stereotype> allApplicableStereotypes(org.eclipse.uml2.uml.Package package_) {
    return allApplicableStereotypes(package_, new UniqueEList.FastCompare<Stereotype>());
  }

  protected static EList<Stereotype> allApplicableStereotypes(org.eclipse.uml2.uml.Package package_,
      EList<Stereotype> allApplicableStereotypes) {
    allApplicableStereotypes.addAll(package_.getOwnedStereotypes());

    for (org.eclipse.uml2.uml.Package nestedPackage : package_.getNestedPackages()) {
  ...
  public static Profile containingProfile(org.eclipse.uml2.uml.Package package_) {
    return (Profile) (package_ instanceof Profile ? package_
        : getOwningElement(package_, UMLPackage.Literals.PROFILE, true));
  }

  protected static EList<Profile> getAppliedProfiles(org.eclipse.uml2.uml.Package package_,
  ...
  public static EList<Profile> getAppliedProfiles(org.eclipse.uml2.uml.Package package_) {
    return getAppliedProfiles(package_, new UniqueEList.FastCompare<Profile>());
  }
  ...
  public static Profile getAppliedProfile(org.eclipse.uml2.uml.Package package_, String qualifiedName) {
    ...
    for (ProfileApplication profileApplication : package_.getProfileApplications()) {
      ...
      if (appliedProfile != null && safeEquals(appliedProfile.getQualifiedName(), qualifiedName)) {
  ...
  public static Profile getAppliedProfile(org.eclipse.uml2.uml.Package package_, String qualifiedName,
    ...
    if (appliedProfile == null && recurse) {
      ...
      for (Iterator<org.eclipse.uml2.uml.Package> otherApplyingPackages = ProfileApplicationHelper.getInstance(package_)
          .getOtherApplyingPackages(package_).iterator(); otherApplyingPackages.hasNext() && appliedProfile == null;) {
  ...
  public static EList<ProfileApplication> getAllProfileApplications(org.eclipse.uml2.uml.Package package_) {
    ...
    for (org.eclipse.uml2.uml.Package applyingPackage : ProfileApplicationHelper.getInstance(package_)
  ...
  public static ProfileApplication getProfileApplication(org.eclipse.uml2.uml.Package package_, Profile profile,
    ...
    if (profileApplication == null && recurse) {
      ...
      for (Iterator<org.eclipse.uml2.uml.Package> otherApplyingPackages = ProfileApplicationHelper.getInstance(package_)
          .getOtherApplyingPackages(package_).iterator(); otherApplyingPackages.hasNext()
  ...
  public static EList<Profile> getAllAppliedProfiles(org.eclipse.uml2.uml.Package package_) {
    EList<Profile> allAppliedProfiles = getAppliedProfiles(package_, new UniqueEList.FastCompare<Profile>());
  ...
  protected static EList<org.eclipse.uml2.uml.Package> getAllImportedPackages(org.eclipse.uml2.uml.Package package_,
    ...
    for (PackageImport packageImport : package_.getPackageImports()) {
      ...
      if (packageImport.getVisibility() == VisibilityKind.PUBLIC_LITERAL) {
        org.eclipse.uml2.uml.Package importedPackage = packageImport.getImportedPackage();
  ...
  protected static EList<PackageableElement> visibleMembers(org.eclipse.uml2.uml.Package package_,
      EList<PackageableElement> visibleMembers) {

    for (NamedElement ownedMember : package_.getOwnedMembers()) {

      if (ownedMember instanceof PackageableElement && ownedMember.getVisibility() == VisibilityKind.PUBLIC_LITERAL) {
  ...
  public static EList<PackageableElement> visibleMembers(org.eclipse.uml2.uml.Package package_) {
    ...
    for (org.eclipse.uml2.uml.Package importedPackage : getAllImportedPackages(package_,
  ...
  protected static boolean containsSpecializations(org.eclipse.uml2.uml.Package package_, Classifier classifier) {

    for (Type ownedType : package_.getOwnedTypes()) {

      if (ownedType instanceof Classifier && ((Classifier) ownedType).allParents().contains(classifier)) {
