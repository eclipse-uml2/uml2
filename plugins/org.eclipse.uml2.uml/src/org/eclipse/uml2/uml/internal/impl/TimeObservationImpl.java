...
public class TimeObservationImpl extends ObservationImpl implements TimeObservation {
    ...
    if (event != null && event.eIsProxy()) {
      ...
      if (event != oldEvent) {
        if (eNotificationRequired())
          eNotify(
              new ENotificationImpl(this, Notification.RESOLVE, UMLPackage.TIME_OBSERVATION__EVENT, oldEvent, event));
      }
    }
    return event;
  }
  ...
  public void setFirstEvent(boolean newFirstEvent) {
    ...
    if (newFirstEvent)
      ...
      eFlags &= ~FIRST_EVENT_EFLAG;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, UMLPackage.TIME_OBSERVATION__FIRST_EVENT, oldFirstEvent,
          newFirstEvent));
  }
