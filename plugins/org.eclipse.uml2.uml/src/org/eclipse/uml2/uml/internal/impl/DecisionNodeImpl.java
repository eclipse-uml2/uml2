...
public class DecisionNodeImpl extends ControlNodeImpl implements DecisionNode {
    ...
    if (decisionInput != null && decisionInput.eIsProxy()) {
      ...
      if (decisionInput != oldDecisionInput) {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, UMLPackage.DECISION_NODE__DECISION_INPUT,
  ...
  public void setDecisionInput(Behavior newDecisionInput) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, UMLPackage.DECISION_NODE__DECISION_INPUT, oldDecisionInput,
          decisionInput));
  }
  ...
  public ObjectFlow getDecisionInputFlow() {
    if (decisionInputFlow != null && decisionInputFlow.eIsProxy()) {
      ...
      if (decisionInputFlow != oldDecisionInputFlow) {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, UMLPackage.DECISION_NODE__DECISION_INPUT_FLOW,
  ...
  public void setDecisionInputFlow(ObjectFlow newDecisionInputFlow) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, UMLPackage.DECISION_NODE__DECISION_INPUT_FLOW,
          oldDecisionInputFlow, decisionInputFlow));
  }
   ...
   * @generated
   */
  public boolean validateIncomingOutgoingEdges(DiagnosticChain diagnostics, Map<Object, Object> context) {
   ...
   * @generated
   */
  public boolean validateDecisionInputFlowIncoming(DiagnosticChain diagnostics, Map<Object, Object> context) {
   ...
   * @generated
   */
  public boolean validateParameters(DiagnosticChain diagnostics, Map<Object, Object> context) {
   ...
   * @generated
   */
  public boolean validateZeroInputParameters(DiagnosticChain diagnostics, Map<Object, Object> context) {
   ...
   * @generated
   */
  public boolean validateIncomingObjectOneInputParameter(DiagnosticChain diagnostics, Map<Object, Object> context) {
   ...
   * @generated
   */
  public boolean validateIncomingControlOneInputParameter(DiagnosticChain diagnostics, Map<Object, Object> context) {
   ...
   * @generated
   */
  public boolean validateTwoInputParameters(DiagnosticChain diagnostics, Map<Object, Object> context) {
  ...
  public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
    ...
    case UMLPackage.DECISION_NODE___VALIDATE_DECISION_INPUT_FLOW_INCOMING__DIAGNOSTICCHAIN_MAP:
      return validateDecisionInputFlowIncoming((DiagnosticChain) arguments.get(0),
          (Map<Object, Object>) arguments.get(1));
    ...
    case UMLPackage.DECISION_NODE___VALIDATE_INCOMING_CONTROL_ONE_INPUT_PARAMETER__DIAGNOSTICCHAIN_MAP:
      return validateIncomingControlOneInputParameter((DiagnosticChain) arguments.get(0),
          (Map<Object, Object>) arguments.get(1));
    ...
    case UMLPackage.DECISION_NODE___VALIDATE_INCOMING_OBJECT_ONE_INPUT_PARAMETER__DIAGNOSTICCHAIN_MAP:
      return validateIncomingObjectOneInputParameter((DiagnosticChain) arguments.get(0),
          (Map<Object, Object>) arguments.get(1));
    }
