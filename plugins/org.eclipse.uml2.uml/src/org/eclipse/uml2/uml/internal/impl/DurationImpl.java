...
public class DurationImpl extends ValueSpecificationImpl implements Duration {
  ...
  public EList<Element> getOwnedElements() {
    ...
    return new DerivedUnionEObjectEList<Element>(Element.class, this, UMLPackage.DURATION__OWNED_ELEMENT,
   ...
   * @ordered
   */
  protected static final int[] OWNED_ELEMENT_ESUBSETS = new int[] { UMLPackage.DURATION__OWNED_COMMENT,
  ...
  public ValueSpecification getExpr() {
    if (expr != null && expr.eIsProxy()) {
      ...
      if (expr != oldExpr) {
        ...
        NotificationChain msgs = oldExpr.eInverseRemove(this, EOPPOSITE_FEATURE_BASE - UMLPackage.DURATION__EXPR, null,
            null);
        if (newExpr.eInternalContainer() == null) {
          msgs = newExpr.eInverseAdd(this, EOPPOSITE_FEATURE_BASE - UMLPackage.DURATION__EXPR, null, msgs);
        }
        if (msgs != null)
          msgs.dispatch();
  ...
  public NotificationChain basicSetExpr(ValueSpecification newExpr, NotificationChain msgs) {
    ...
    expr = newExpr;
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, UMLPackage.DURATION__EXPR, oldExpr,
          newExpr);
      if (msgs == null)
        msgs = notification;
      else
  ...
  public void setExpr(ValueSpecification newExpr) {
    if (newExpr != expr) {
      ...
      if (expr != null)
        msgs = ((InternalEObject) expr).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - UMLPackage.DURATION__EXPR, null,
            msgs);
      if (newExpr != null)
        msgs = ((InternalEObject) newExpr).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - UMLPackage.DURATION__EXPR, null,
            msgs);
  ...
  public EList<Observation> getObservations() {
    if (observations == null) {
      observations = new EObjectResolvingEList<Observation>(Observation.class, this, UMLPackage.DURATION__OBSERVATION);
    }
    return observations;
  }
