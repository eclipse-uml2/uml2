...
public class IncludeImpl extends NamedElementImpl implements Include {
  ...
  public EList<Element> getRelatedElements() {
    ...
    return new DerivedUnionEObjectEList<Element>(Element.class, this, UMLPackage.INCLUDE__RELATED_ELEMENT,
    ...
    if (cache != null) {
      ...
      if (sources == null) {
        cache.put(eResource, this, UMLPackage.Literals.DIRECTED_RELATIONSHIP__SOURCE,
            sources = new DerivedUnionEObjectEList<Element>(Element.class, this, UMLPackage.INCLUDE__SOURCE,
                SOURCE_ESUBSETS));
      }
      return sources;
    }
    ...
    if (cache != null) {
      ...
      if (targets == null) {
        cache.put(eResource, this, UMLPackage.Literals.DIRECTED_RELATIONSHIP__TARGET,
            targets = new DerivedUnionEObjectEList<Element>(Element.class, this, UMLPackage.INCLUDE__TARGET,
                TARGET_ESUBSETS));
      }
      return targets;
    }
    ...
    if (addition != null && addition.eIsProxy()) {
      ...
      if (addition != oldAddition) {
        if (eNotificationRequired())
          eNotify(
              new ENotificationImpl(this, Notification.RESOLVE, UMLPackage.INCLUDE__ADDITION, oldAddition, addition));
      }
    }
    return addition;
  }
  ...
  public void setIncludingCase(UseCase newIncludingCase) {
    if (newIncludingCase != eInternalContainer()
      ...
      if (newIncludingCase != null)
        msgs = ((InternalEObject) newIncludingCase).eInverseAdd(this, UMLPackage.USE_CASE__INCLUDE, UseCase.class,
            msgs);
      msgs = basicSetIncludingCase(newIncludingCase, msgs);
      if (msgs != null)
        msgs.dispatch();
    } else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, UMLPackage.INCLUDE__INCLUDING_CASE, newIncludingCase,
          newIncludingCase));
  }
   ...
   * @ordered
   */
  protected static final int[] RELATED_ELEMENT_ESUBSETS = new int[] { UMLPackage.INCLUDE__SOURCE,
  ...
  public boolean isSetNamespace() {
    return super.isSetNamespace() || eIsSet(UMLPackage.INCLUDE__INCLUDING_CASE);
  }
