...
public class ExecutionSpecificationOperations extends NamedElementOperations {
   ...
   * @generated NOT
   */
  public static boolean validateSameLifeline(ExecutionSpecification executionSpecification, DiagnosticChain diagnostics,
    ...
    if (start != null) {
      ...
      if (finish != null) {
        ...
        if (!startCovereds.containsAll(finishCovereds) || !finishCovereds.containsAll(startCovereds)) {
          ...
          if (diagnostics != null) {
            diagnostics.add(new BasicDiagnostic(Diagnostic.WARNING, UMLValidator.DIAGNOSTIC_SOURCE,
                ...
                UMLPlugin.INSTANCE.getString("_UI_ExecutionSpecification_SameLifeline_diagnostic", //$NON-NLS-1$
                    getMessageSubstitutions(context, executionSpecification)),
