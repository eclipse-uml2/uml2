 ...
 * @generated
 */
public class CreateLinkActionOperations extends WriteLinkActionOperations {
   ...
   * @generated
   */
  public static boolean validateAssociationNotAbstract(CreateLinkAction createLinkAction, DiagnosticChain diagnostics,
        ...
        diagnostics.add(new BasicDiagnostic(Diagnostic.ERROR, UMLValidator.DIAGNOSTIC_SOURCE,
            ...
            org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", //$NON-NLS-1$
                new Object[] { "validateAssociationNotAbstract", //$NON-NLS-1$
                    org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(createLinkAction, context) }), new Object[] { createLinkAction }));
      }
      return false;
    }
    return true;
