 ...
 * @generated
 */
public class ValuePinOperations extends InputPinOperations {
   ...
   * @generated
   */
  public static boolean validateCompatibleType(ValuePin valuePin, DiagnosticChain diagnostics,
        ...
        diagnostics.add(new BasicDiagnostic(Diagnostic.ERROR, UMLValidator.DIAGNOSTIC_SOURCE,
            ...
            org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", //$NON-NLS-1$
                new Object[] { "validateCompatibleType", //$NON-NLS-1$
                    org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(valuePin, context) }), new Object[] { valuePin }));
      }
      return false;
    }
    return true;
   ...
   * @generated
   */
  public static boolean validateNoIncomingEdges(ValuePin valuePin, DiagnosticChain diagnostics,
      Map<Object, Object> context) {
    // TODO: implement this method
    // -> specify the condition that violates the invariant
    // -> verify the details of the diagnostic, including severity and message
