...
public class GateImpl extends MessageEndImpl implements Gate {
   ...
   * @generated
   */
  public boolean validateActualGateMatched(DiagnosticChain diagnostics, Map<Object, Object> context) {
   ...
   * @generated
   */
  public boolean validateInsideCfMatched(DiagnosticChain diagnostics, Map<Object, Object> context) {
   ...
   * @generated
   */
  public boolean validateOutsideCfMatched(DiagnosticChain diagnostics, Map<Object, Object> context) {
   ...
   * @generated
   */
  public boolean validateFormalGateDistinguishable(DiagnosticChain diagnostics, Map<Object, Object> context) {
   ...
   * @generated
   */
  public boolean validateActualGateDistinguishable(DiagnosticChain diagnostics, Map<Object, Object> context) {
   ...
   * @generated
   */
  public boolean validateOutsideCfGateDistinguishable(DiagnosticChain diagnostics, Map<Object, Object> context) {
   ...
   * @generated
   */
  public boolean validateInsideCfGateDistinguishable(DiagnosticChain diagnostics, Map<Object, Object> context) {
  ...
  public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
    ...
    case UMLPackage.GATE___VALIDATE_FORMAL_GATE_DISTINGUISHABLE__DIAGNOSTICCHAIN_MAP:
      return validateFormalGateDistinguishable((DiagnosticChain) arguments.get(0),
          (Map<Object, Object>) arguments.get(1));
    case UMLPackage.GATE___VALIDATE_ACTUAL_GATE_DISTINGUISHABLE__DIAGNOSTICCHAIN_MAP:
      return validateActualGateDistinguishable((DiagnosticChain) arguments.get(0),
          (Map<Object, Object>) arguments.get(1));
    case UMLPackage.GATE___VALIDATE_OUTSIDE_CF_GATE_DISTINGUISHABLE__DIAGNOSTICCHAIN_MAP:
      return validateOutsideCfGateDistinguishable((DiagnosticChain) arguments.get(0),
          (Map<Object, Object>) arguments.get(1));
    case UMLPackage.GATE___VALIDATE_INSIDE_CF_GATE_DISTINGUISHABLE__DIAGNOSTICCHAIN_MAP:
      return validateInsideCfGateDistinguishable((DiagnosticChain) arguments.get(0),
          (Map<Object, Object>) arguments.get(1));
  ...
  public String getName() {
    ...
    if (message != null) {
      ...
      if (isActual() || isOutsideCF()) {
        return (isSend() ? "out_" //$NON-NLS-1$
            : "in_") + message.getName(); //$NON-NLS-1$
      } else {
        return (isSend() ? "in_" //$NON-NLS-1$
