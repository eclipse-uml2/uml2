...
public abstract class BehavioredClassifierImpl
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd,
		...
		switch (featureID) {
			...
			case UMLPackage.BEHAVIORED_CLASSIFIER__OWNED_ELEMENT_IMPORT :
				return ((InternalEList<?>) getOwnedElementImports())
					.basicRemove(otherEnd, msgs);
			case UMLPackage.BEHAVIORED_CLASSIFIER__OWNED_PACKAGE_IMPORT :
				return ((InternalEList<?>) getOwnedPackageImports())
					.basicRemove(otherEnd, msgs);
			case UMLPackage.BEHAVIORED_CLASSIFIER__OWNED_CONSTRAINT :
