...
public class UseCaseImpl extends BehavioredClassifierImpl implements UseCase {
  ...
  public EList<NamedElement> getOwnedMembers() {
    ...
    return new DerivedUnionEObjectEList<NamedElement>(NamedElement.class, this, UMLPackage.USE_CASE__OWNED_MEMBER,
  ...
  public EList<Include> getIncludes() {
    if (includes == null) {
      includes = new EObjectContainmentWithInverseEList.Resolving<Include>(Include.class, this,
          UMLPackage.USE_CASE__INCLUDE, UMLPackage.INCLUDE__INCLUDING_CASE);
    }
    return includes;
  }
   ...
   * @generated
   */
  public Include getInclude(String name, UseCase addition, boolean ignoreCase, boolean createOnDemand) {
  ...
  public EList<Extend> getExtends() {
    if (extends_ == null) {
      extends_ = new EObjectContainmentWithInverseEList.Resolving<Extend>(Extend.class, this,
          UMLPackage.USE_CASE__EXTEND, UMLPackage.EXTEND__EXTENSION);
    }
    return extends_;
  }
   ...
   * @generated
   */
  public Extend getExtend(String name, UseCase extendedCase, boolean ignoreCase, boolean createOnDemand) {
  ...
  public EList<ExtensionPoint> getExtensionPoints() {
    if (extensionPoints == null) {
      extensionPoints = new EObjectContainmentWithInverseEList.Resolving<ExtensionPoint>(ExtensionPoint.class, this,
          UMLPackage.USE_CASE__EXTENSION_POINT, UMLPackage.EXTENSION_POINT__USE_CASE);
    }
   ...
   * @generated
   */
  public ExtensionPoint getExtensionPoint(String name, boolean ignoreCase, boolean createOnDemand) {
    extensionPointLoop: for (ExtensionPoint extensionPoint : getExtensionPoints()) {
      if (name != null
          && !(ignoreCase ? name.equalsIgnoreCase(extensionPoint.getName()) : name.equals(extensionPoint.getName())))
  ...
  public EList<Classifier> getSubjects() {
    if (subjects == null) {
      subjects = new EObjectWithInverseResolvingEList.ManyInverse<Classifier>(Classifier.class, this,
          UMLPackage.USE_CASE__SUBJECT, UMLPackage.CLASSIFIER__USE_CASE);
    }
    return subjects;
  }
   ...
   * @generated
   */
  public boolean validateMustHaveName(DiagnosticChain diagnostics, Map<Object, Object> context) {
   ...
   * @generated
   */
  public boolean validateNoAssociationToUseCase(DiagnosticChain diagnostics, Map<Object, Object> context) {
   ...
   * @generated
   */
  public boolean validateCannotIncludeSelf(DiagnosticChain diagnostics, Map<Object, Object> context) {
  ...
  public EList<UseCase> allIncludedUseCases() {
    ...
    if (cache != null) {
      ...
      if (result == null) {
        cache.put(this, UMLPackage.Literals.USE_CASE___ALL_INCLUDED_USE_CASES,
    ...
    case UMLPackage.USE_CASE__OWNED_TEMPLATE_SIGNATURE:
      if (ownedTemplateSignature != null)
        msgs = ((InternalEObject) ownedTemplateSignature).eInverseRemove(this,
            EOPPOSITE_FEATURE_BASE - UMLPackage.USE_CASE__OWNED_TEMPLATE_SIGNATURE, null, msgs);
  ...
  public boolean isSetOwnedMembers() {
    return super.isSetOwnedMembers() || eIsSet(UMLPackage.USE_CASE__EXTEND)
        || eIsSet(UMLPackage.USE_CASE__EXTENSION_POINT) || eIsSet(UMLPackage.USE_CASE__INCLUDE);
  }
   ...
   * @ordered
   */
  protected static final int[] OWNED_MEMBER_ESUBSETS = new int[] { UMLPackage.USE_CASE__OWNED_RULE,
      UMLPackage.USE_CASE__OWNED_USE_CASE, UMLPackage.USE_CASE__OWNED_BEHAVIOR, UMLPackage.USE_CASE__EXTEND,
