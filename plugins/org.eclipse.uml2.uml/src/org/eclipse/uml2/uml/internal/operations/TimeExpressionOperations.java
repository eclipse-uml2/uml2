...
public class TimeExpressionOperations extends ValueSpecificationOperations {
   ...
   * @generated
   */
  public static boolean validateNoExprRequiresObservation(TimeExpression timeExpression, DiagnosticChain diagnostics,
        ...
        diagnostics.add(new BasicDiagnostic(Diagnostic.ERROR, UMLValidator.DIAGNOSTIC_SOURCE,
            ...
            org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", //$NON-NLS-1$
                new Object[] { "validateNoExprRequiresObservation", //$NON-NLS-1$
                    org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(timeExpression, context) }), new Object[] { timeExpression }));
      }
      return false;
    }
    return true;
  ...
  public static String stringValue(TimeExpression timeExpression) {
    ...
    return expr == null || expr instanceof TimeExpression ? ValueSpecificationOperations.stringValue(timeExpression)
        : expr.stringValue();
  }
