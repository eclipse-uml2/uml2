 ...
 * @generated
 */
public class DurationConstraintOperations extends ConstraintOperations {
   ...
   * @generated
   */
  public static boolean validateFirstEventMultiplicity(DurationConstraint durationConstraint,
        ...
        diagnostics.add(new BasicDiagnostic(Diagnostic.ERROR, UMLValidator.DIAGNOSTIC_SOURCE,
            ...
            org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", //$NON-NLS-1$
                new Object[] { "validateFirstEventMultiplicity", //$NON-NLS-1$
                    org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(durationConstraint, context) }), new Object[] { durationConstraint }));
      }
      return false;
    }
    return true;
   ...
   * @generated
   */
  public static boolean validateHasOneOrTwoConstrainedElements(DurationConstraint durationConstraint,
      DiagnosticChain diagnostics, Map<Object, Object> context) {
    // TODO: implement this method
    // -> specify the condition that violates the invariant
    // -> verify the details of the diagnostic, including severity and message
