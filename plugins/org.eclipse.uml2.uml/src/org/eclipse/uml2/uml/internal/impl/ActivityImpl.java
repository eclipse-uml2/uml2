...
public class ActivityImpl extends BehaviorImpl implements Activity {
  ...
  public EList<Element> getOwnedElements() {
    ...
    return new DerivedUnionEObjectEList<Element>(Element.class, this, UMLPackage.ACTIVITY__OWNED_ELEMENT,
  ...
  public EList<NamedElement> getOwnedMembers() {
    ...
    return new DerivedUnionEObjectEList<NamedElement>(NamedElement.class, this, UMLPackage.ACTIVITY__OWNED_MEMBER,
  ...
  private EList<ActivityGroup> createGroupsList() {
    return new SubsetSupersetEObjectResolvingEList<ActivityGroup>(ActivityGroup.class, this, UMLPackage.ACTIVITY__GROUP,
        null, GROUP_ESUBSETS);
  }
  ...
  private EList<ActivityNode> createNodesList() {
    return new SubsetSupersetEObjectResolvingEList<ActivityNode>(ActivityNode.class, this, UMLPackage.ACTIVITY__NODE,
        null, NODE_ESUBSETS);
  }
  ...
  public void setIsReadOnly(boolean newIsReadOnly) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, UMLPackage.ACTIVITY__IS_READ_ONLY, oldIsReadOnly,
          newIsReadOnly));
  }
  ...
  public void setIsSingleExecution(boolean newIsSingleExecution) {
    ...
    if (newIsSingleExecution)
      ...
      eFlags &= ~IS_SINGLE_EXECUTION_EFLAG;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, UMLPackage.ACTIVITY__IS_SINGLE_EXECUTION,
          oldIsSingleExecution, newIsSingleExecution));
  }
  ...
  private EList<StructuredActivityNode> createStructuredNodesList() {
    return new SubsetSupersetEObjectContainmentEList.Resolving<StructuredActivityNode>(StructuredActivityNode.class,
        this, UMLPackage.ACTIVITY__STRUCTURED_NODE, STRUCTURED_NODE_ESUPERSETS, null);
  }
   ...
   * @generated
   */
  public StructuredActivityNode createStructuredNode(String name, EClass eClass) {
  ...
  public EList<Variable> getVariables() {
    if (variables == null) {
      variables = new EObjectContainmentWithInverseEList.Resolving<Variable>(Variable.class, this,
          UMLPackage.ACTIVITY__VARIABLE, UMLPackage.VARIABLE__ACTIVITY_SCOPE);
    }
    return variables;
  }
  ...
  public EList<ActivityEdge> getEdges() {
    if (edges == null) {
      edges = new EObjectContainmentWithInverseEList.Resolving<ActivityEdge>(ActivityEdge.class, this,
          UMLPackage.ACTIVITY__EDGE, UMLPackage.ACTIVITY_EDGE__ACTIVITY);
    }
    return edges;
  }
  ...
  private EList<ActivityPartition> createPartitionsList() {
    return new SubsetSupersetEObjectResolvingEList<ActivityPartition>(ActivityPartition.class, this,
        UMLPackage.ACTIVITY__PARTITION, PARTITION_ESUPERSETS, null);
  }
  ...
  public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
    ...
    case UMLPackage.ACTIVITY__OWNED_TEMPLATE_SIGNATURE:
      if (ownedTemplateSignature != null)
        msgs = ((InternalEObject) ownedTemplateSignature).eInverseRemove(this,
            EOPPOSITE_FEATURE_BASE - UMLPackage.ACTIVITY__OWNED_TEMPLATE_SIGNATURE, null, msgs);
    ...
    case UMLPackage.ACTIVITY__SPECIFICATION:
      if (specification != null)
        msgs = ((InternalEObject) specification).eInverseRemove(this, UMLPackage.BEHAVIORAL_FEATURE__METHOD,
  ...
  public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
    ...
    case UMLPackage.ACTIVITY___VALIDATE_FEATURE_OF_CONTEXT_CLASSIFIER__DIAGNOSTICCHAIN_MAP:
      return validateFeatureOfContextClassifier((DiagnosticChain) arguments.get(0),
          (Map<Object, Object>) arguments.get(1));
    ...
    case UMLPackage.ACTIVITY___VALIDATE_MAXIMUM_ONE_PARAMETER_NODE__DIAGNOSTICCHAIN_MAP:
      return validateMaximumOneParameterNode((DiagnosticChain) arguments.get(0),
          (Map<Object, Object>) arguments.get(1));
    case UMLPackage.ACTIVITY___VALIDATE_MAXIMUM_TWO_PARAMETER_NODES__DIAGNOSTICCHAIN_MAP:
      return validateMaximumTwoParameterNodes((DiagnosticChain) arguments.get(0),
          (Map<Object, Object>) arguments.get(1));
    }
  ...
  public boolean isSetOwnedElements() {
    return super.isSetOwnedElements() || eIsSet(UMLPackage.ACTIVITY__EDGE) || eIsSet(UMLPackage.ACTIVITY__NODE)
  ...
  public boolean isSetOwnedMembers() {
    return super.isSetOwnedMembers() || eIsSet(UMLPackage.ACTIVITY__VARIABLE);
  }
   ...
   * @ordered
   */
  protected static final int[] OWNED_ELEMENT_ESUBSETS = new int[] { UMLPackage.ACTIVITY__OWNED_COMMENT,
      UMLPackage.ACTIVITY__NAME_EXPRESSION, UMLPackage.ACTIVITY__ELEMENT_IMPORT, UMLPackage.ACTIVITY__PACKAGE_IMPORT,
      UMLPackage.ACTIVITY__OWNED_MEMBER, UMLPackage.ACTIVITY__TEMPLATE_BINDING,
      UMLPackage.ACTIVITY__OWNED_TEMPLATE_SIGNATURE, UMLPackage.ACTIVITY__COLLABORATION_USE,
      UMLPackage.ACTIVITY__GENERALIZATION, UMLPackage.ACTIVITY__SUBSTITUTION,
      UMLPackage.ACTIVITY__INTERFACE_REALIZATION, UMLPackage.ACTIVITY__EDGE, UMLPackage.ACTIVITY__NODE,
   ...
   * @ordered
   */
  protected static final int[] OWNED_MEMBER_ESUBSETS = new int[] { UMLPackage.ACTIVITY__OWNED_RULE,
      UMLPackage.ACTIVITY__OWNED_USE_CASE, UMLPackage.ACTIVITY__OWNED_ATTRIBUTE, UMLPackage.ACTIVITY__OWNED_CONNECTOR,
      UMLPackage.ACTIVITY__OWNED_BEHAVIOR, UMLPackage.ACTIVITY__OWNED_OPERATION, UMLPackage.ACTIVITY__NESTED_CLASSIFIER,
      UMLPackage.ACTIVITY__OWNED_RECEPTION, UMLPackage.ACTIVITY__OWNED_PARAMETER,
  ...
  private EList<ActivityGroup> createOwnedGroupsList() {
    return new SubsetSupersetEObjectContainmentEList.Resolving<ActivityGroup>(ActivityGroup.class, this,
        UMLPackage.ACTIVITY__OWNED_GROUP, OWNED_GROUP_ESUPERSETS, OWNED_GROUP_ESUBSETS);
  }
   ...
   * @generated
   */
  public ActivityGroup getOwnedGroup(String name, boolean ignoreCase, EClass eClass, boolean createOnDemand) {
    ownedGroupLoop: for (ActivityGroup ownedGroup : getOwnedGroups()) {
      ...
      if (name != null
          && !(ignoreCase ? name.equalsIgnoreCase(ownedGroup.getName()) : name.equals(ownedGroup.getName())))
        continue ownedGroupLoop;
      return ownedGroup;
    }
  ...
  public ActivityGroup getGroup(String name, boolean ignoreCase, EClass eClass) {
    groupLoop: for (ActivityGroup group : getGroups()) {
      if (eClass != null && !eClass.isInstance(group))
        continue groupLoop;
      if (name != null && !(ignoreCase ? name.equalsIgnoreCase(group.getName()) : name.equals(group.getName())))
        continue groupLoop;
      return group;
    }
    return null;
   ...
   * @ordered
   */
  protected static final int[] STRUCTURED_NODE_ESUPERSETS = new int[] { UMLPackage.ACTIVITY__GROUP,
  ...
  private EList<ActivityNode> createOwnedNodesList() {
    return new SubsetSupersetEObjectContainmentEList.Resolving<ActivityNode>(ActivityNode.class, this,
        UMLPackage.ACTIVITY__OWNED_NODE, OWNED_NODE_ESUPERSETS, null);
  }
   ...
   * @generated
   */
  public ActivityNode getOwnedNode(String name, boolean ignoreCase, EClass eClass, boolean createOnDemand) {
  ...
  public StructuredActivityNode getStructuredNode(String name, boolean ignoreCase, EClass eClass,
    ...
    structuredNodeLoop: for (StructuredActivityNode structuredNode : getStructuredNodes()) {
      ...
      if (name != null
          && !(ignoreCase ? name.equalsIgnoreCase(structuredNode.getName()) : name.equals(structuredNode.getName())))
        continue structuredNodeLoop;
   ...
   * @generated
   */
  public boolean validateMaximumOneParameterNode(DiagnosticChain diagnostics, Map<Object, Object> context) {
   ...
   * @generated
   */
  public boolean validateMaximumTwoParameterNodes(DiagnosticChain diagnostics, Map<Object, Object> context) {
   ...
   * @ordered
   */
  protected static final int[] NODE_ESUBSETS = new int[] { UMLPackage.ACTIVITY__OWNED_NODE,
   ...
   * @ordered
   */
  protected static final int[] GROUP_ESUBSETS = new int[] { UMLPackage.ACTIVITY__OWNED_GROUP,
      UMLPackage.ACTIVITY__STRUCTURED_NODE };
   ...
   * @generated
   */
  public ActivityPartition getPartition(String name, boolean ignoreCase, boolean createOnDemand) {
