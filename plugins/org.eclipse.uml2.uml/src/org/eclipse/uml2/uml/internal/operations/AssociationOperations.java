...
public class AssociationOperations extends ClassifierOperations {
   ...
   * @generated NOT
   */
  public static boolean validateSpecializedEndNumber(Association association, DiagnosticChain diagnostics,
    ...
    for (Classifier general : association.getGenerals()) {
      ...
      if (general instanceof Association && ((Association) general).getMemberEnds().size() != memberEndsSize) {
        ...
        if (diagnostics != null) {
          diagnostics.add(new BasicDiagnostic(Diagnostic.WARNING, UMLValidator.DIAGNOSTIC_SOURCE,
              ...
              UMLPlugin.INSTANCE.getString("_UI_Association_SpecializedEndNumber_diagnostic", //$NON-NLS-1$
                  getMessageSubstitutions(context, association, general)),
   ...
   * @generated NOT
   */
  public static boolean validateSpecializedEndTypes(Association association, DiagnosticChain diagnostics,
      Map<Object, Object> context) {
    boolean result = true;
    ...
    for (Classifier general : association.getGenerals()) {
      ...
      if (general instanceof Association) {
        ...
        for (int i = 0; i < memberEnds.size() && i < generalMemberEnds.size(); i++) {

          Type memberEndType = memberEnds.get(i).getType();
          Type generalMemberEndType = generalMemberEnds.get(i).getType();
          ...
          if (memberEndType != null && generalMemberEndType != null
            ...
            if (diagnostics != null) {
              diagnostics.add(new BasicDiagnostic(Diagnostic.WARNING, UMLValidator.DIAGNOSTIC_SOURCE,
                  ...
                  UMLPlugin.INSTANCE.getString("_UI_Association_SpecializedEndTypes_diagnostic", //$NON-NLS-1$
                      getMessageSubstitutions(context, association, general)),
                  new Object[] { association }));
            }
   ...
   * @generated
   */
  public static boolean validateBinaryAssociations(Association association, DiagnosticChain diagnostics,
      Map<Object, Object> context) {
        ...
        diagnostics.add(new BasicDiagnostic(Diagnostic.ERROR, UMLValidator.DIAGNOSTIC_SOURCE,
            ...
            org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", //$NON-NLS-1$
                new Object[] { "validateBinaryAssociations", //$NON-NLS-1$
                    org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(association, context) }), new Object[] { association }));
      }
      return false;
    }
    return true;
   ...
   * @generated
   */
  public static boolean validateAssociationEnds(Association association, DiagnosticChain diagnostics,
      Map<Object, Object> context) {
    // TODO: implement this method
    // -> specify the condition that violates the invariant
    // -> verify the details of the diagnostic, including severity and message
   ...
   * @generated
   */
  public static boolean validateEndsMustBeTyped(Association association, DiagnosticChain diagnostics,
      Map<Object, Object> context) {
    // TODO: implement this method
    // -> specify the condition that violates the invariant
    // -> verify the details of the diagnostic, including severity and message
  ...
  public static EList<Type> getEndTypes(Association association) {
    ...
    for (Property memberEnd : association.getMemberEnds()) {
      Type endType = (Type) memberEnd.eGet(UMLPackage.Literals.TYPED_ELEMENT__TYPE, false);
    ...
    return new UnionEObjectEList<Type>((InternalEObject) association, UMLPackage.Literals.ASSOCIATION__END_TYPE,
        endTypes.size(), endTypes.toArray());
  }
