...
public class ExtensionPointImpl extends RedefinableElementImpl implements ExtensionPoint {
  ...
  public void setUseCase(UseCase newUseCase) {
    if (newUseCase != eInternalContainer()
      ...
      if (newUseCase != null)
        msgs = ((InternalEObject) newUseCase).eInverseAdd(this, UMLPackage.USE_CASE__EXTENSION_POINT, UseCase.class,
            msgs);
      ...
      eNotify(
          new ENotificationImpl(this, Notification.SET, UMLPackage.EXTENSION_POINT__USE_CASE, newUseCase, newUseCase));
  }
  ...
  public boolean isSetNamespace() {
    return super.isSetNamespace() || eIsSet(UMLPackage.EXTENSION_POINT__USE_CASE);
  }
