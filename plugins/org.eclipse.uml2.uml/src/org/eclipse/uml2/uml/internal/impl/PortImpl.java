...
public class PortImpl extends PropertyImpl implements Port {
  ...
  private EList<Property> createRedefinedPropertiesList() {
    return new SubsetSupersetEObjectResolvingEList<Property>(Property.class, this, UMLPackage.PORT__REDEFINED_PROPERTY,
  ...
  public void setIsBehavior(boolean newIsBehavior) {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(this, Notification.SET, UMLPackage.PORT__IS_BEHAVIOR, oldIsBehavior, newIsBehavior));
  }
  ...
  public void setIsConjugated(boolean newIsConjugated) {
    ...
    if (newIsConjugated)
      ...
      eFlags &= ~IS_CONJUGATED_EFLAG;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, UMLPackage.PORT__IS_CONJUGATED, oldIsConjugated,
          newIsConjugated));
  }
  ...
  public void setIsService(boolean newIsService) {
    ...
    if (newIsService)
      ...
      eFlags &= ~IS_SERVICE_EFLAG;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, UMLPackage.PORT__IS_SERVICE, oldIsService, newIsService));
  }
  ...
  private EList<Port> createRedefinedPortsList() {
    return new SubsetSupersetEObjectResolvingEList<Port>(Port.class, this, UMLPackage.PORT__REDEFINED_PORT,
  ...
  public Port getRedefinedPort(String name, Type type, boolean ignoreCase) {
    redefinedPortLoop: for (Port redefinedPort : getRedefinedPorts()) {
      if (name != null
          && !(ignoreCase ? name.equalsIgnoreCase(redefinedPort.getName()) : name.equals(redefinedPort.getName())))
   ...
   * @generated
   */
  public boolean validatePortAggregation(DiagnosticChain diagnostics, Map<Object, Object> context) {
   ...
   * @generated
   */
  public boolean validateDefaultValue(DiagnosticChain diagnostics, Map<Object, Object> context) {
   ...
   * @generated
   */
  public boolean validateEncapsulatedOwner(DiagnosticChain diagnostics, Map<Object, Object> context) {
