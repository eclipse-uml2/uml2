...
public class ExtensionImpl extends AssociationImpl implements Extension {
  ...
  private EList<Property> createOwnedEndsList() {
    return new SubsetSupersetEObjectContainmentWithInverseEList.Resolving<Property>(ExtensionEnd.class, this,
        UMLPackage.EXTENSION__OWNED_END, OWNED_END_ESUPERSETS, OWNED_END_ESUBSETS,
   ...
   * @generated
   */
  public Property getOwnedEnd(String name, Type type, boolean ignoreCase, boolean createOnDemand) {
   ...
   * @generated
   */
  public boolean validateNonOwnedEnd(DiagnosticChain diagnostics, Map<Object, Object> context) {
   ...
   * @generated
   */
  public boolean validateIsBinary(DiagnosticChain diagnostics, Map<Object, Object> context) {
    ...
    case UMLPackage.EXTENSION__OWNED_TEMPLATE_SIGNATURE:
      if (ownedTemplateSignature != null)
        msgs = ((InternalEObject) ownedTemplateSignature).eInverseRemove(this,
            EOPPOSITE_FEATURE_BASE - UMLPackage.EXTENSION__OWNED_TEMPLATE_SIGNATURE, null, msgs);
