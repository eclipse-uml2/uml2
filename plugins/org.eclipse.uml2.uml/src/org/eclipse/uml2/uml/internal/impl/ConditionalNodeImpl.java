...
public class ConditionalNodeImpl extends StructuredActivityNodeImpl implements ConditionalNode {
  ...
  public EList<Element> getOwnedElements() {
    ...
    return new DerivedUnionEObjectEList<Element>(Element.class, this, UMLPackage.CONDITIONAL_NODE__OWNED_ELEMENT,
  ...
  public void setIsDeterminate(boolean newIsDeterminate) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, UMLPackage.CONDITIONAL_NODE__IS_DETERMINATE,
          oldIsDeterminate, newIsDeterminate));
  }
  ...
  public void setIsAssured(boolean newIsAssured) {
    ...
    if (newIsAssured)
      ...
      eFlags &= ~IS_ASSURED_EFLAG;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, UMLPackage.CONDITIONAL_NODE__IS_ASSURED, oldIsAssured,
          newIsAssured));
  }
  ...
  public EList<Clause> getClauses() {
    if (clauses == null) {
      clauses = new EObjectContainmentEList.Resolving<Clause>(Clause.class, this, UMLPackage.CONDITIONAL_NODE__CLAUSE);
    }
    return clauses;
  }
  ...
  public EList<OutputPin> getResults() {
    if (results == null) {
      results = new EObjectContainmentEList.Resolving<OutputPin>(OutputPin.class, this,
   ...
   * @generated
   */
  public boolean validateNoInputPins(DiagnosticChain diagnostics, Map<Object, Object> context) {
   ...
   * @generated
   */
  public boolean validateOneClauseWithExecutableNode(DiagnosticChain diagnostics, Map<Object, Object> context) {
   ...
   * @generated
   */
  public boolean validateClauseNoPredecessor(DiagnosticChain diagnostics, Map<Object, Object> context) {
  ...
  public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
    ...
    case UMLPackage.CONDITIONAL_NODE___VALIDATE_ONE_CLAUSE_WITH_EXECUTABLE_NODE__DIAGNOSTICCHAIN_MAP:
      return validateOneClauseWithExecutableNode((DiagnosticChain) arguments.get(0),
          (Map<Object, Object>) arguments.get(1));
   ...
   * @ordered
   */
  protected static final int[] OWNED_ELEMENT_ESUBSETS = new int[] { UMLPackage.CONDITIONAL_NODE__OWNED_COMMENT,
      UMLPackage.CONDITIONAL_NODE__NAME_EXPRESSION, UMLPackage.CONDITIONAL_NODE__HANDLER,
      UMLPackage.CONDITIONAL_NODE__INPUT, UMLPackage.CONDITIONAL_NODE__LOCAL_POSTCONDITION,
      UMLPackage.CONDITIONAL_NODE__LOCAL_PRECONDITION, UMLPackage.CONDITIONAL_NODE__OUTPUT,
      UMLPackage.CONDITIONAL_NODE__ELEMENT_IMPORT, UMLPackage.CONDITIONAL_NODE__PACKAGE_IMPORT,
      UMLPackage.CONDITIONAL_NODE__OWNED_MEMBER, UMLPackage.CONDITIONAL_NODE__SUBGROUP,
      UMLPackage.CONDITIONAL_NODE__EDGE, UMLPackage.CONDITIONAL_NODE__NODE, UMLPackage.CONDITIONAL_NODE__CLAUSE };
  ...
  public boolean isSetOwnedElements() {
    return super.isSetOwnedElements() || eIsSet(UMLPackage.CONDITIONAL_NODE__CLAUSE);
  }
  ...
  public EList<OutputPin> getOutputs() {
    ...
    return new DerivedUnionEObjectEList<OutputPin>(OutputPin.class, this, UMLPackage.CONDITIONAL_NODE__OUTPUT,
        OUTPUT_ESUBSETS);
  }
