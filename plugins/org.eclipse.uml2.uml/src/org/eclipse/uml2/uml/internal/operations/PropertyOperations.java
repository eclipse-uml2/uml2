...
public class PropertyOperations extends RedefinableElementOperations {
   ...
   * @generated NOT
   */
  public static boolean validateMultiplicityOfComposite(Property property, DiagnosticChain diagnostics,
          ...
          diagnostics
              .add(
                  new BasicDiagnostic(Diagnostic.WARNING, UMLValidator.DIAGNOSTIC_SOURCE,
                      ...
                      UMLPlugin.INSTANCE.getString("_UI_Property_MultiplicityOfComposite_diagnostic", //$NON-NLS-1$
   ...
   * @generated NOT
   */
  public static boolean validateSubsettingContextConforms(Property property, DiagnosticChain diagnostics,
      Map<Object, Object> context) {
    boolean result = true;

    spLoop: for (Property subsettedProperty : property.getSubsettedProperties()) {
      ...
      if (diagnostics == null) {
        ...
        diagnostics.add(new BasicDiagnostic(Diagnostic.WARNING, UMLValidator.DIAGNOSTIC_SOURCE,
            ...
            UMLPlugin.INSTANCE.getString("_UI_Property_SubsettingContextConforms_diagnostic", //$NON-NLS-1$
                getMessageSubstitutions(context, property, subsettedProperty)),
   ...
   * @generated
   */
  public static boolean validateRedefinedPropertyInherited(Property property, DiagnosticChain diagnostics,
      Map<Object, Object> context) {
        ...
        diagnostics.add(new BasicDiagnostic(Diagnostic.ERROR, UMLValidator.DIAGNOSTIC_SOURCE,
            ...
            org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", //$NON-NLS-1$
                new Object[] { "validateRedefinedPropertyInherited", //$NON-NLS-1$
                    org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(property, context) }), new Object[] { property }));
      }
      return false;
    }
    return true;
   ...
   * @generated NOT
   */
  public static boolean validateSubsettingRules(Property property, DiagnosticChain diagnostics,
      Map<Object, Object> context) {
    boolean result = true;
    ...
    for (Property subsettedProperty : property.getSubsettedProperties()) {
      ...
      if (!(type == null ? subsettedType == null : type.conformsTo(subsettedProperty.getType()))
          || (subsettedUpperBound != LiteralUnlimitedNatural.UNLIMITED
              && (upperBound == LiteralUnlimitedNatural.UNLIMITED || upperBound > subsettedUpperBound))) {
        ...
        if (diagnostics == null) {
          ...
          diagnostics.add(new BasicDiagnostic(Diagnostic.WARNING, UMLValidator.DIAGNOSTIC_SOURCE,
              ...
              UMLPlugin.INSTANCE.getString("_UI_Property_SubsettingRules_diagnostic", //$NON-NLS-1$
                  getMessageSubstitutions(context, property, subsettedProperty)),
              new Object[] { property, subsettedProperty }));
        }
      }
   ...
   * @generated NOT
   */
  public static boolean validateDerivedUnionIsDerived(Property property, DiagnosticChain diagnostics,
      Map<Object, Object> context) {
    boolean result = true;
    ...
    if (property.isDerivedUnion() && !property.isDerived()) {
      ...
      if (diagnostics != null) {
        diagnostics.add(new BasicDiagnostic(Diagnostic.WARNING, UMLValidator.DIAGNOSTIC_SOURCE,
            ...
            UMLPlugin.INSTANCE.getString("_UI_Property_DerivedUnionIsDerived_diagnostic", //$NON-NLS-1$
                getMessageSubstitutions(context, property)),
            new Object[] { property }));
      }
    }
   ...
   * @generated NOT
   */
  public static boolean validateDerivedUnionIsReadOnly(Property property, DiagnosticChain diagnostics,
      Map<Object, Object> context) {
    boolean result = true;
    ...
    if (property.isDerivedUnion() && !property.isReadOnly()) {
      ...
      if (diagnostics != null) {
        diagnostics.add(new BasicDiagnostic(Diagnostic.WARNING, UMLValidator.DIAGNOSTIC_SOURCE,
            ...
            UMLPlugin.INSTANCE.getString("_UI_Property_DerivedUnionIsReadOnly_diagnostic", //$NON-NLS-1$
                getMessageSubstitutions(context, property)),
            new Object[] { property }));
      }
    }
   ...
   * @generated NOT
   */
  public static boolean validateSubsettedPropertyNames(Property property, DiagnosticChain diagnostics,
      Map<Object, Object> context) {
    boolean result = true;
      ...
      if (safeEquals(name, subsettedProperty.getName())) {
        ...
        if (diagnostics == null) {
          ...
          diagnostics.add(new BasicDiagnostic(Diagnostic.WARNING, UMLValidator.DIAGNOSTIC_SOURCE,
              ...
              UMLPlugin.INSTANCE.getString("_UI_Property_SubsettingPropertyNames_diagnostic", //$NON-NLS-1$
                  getMessageSubstitutions(context, property, subsettedProperty)),
              new Object[] { property, subsettedProperty }));
        }
      }
   ...
   * @generated
   */
  public static boolean validateTypeOfOppositeEnd(Property property, DiagnosticChain diagnostics,
      Map<Object, Object> context) {
    // TODO: implement this method
    // -> specify the condition that violates the invariant
    // -> verify the details of the diagnostic, including severity and message
   ...
   * @generated
   */
  public static boolean validateQualifiedIsAssociationEnd(Property property, DiagnosticChain diagnostics,
      Map<Object, Object> context) {
    // TODO: implement this method
    // -> specify the condition that violates the invariant
    // -> verify the details of the diagnostic, including severity and message
   ...
   * @generated NOT
   */
  public static boolean validateDeploymentTarget(Property property, DiagnosticChain diagnostics,
      Map<Object, Object> context) {
    boolean result = true;

    if (!property.getDeployments().isEmpty()) {

      if (!property.isComposite() || !(property.getType() instanceof Node) || !(property.getOwner() instanceof Node)) {
        ...
        if (diagnostics != null) {
          diagnostics.add(new BasicDiagnostic(Diagnostic.WARNING, UMLValidator.DIAGNOSTIC_SOURCE,
              ...
              UMLPlugin.INSTANCE.getString("_UI_Property_DeploymentTarget_diagnostic", //$NON-NLS-1$
                  getMessageSubstitutions(context, property)),
              new Object[] { property }));
        }
      }
   ...
   * @generated
   */
  public static boolean validateBindingToAttribute(Property property, DiagnosticChain diagnostics,
      Map<Object, Object> context) {
    // TODO: implement this method
    // -> specify the condition that violates the invariant
    // -> verify the details of the diagnostic, including severity and message
  ...
  public static void setBooleanDefaultValue(Property property, boolean value) {
    ...
    ((LiteralBoolean) (defaultValue instanceof LiteralBoolean ? defaultValue
        : property.createDefaultValue(null, null, UMLPackage.Literals.LITERAL_BOOLEAN))).setValue(value);
  }
  ...
  public static void setIntegerDefaultValue(Property property, int value) {
    ...
    ((LiteralInteger) (defaultValue instanceof LiteralInteger ? defaultValue
        : property.createDefaultValue(null, null, UMLPackage.Literals.LITERAL_INTEGER))).setValue(value);
  }
  ...
  public static void setStringDefaultValue(Property property, String value) {
    ...
    ((LiteralString) (defaultValue instanceof LiteralString ? defaultValue
        : property.createDefaultValue(null, null, UMLPackage.Literals.LITERAL_STRING))).setValue(value);
  }
  ...
  public static void setUnlimitedNaturalDefaultValue(Property property, int value) {
    ...
    ((LiteralUnlimitedNatural) (defaultValue instanceof LiteralUnlimitedNatural ? defaultValue
        : property.createDefaultValue(null, null, UMLPackage.Literals.LITERAL_UNLIMITED_NATURAL))).setValue(value);
  }
  ...
  public static Property getOpposite(Property property) {
    ...
    if (association != null) {
      ...
      if (memberEnds.size() == 2) {
        ...
        if (index != -1) {
          return ((InternalEList<Property>) memberEnds).basicGet(1 - index);
        }
      }
    }
  ...
  public static boolean isNavigable(Property property) {
    ...
    return owningAssociation == null ? property.eGet(UMLPackage.Literals.ELEMENT__OWNER, false) instanceof Classifier
  ...
  public static void setOpposite(Property property, Property newOpposite) {
    ...
    case 2:
      if (newOpposite == null) {
        ...
        memberEnds.set(Math.abs(memberEnds.indexOf(property) - 1), newOpposite);
      }
      break;
    default:
      throw new IllegalStateException();
  ...
  public static void setRealDefaultValue(Property property, double value) {
    ...
    ((LiteralReal) (defaultValue instanceof LiteralReal ? defaultValue
        : property.createDefaultValue(null, null, UMLPackage.Literals.LITERAL_REAL))).setValue(value);
  }
  ...
  public static boolean isAttribute(Property property) {
    ...
    for (EStructuralFeature.Setting inverseReference : getInverseReferences(property)) {
      ...
      if (eObject instanceof Classifier && ((Classifier) eObject).getAttributes().contains(property)) {
  ...
  public static boolean isConsistentWith(Property property, RedefinableElement redefiningElement) {
    ...
    if (redefiningElement instanceof Property && redefiningElement.isRedefinitionContextValid(property)) {
      ...
      return (propType == null ? type == null : propType.conformsTo(type)) && prop.lowerBound() >= property.lowerBound()
          && (upperBound == LiteralUnlimitedNatural.UNLIMITED
              || (propUpperBound != LiteralUnlimitedNatural.UNLIMITED && propUpperBound <= upperBound))
          && (property.isComposite() ? prop.isComposite() : true);
    }
  ...
  public static boolean isCompatibleWith(Property property, ParameterableElement p) {
    ...
    if (property.eClass().isInstance(p) && p instanceof TypedElement) {
      ...
      return type == null ? ((TypedElement) p).eGet(UMLPackage.Literals.TYPED_ELEMENT__TYPE, false) == null
