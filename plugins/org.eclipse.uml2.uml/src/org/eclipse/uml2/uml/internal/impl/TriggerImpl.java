...
public class TriggerImpl extends NamedElementImpl implements Trigger {
  ...
  public EList<Port> getPorts() {
    if (ports == null) {
      ports = new EObjectResolvingEList<Port>(Port.class, this, UMLPackage.TRIGGER__PORT);
    }
    return ports;
  }
   ...
   * @generated
   */
  public boolean validateTriggerWithPorts(DiagnosticChain diagnostics, Map<Object, Object> context) {
