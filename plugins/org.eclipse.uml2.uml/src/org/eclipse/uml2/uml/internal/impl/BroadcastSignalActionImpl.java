...
public class BroadcastSignalActionImpl extends InvocationActionImpl implements BroadcastSignalAction {
    ...
    if (signal != null && signal.eIsProxy()) {
      ...
      if (signal != oldSignal) {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, UMLPackage.BROADCAST_SIGNAL_ACTION__SIGNAL,
              oldSignal, signal));
      }
    }
    return signal;
  ...
  public void setSignal(Signal newSignal) {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(this, Notification.SET, UMLPackage.BROADCAST_SIGNAL_ACTION__SIGNAL, oldSignal, signal));
  }
   ...
   * @generated
   */
  public boolean validateNumberOfArguments(DiagnosticChain diagnostics, Map<Object, Object> context) {
