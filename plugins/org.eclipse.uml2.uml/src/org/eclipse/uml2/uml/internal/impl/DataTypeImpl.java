...
public class DataTypeImpl extends ClassifierImpl implements DataType {
    ...
    if (cache != null) {
      ...
      if (attributes == null) {
        cache.put(eResource, this, UMLPackage.Literals.CLASSIFIER__ATTRIBUTE,
            attributes = new DerivedUnionEObjectEList<Property>(Property.class, this, UMLPackage.DATA_TYPE__ATTRIBUTE,
                ATTRIBUTE_ESUBSETS));
      }
      return attributes;
    }
    return new DerivedUnionEObjectEList<Property>(Property.class, this, UMLPackage.DATA_TYPE__ATTRIBUTE,
        ATTRIBUTE_ESUBSETS);
  }
  ...
  public EList<NamedElement> getOwnedMembers() {
    ...
    return new DerivedUnionEObjectEList<NamedElement>(NamedElement.class, this, UMLPackage.DATA_TYPE__OWNED_MEMBER,
    ...
    if (cache != null) {
      ...
      if (features == null) {
        cache.put(eResource, this, UMLPackage.Literals.CLASSIFIER__FEATURE,
            features = new DerivedUnionEObjectEList<Feature>(Feature.class, this, UMLPackage.DATA_TYPE__FEATURE,
                FEATURE_ESUBSETS));
      }
      return features;
    }
  ...
  public EList<Property> getOwnedAttributes() {
    if (ownedAttributes == null) {
      ownedAttributes = new EObjectContainmentWithInverseEList.Resolving<Property>(Property.class, this,
          UMLPackage.DATA_TYPE__OWNED_ATTRIBUTE, UMLPackage.PROPERTY__DATATYPE);
    }
  ...
  public EList<Operation> getOwnedOperations() {
    if (ownedOperations == null) {
      ownedOperations = new EObjectContainmentWithInverseEList.Resolving<Operation>(Operation.class, this,
          UMLPackage.DATA_TYPE__OWNED_OPERATION, UMLPackage.OPERATION__DATATYPE);
    }
    ...
    case UMLPackage.DATA_TYPE__OWNED_TEMPLATE_SIGNATURE:
      if (ownedTemplateSignature != null)
        msgs = ((InternalEObject) ownedTemplateSignature).eInverseRemove(this,
            EOPPOSITE_FEATURE_BASE - UMLPackage.DATA_TYPE__OWNED_TEMPLATE_SIGNATURE, null, msgs);
