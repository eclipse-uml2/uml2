...
public abstract class NamedElementImpl extends ElementImpl implements NamedElement {
   ...
   * @ordered
   */
  protected static final VisibilityKind[] VISIBILITY_EFLAG_VALUES = VisibilityKind.values();
  ...
  public EList<Element> getOwnedElements() {
    ...
    return new DerivedUnionEObjectEList<Element>(Element.class, this, UMLPackage.NAMED_ELEMENT__OWNED_ELEMENT,
  ...
  public void setName(String newName) {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(this, Notification.SET, UMLPackage.NAMED_ELEMENT__NAME, oldName, name, !oldNameESet));
  }
  ...
  public void unsetName() {
    ...
    eFlags &= ~NAME_ESETFLAG;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.UNSET, UMLPackage.NAMED_ELEMENT__NAME, oldName, NAME_EDEFAULT,
          oldNameESet));
  }
  ...
  public void setVisibility(VisibilityKind newVisibility) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, UMLPackage.NAMED_ELEMENT__VISIBILITY, oldVisibility,
  ...
  public void unsetVisibility() {
    ...
    eFlags &= ~VISIBILITY_ESETFLAG;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.UNSET, UMLPackage.NAMED_ELEMENT__VISIBILITY, oldVisibility,
  ...
  public EList<Dependency> getClientDependencies() {
    ...
    if (cache != null) {
      ...
      if (result == null) {
        cache.put(this, UMLPackage.Literals.NAMED_ELEMENT__CLIENT_DEPENDENCY,
            result = NamedElementOperations.getClientDependencies(this));
      }
      return result;
    }
    ...
    if (nameExpression != null && nameExpression.eIsProxy()) {
      ...
      if (nameExpression != oldNameExpression) {
        ...
        NotificationChain msgs = oldNameExpression.eInverseRemove(this,
            EOPPOSITE_FEATURE_BASE - UMLPackage.NAMED_ELEMENT__NAME_EXPRESSION, null, null);
        if (newNameExpression.eInternalContainer() == null) {
          msgs = newNameExpression.eInverseAdd(this, EOPPOSITE_FEATURE_BASE - UMLPackage.NAMED_ELEMENT__NAME_EXPRESSION,
              null, msgs);
        }
        if (msgs != null)
          msgs.dispatch();
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, UMLPackage.NAMED_ELEMENT__NAME_EXPRESSION,
  ...
  public NotificationChain basicSetNameExpression(StringExpression newNameExpression, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          UMLPackage.NAMED_ELEMENT__NAME_EXPRESSION, oldNameExpression, newNameExpression);
      if (msgs == null)
        msgs = notification;
      else
    ...
    if (newNameExpression != nameExpression) {
      ...
      if (nameExpression != null)
        msgs = ((InternalEObject) nameExpression).eInverseRemove(this,
            EOPPOSITE_FEATURE_BASE - UMLPackage.NAMED_ELEMENT__NAME_EXPRESSION, null, msgs);
      ...
      eNotify(new ENotificationImpl(this, Notification.SET, UMLPackage.NAMED_ELEMENT__NAME_EXPRESSION,
          newNameExpression, newNameExpression));
  }
      ...
      if (!UML2Util.isEmpty(name)) {
        ...
        for (EObject otherEObject : eContents()) {
          ...
          if (otherEObject == eObject) {
            ...
            if (name.equals(((NamedElement) otherEObject).getName())) {
