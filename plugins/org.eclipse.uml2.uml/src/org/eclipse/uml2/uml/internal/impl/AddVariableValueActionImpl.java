...
public class AddVariableValueActionImpl extends WriteVariableActionImpl implements AddVariableValueAction {
  ...
  public EList<InputPin> getInputs() {
    ...
    return new DerivedUnionEObjectEList<InputPin>(InputPin.class, this, UMLPackage.ADD_VARIABLE_VALUE_ACTION__INPUT,
        INPUT_ESUBSETS);
  }
  ...
  public void setIsReplaceAll(boolean newIsReplaceAll) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, UMLPackage.ADD_VARIABLE_VALUE_ACTION__IS_REPLACE_ALL,
   ...
   * @generated
   */
  public boolean validateRequiredValue(DiagnosticChain diagnostics, Map<Object, Object> context) {
   ...
   * @generated
   */
  public boolean validateInsertAtPin(DiagnosticChain diagnostics, Map<Object, Object> context) {
    ...
    if (insertAt != null && insertAt.eIsProxy()) {
      ...
      if (insertAt != oldInsertAt) {
        ...
        NotificationChain msgs = oldInsertAt.eInverseRemove(this,
            EOPPOSITE_FEATURE_BASE - UMLPackage.ADD_VARIABLE_VALUE_ACTION__INSERT_AT, null, null);
        if (newInsertAt.eInternalContainer() == null) {
          msgs = newInsertAt.eInverseAdd(this, EOPPOSITE_FEATURE_BASE - UMLPackage.ADD_VARIABLE_VALUE_ACTION__INSERT_AT,
              null, msgs);
        }
        if (msgs != null)
          msgs.dispatch();
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, UMLPackage.ADD_VARIABLE_VALUE_ACTION__INSERT_AT,
  ...
  public NotificationChain basicSetInsertAt(InputPin newInsertAt, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          UMLPackage.ADD_VARIABLE_VALUE_ACTION__INSERT_AT, oldInsertAt, newInsertAt);
      if (msgs == null)
        msgs = notification;
      else
    ...
    if (newInsertAt != insertAt) {
      ...
      if (insertAt != null)
        msgs = ((InternalEObject) insertAt).eInverseRemove(this,
            EOPPOSITE_FEATURE_BASE - UMLPackage.ADD_VARIABLE_VALUE_ACTION__INSERT_AT, null, msgs);
      if (newInsertAt != null)
      ...
      eNotify(new ENotificationImpl(this, Notification.SET, UMLPackage.ADD_VARIABLE_VALUE_ACTION__INSERT_AT,
   ...
   * @ordered
   */
  protected static final int[] INPUT_ESUBSETS = new int[] { UMLPackage.ADD_VARIABLE_VALUE_ACTION__VALUE,
  ...
  public boolean isSetInputs() {
    return super.isSetInputs() || eIsSet(UMLPackage.ADD_VARIABLE_VALUE_ACTION__INSERT_AT);
  }
