 ...
 * @generated
 */
public class ProtocolStateMachineOperations extends StateMachineOperations {
   ...
   * @generated
   */
  public static boolean validateProtocolTransitions(ProtocolStateMachine protocolStateMachine,
        ...
        diagnostics.add(new BasicDiagnostic(Diagnostic.ERROR, UMLValidator.DIAGNOSTIC_SOURCE,
            ...
            org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", //$NON-NLS-1$
                new Object[] { "validateProtocolTransitions", //$NON-NLS-1$
                    org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(protocolStateMachine, context) }), new Object[] { protocolStateMachine }));
      }
      return false;
    }
    return true;
   ...
   * @generated
   */
  public static boolean validateEntryExitDo(ProtocolStateMachine protocolStateMachine, DiagnosticChain diagnostics,
   ...
   * @generated
   */
  public static boolean validateDeepOrShallowHistory(ProtocolStateMachine protocolStateMachine,
      DiagnosticChain diagnostics, Map<Object, Object> context) {
    // TODO: implement this method
    // -> specify the condition that violates the invariant
    // -> verify the details of the diagnostic, including severity and message
   ...
   * @generated
   */
  public static boolean validateClassifierContext(ProtocolStateMachine protocolStateMachine,
      DiagnosticChain diagnostics, Map<Object, Object> context) {
    // TODO: implement this method
    // -> specify the condition that violates the invariant
    // -> verify the details of the diagnostic, including severity and message
