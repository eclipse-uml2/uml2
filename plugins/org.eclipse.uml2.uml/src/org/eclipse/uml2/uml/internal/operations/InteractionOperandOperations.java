 ...
 * @generated
 */
public class InteractionOperandOperations extends NamespaceOperations {
   ...
   * @generated
   */
  public static boolean validateGuardDirectlyPrior(InteractionOperand interactionOperand, DiagnosticChain diagnostics,
        ...
        diagnostics.add(new BasicDiagnostic(Diagnostic.ERROR, UMLValidator.DIAGNOSTIC_SOURCE,
            ...
            org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", //$NON-NLS-1$
                new Object[] { "validateGuardDirectlyPrior", //$NON-NLS-1$
                    org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(interactionOperand, context) }), new Object[] { interactionOperand }));
      }
      return false;
    }
    return true;
   ...
   * @generated
   */
  public static boolean validateGuardContainReferences(InteractionOperand interactionOperand,
