...
public class InterruptibleActivityRegionImpl extends ActivityGroupImpl implements InterruptibleActivityRegion {
      ...
      if (containedNodes == null) {
        cache.put(eResource, this, UMLPackage.Literals.ACTIVITY_GROUP__CONTAINED_NODE,
            containedNodes = new DerivedUnionEObjectEList<ActivityNode>(ActivityNode.class, this,
                UMLPackage.INTERRUPTIBLE_ACTIVITY_REGION__CONTAINED_NODE, CONTAINED_NODE_ESUBSETS));
      }
  ...
  public EList<ActivityNode> getNodes() {
    if (nodes == null) {
      nodes = new EObjectWithInverseResolvingEList.ManyInverse<ActivityNode>(ActivityNode.class, this,
          UMLPackage.INTERRUPTIBLE_ACTIVITY_REGION__NODE, UMLPackage.ACTIVITY_NODE__IN_INTERRUPTIBLE_REGION);
    }
    return nodes;
  }
  ...
  public EList<ActivityEdge> getInterruptingEdges() {
    if (interruptingEdges == null) {
      interruptingEdges = new EObjectWithInverseResolvingEList<ActivityEdge>(ActivityEdge.class, this,
          UMLPackage.INTERRUPTIBLE_ACTIVITY_REGION__INTERRUPTING_EDGE, UMLPackage.ACTIVITY_EDGE__INTERRUPTS);
    }
  ...
  public ActivityEdge getInterruptingEdge(String name, boolean ignoreCase, EClass eClass) {
    interruptingEdgeLoop: for (ActivityEdge interruptingEdge : getInterruptingEdges()) {
      ...
      if (name != null && !(ignoreCase ? name.equalsIgnoreCase(interruptingEdge.getName())
   ...
   * @generated
   */
  public boolean validateInterruptingEdges(DiagnosticChain diagnostics, Map<Object, Object> context) {
  ...
  public boolean isSetContainedNodes() {
    return super.isSetContainedNodes() || eIsSet(UMLPackage.INTERRUPTIBLE_ACTIVITY_REGION__NODE);
  }
