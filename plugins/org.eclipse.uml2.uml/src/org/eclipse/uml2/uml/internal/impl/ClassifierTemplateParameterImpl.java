...
public class ClassifierTemplateParameterImpl extends TemplateParameterImpl implements ClassifierTemplateParameter {
  ...
  public void setAllowSubstitutable(boolean newAllowSubstitutable) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET,
          UMLPackage.CLASSIFIER_TEMPLATE_PARAMETER__ALLOW_SUBSTITUTABLE, oldAllowSubstitutable, newAllowSubstitutable));
  }
  ...
  public EList<Classifier> getConstrainingClassifiers() {
    if (constrainingClassifiers == null) {
      constrainingClassifiers = new EObjectResolvingEList<Classifier>(Classifier.class, this,
   ...
   * @generated
   */
  public Classifier getConstrainingClassifier(String name, boolean ignoreCase, EClass eClass) {
    constrainingClassifierLoop: for (Classifier constrainingClassifier : getConstrainingClassifiers()) {
      ...
      if (name != null && !(ignoreCase ? name.equalsIgnoreCase(constrainingClassifier.getName())
      ...
      if (parameteredElement != oldParameteredElement) {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE,
              UMLPackage.CLASSIFIER_TEMPLATE_PARAMETER__PARAMETERED_ELEMENT, oldParameteredElement,
              parameteredElement));
      }
    }
   ...
   * @generated
   */
  public NotificationChain basicSetParameteredElementGen(ParameterableElement newParameteredElement,
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          UMLPackage.CLASSIFIER_TEMPLATE_PARAMETER__PARAMETERED_ELEMENT, oldParameteredElement, newParameteredElement);
      if (msgs == null)
        msgs = notification;
      else
  ...
  public void setParameteredElement(ParameterableElement newParameteredElement) {
    ...
    if (newParameteredElement != parameteredElement) {
      ...
      eNotify(new ENotificationImpl(this, Notification.SET,
          UMLPackage.CLASSIFIER_TEMPLATE_PARAMETER__PARAMETERED_ELEMENT, newParameteredElement, newParameteredElement));
  }
   ...
   * @generated
   */
  public boolean validateHasConstrainingClassifier(DiagnosticChain diagnostics, Map<Object, Object> context) {
   ...
   * @generated
   */
  public boolean validateParameteredElementNoFeatures(DiagnosticChain diagnostics, Map<Object, Object> context) {
   ...
   * @generated
   */
  public boolean validateMatchingAbstract(DiagnosticChain diagnostics, Map<Object, Object> context) {
   ...
   * @generated
   */
  public boolean validateActualIsClassifier(DiagnosticChain diagnostics, Map<Object, Object> context) {
   ...
   * @generated
   */
  public boolean validateConstrainingClassifiersConstrainArgs(DiagnosticChain diagnostics,
      Map<Object, Object> context) {
    return ClassifierTemplateParameterOperations.validateConstrainingClassifiersConstrainArgs(this, diagnostics,
        context);
  }
   ...
   * @generated
   */
  public boolean validateConstrainingClassifiersConstrainParameteredElement(DiagnosticChain diagnostics,
      Map<Object, Object> context) {
    return ClassifierTemplateParameterOperations.validateConstrainingClassifiersConstrainParameteredElement(this,
        diagnostics, context);
  }
    ...
    case UMLPackage.CLASSIFIER_TEMPLATE_PARAMETER__OWNED_PARAMETERED_ELEMENT:
      if (ownedParameteredElement != null)
        msgs = ((InternalEObject) ownedParameteredElement).eInverseRemove(this,
            EOPPOSITE_FEATURE_BASE - UMLPackage.CLASSIFIER_TEMPLATE_PARAMETER__OWNED_PARAMETERED_ELEMENT, null, msgs);
  ...
  public boolean eIsSet(int featureID) {
    ...
    case UMLPackage.CLASSIFIER_TEMPLATE_PARAMETER__CONSTRAINING_CLASSIFIER:
      return constrainingClassifiers != null && !constrainingClassifiers.isEmpty();
    }
  ...
  public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
    ...
    case UMLPackage.CLASSIFIER_TEMPLATE_PARAMETER___VALIDATE_HAS_CONSTRAINING_CLASSIFIER__DIAGNOSTICCHAIN_MAP:
      return validateHasConstrainingClassifier((DiagnosticChain) arguments.get(0),
          (Map<Object, Object>) arguments.get(1));
    case UMLPackage.CLASSIFIER_TEMPLATE_PARAMETER___VALIDATE_PARAMETERED_ELEMENT_NO_FEATURES__DIAGNOSTICCHAIN_MAP:
      return validateParameteredElementNoFeatures((DiagnosticChain) arguments.get(0),
          (Map<Object, Object>) arguments.get(1));
    ...
    case UMLPackage.CLASSIFIER_TEMPLATE_PARAMETER___VALIDATE_CONSTRAINING_CLASSIFIERS_CONSTRAIN_ARGS__DIAGNOSTICCHAIN_MAP:
      return validateConstrainingClassifiersConstrainArgs((DiagnosticChain) arguments.get(0),
          (Map<Object, Object>) arguments.get(1));
    case UMLPackage.CLASSIFIER_TEMPLATE_PARAMETER___VALIDATE_CONSTRAINING_CLASSIFIERS_CONSTRAIN_PARAMETERED_ELEMENT__DIAGNOSTICCHAIN_MAP:
      return validateConstrainingClassifiersConstrainParameteredElement((DiagnosticChain) arguments.get(0),
          (Map<Object, Object>) arguments.get(1));
    }
