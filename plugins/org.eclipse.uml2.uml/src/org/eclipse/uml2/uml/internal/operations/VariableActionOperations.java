...
public class VariableActionOperations extends ActionOperations {
   ...
   * @generated
   */
  public static boolean validateScopeOfVariable(VariableAction variableAction, DiagnosticChain diagnostics,
        ...
        diagnostics.add(new BasicDiagnostic(Diagnostic.ERROR, UMLValidator.DIAGNOSTIC_SOURCE,
            ...
            org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", //$NON-NLS-1$
                new Object[] { "validateScopeOfVariable", //$NON-NLS-1$
                    org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(variableAction, context) }), new Object[] { variableAction }));
      }
      return false;
    }
    return true;
