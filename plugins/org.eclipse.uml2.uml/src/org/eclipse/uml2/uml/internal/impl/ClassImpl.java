...
public class ClassImpl extends EncapsulatedClassifierImpl implements org.eclipse.uml2.uml.Class {
  ...
  public EList<NamedElement> getOwnedMembers() {
    ...
    return new DerivedUnionEObjectEList<NamedElement>(NamedElement.class, this, UMLPackage.CLASS__OWNED_MEMBER,
    ...
    if (cache != null) {
      ...
      if (ownedElements == null) {
        cache.put(eResource, this, UMLPackage.Literals.ELEMENT__OWNED_ELEMENT,
            ownedElements = new DerivedUnionEObjectEList<Element>(Element.class, this, UMLPackage.CLASS__OWNED_ELEMENT,
                OWNED_ELEMENT_ESUBSETS));
      }
      return ownedElements;
    }
    return new DerivedUnionEObjectEList<Element>(Element.class, this, UMLPackage.CLASS__OWNED_ELEMENT,
        OWNED_ELEMENT_ESUBSETS);
  }
  ...
  private EList<Behavior> createOwnedBehaviorsList() {
    return new SubsetSupersetEObjectContainmentEList.Resolving<Behavior>(Behavior.class, this,
        UMLPackage.CLASS__OWNED_BEHAVIOR, null, OWNED_BEHAVIOR_ESUBSETS);
  }
    ...
    if (classifierBehavior != null && classifierBehavior.eIsProxy()) {
      ...
      if (classifierBehavior != oldClassifierBehavior) {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, UMLPackage.CLASS__CLASSIFIER_BEHAVIOR,
  ...
  public void setClassifierBehavior(Behavior newClassifierBehavior) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, UMLPackage.CLASS__CLASSIFIER_BEHAVIOR,
          oldClassifierBehavior, classifierBehavior));
  ...
  public EList<InterfaceRealization> getInterfaceRealizations() {
    if (interfaceRealizations == null) {
      interfaceRealizations = new EObjectContainmentWithInverseEList.Resolving<InterfaceRealization>(
          InterfaceRealization.class, this, UMLPackage.CLASS__INTERFACE_REALIZATION,
    ...
    if (cache != null) {
      ...
      if (features == null) {
        cache.put(eResource, this, UMLPackage.Literals.CLASSIFIER__FEATURE,
            features = new DerivedUnionEObjectEList<Feature>(Feature.class, this, UMLPackage.CLASS__FEATURE,
                FEATURE_ESUBSETS));
      }
      return features;
    }
    ...
    if (cache != null) {
      ...
      if (attributes == null) {
        cache.put(eResource, this, UMLPackage.Literals.CLASSIFIER__ATTRIBUTE,
            attributes = new DerivedUnionEObjectEList<Property>(Property.class, this, UMLPackage.CLASS__ATTRIBUTE,
                ATTRIBUTE_ESUBSETS));
      }
      return attributes;
    }
    return new DerivedUnionEObjectEList<Property>(Property.class, this, UMLPackage.CLASS__ATTRIBUTE,
        ATTRIBUTE_ESUBSETS);
  }
  ...
  public EList<Operation> getOwnedOperations() {
    if (ownedOperations == null) {
      ownedOperations = new EObjectContainmentWithInverseEList.Resolving<Operation>(Operation.class, this,
          UMLPackage.CLASS__OWNED_OPERATION, UMLPackage.OPERATION__CLASS);
    }
  ...
  public Operation createOwnedOperation(String name, EList<String> ownedParameterNames,
    ...
    for (int i = 0; i < ownedParameterListSize; i++) {
      newOwnedOperation.createOwnedParameter(i < ownedParameterNamesSize ? (String) ownedParameterNames.get(i) : null,
  ...
  public Operation getOwnedOperation(String name, EList<String> ownedParameterNames, EList<Type> ownedParameterTypes,
    ...
    ownedOperationLoop: for (Operation ownedOperation : getOwnedOperations()) {
      if (name != null
          && !(ignoreCase ? name.equalsIgnoreCase(ownedOperation.getName()) : name.equals(ownedOperation.getName())))
  ...
  public EList<Classifier> getNestedClassifiers() {
    if (nestedClassifiers == null) {
      nestedClassifiers = new EObjectContainmentEList.Resolving<Classifier>(Classifier.class, this,
  ...
  protected static class SuperClassEList extends DerivedSubsetEObjectEList<Object> {

    protected SuperClassEList(Class<?> dataClass, InternalEObject owner, int featureID, int[] sourceFeatureIDs) {
      super(dataClass, owner, featureID, sourceFeatureIDs);
    }

    @Override
    public List<Object> basicList() {
      return new SuperClassEList(dataClass, owner, featureID, sourceFeatureIDs) {
  ...
  public EList<org.eclipse.uml2.uml.Class> getSuperClasses() {
    ...
    if (cache != null) {
      Resource eResource = eResource();
      EList<org.eclipse.uml2.uml.Class> superClasses = (EList<org.eclipse.uml2.uml.Class>) cache.get(eResource, this,
          UMLPackage.Literals.CLASS__SUPER_CLASS);
      if (superClasses == null) {
        cache.put(eResource, this, UMLPackage.Literals.CLASS__SUPER_CLASS,
            superClasses = (EList<org.eclipse.uml2.uml.Class>) ((EList<?>) new SuperClassEList(
                org.eclipse.uml2.uml.Class.class, this, UMLPackage.CLASS__SUPER_CLASS, SUPER_CLASS_ESUPERSETS)));
      }
      return superClasses;
    }
    return (EList<org.eclipse.uml2.uml.Class>) ((EList<?>) new SuperClassEList(org.eclipse.uml2.uml.Class.class, this,
  ...
  public void setIsActive(boolean newIsActive) {
    ...
    if (newIsActive)
      ...
      eFlags &= ~IS_ACTIVE_EFLAG;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, UMLPackage.CLASS__IS_ACTIVE, oldIsActive, newIsActive));
  }
  ...
  public EList<Reception> getOwnedReceptions() {
    if (ownedReceptions == null) {
      ownedReceptions = new EObjectContainmentEList.Resolving<Reception>(Reception.class, this,
  ...
  public Reception createOwnedReception(String name, EList<String> ownedParameterNames,
    ...
    if (ownedParameterTypesSize > ownedParameterListSize)
      ownedParameterListSize = ownedParameterTypesSize;
    for (int i = 0; i < ownedParameterListSize; i++) {
      newOwnedReception.createOwnedParameter(i < ownedParameterNamesSize ? (String) ownedParameterNames.get(i) : null,
          i < ownedParameterTypesSize ? (Type) ownedParameterTypes.get(i) : null);
    }
  ...
  public Reception getOwnedReception(String name, EList<String> ownedParameterNames, EList<Type> ownedParameterTypes,
    ...
    ownedReceptionLoop: for (Reception ownedReception : getOwnedReceptions()) {
      if (name != null
          && !(ignoreCase ? name.equalsIgnoreCase(ownedReception.getName()) : name.equals(ownedReception.getName())))
  ...
  public EList<Property> getOwnedAttributes() {
    if (ownedAttributes == null) {
      ownedAttributes = new EObjectContainmentEList.Resolving<Property>(Property.class, this,
  ...
  public Property getOwnedAttribute(String name, Type type, boolean ignoreCase, EClass eClass, boolean createOnDemand) {
    ownedAttributeLoop: for (Property ownedAttribute : getOwnedAttributes()) {
      ...
      if (name != null
          && !(ignoreCase ? name.equalsIgnoreCase(ownedAttribute.getName()) : name.equals(ownedAttribute.getName())))
        continue ownedAttributeLoop;
  ...
  public void setIsAbstract(boolean newIsAbstract) {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(this, Notification.SET, UMLPackage.CLASS__IS_ABSTRACT, oldIsAbstract, newIsAbstract));
  }
    ...
    case UMLPackage.CLASS__OWNED_TEMPLATE_SIGNATURE:
      if (ownedTemplateSignature != null)
        msgs = ((InternalEObject) ownedTemplateSignature).eInverseRemove(this,
            EOPPOSITE_FEATURE_BASE - UMLPackage.CLASS__OWNED_TEMPLATE_SIGNATURE, null, msgs);
  ...
  protected static final int[] OWNED_ELEMENT_ESUBSETS = new int[] { UMLPackage.CLASS__OWNED_COMMENT,
      ...
      UMLPackage.CLASS__OWNED_MEMBER, UMLPackage.CLASS__TEMPLATE_BINDING, UMLPackage.CLASS__OWNED_TEMPLATE_SIGNATURE,
      UMLPackage.CLASS__COLLABORATION_USE, UMLPackage.CLASS__GENERALIZATION, UMLPackage.CLASS__SUBSTITUTION,
  ...
  public Behavior getOwnedBehavior(String name, boolean ignoreCase, EClass eClass, boolean createOnDemand) {
    ownedBehaviorLoop: for (Behavior ownedBehavior : getOwnedBehaviors()) {
      ...
      if (name != null
          && !(ignoreCase ? name.equalsIgnoreCase(ownedBehavior.getName()) : name.equals(ownedBehavior.getName())))
        continue ownedBehaviorLoop;
