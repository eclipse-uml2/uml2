...
public abstract class StructuralFeatureActionImpl extends ActionImpl implements StructuralFeatureAction {
  ...
  public EList<InputPin> getInputs() {
    ...
    return new DerivedUnionEObjectEList<InputPin>(InputPin.class, this, UMLPackage.STRUCTURAL_FEATURE_ACTION__INPUT,
        INPUT_ESUBSETS);
  }
      ...
      if (structuralFeature != oldStructuralFeature) {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE,
              UMLPackage.STRUCTURAL_FEATURE_ACTION__STRUCTURAL_FEATURE, oldStructuralFeature, structuralFeature));
      }
    }
  ...
  public void setStructuralFeature(StructuralFeature newStructuralFeature) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, UMLPackage.STRUCTURAL_FEATURE_ACTION__STRUCTURAL_FEATURE,
    ...
    if (object != null && object.eIsProxy()) {
      ...
      if (object != oldObject) {
        ...
        NotificationChain msgs = oldObject.eInverseRemove(this,
            EOPPOSITE_FEATURE_BASE - UMLPackage.STRUCTURAL_FEATURE_ACTION__OBJECT, null, null);
        if (newObject.eInternalContainer() == null) {
          msgs = newObject.eInverseAdd(this, EOPPOSITE_FEATURE_BASE - UMLPackage.STRUCTURAL_FEATURE_ACTION__OBJECT,
              null, msgs);
        }
        if (msgs != null)
          msgs.dispatch();
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, UMLPackage.STRUCTURAL_FEATURE_ACTION__OBJECT,
              oldObject, object));
      }
    }
    return object;
  ...
  public NotificationChain basicSetObject(InputPin newObject, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          UMLPackage.STRUCTURAL_FEATURE_ACTION__OBJECT, oldObject, newObject);
      if (msgs == null)
        msgs = notification;
      else
    ...
    if (newObject != object) {
      ...
      if (object != null)
        msgs = ((InternalEObject) object).eInverseRemove(this,
            EOPPOSITE_FEATURE_BASE - UMLPackage.STRUCTURAL_FEATURE_ACTION__OBJECT, null, msgs);
      if (newObject != null)
      ...
      eNotify(new ENotificationImpl(this, Notification.SET, UMLPackage.STRUCTURAL_FEATURE_ACTION__OBJECT, newObject,
          newObject));
  }
