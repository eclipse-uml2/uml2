 ...
 * @generated
 */
public class CommunicationPathOperations extends AssociationOperations {
   ...
   * @generated
   */
  public static boolean validateAssociationEnds(CommunicationPath communicationPath, DiagnosticChain diagnostics,
        ...
        diagnostics.add(new BasicDiagnostic(Diagnostic.ERROR, UMLValidator.DIAGNOSTIC_SOURCE,
            ...
            org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", //$NON-NLS-1$
                new Object[] { "validateAssociationEnds", //$NON-NLS-1$
                    org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(communicationPath, context) }), new Object[] { communicationPath }));
      }
      return false;
    }
    return true;
