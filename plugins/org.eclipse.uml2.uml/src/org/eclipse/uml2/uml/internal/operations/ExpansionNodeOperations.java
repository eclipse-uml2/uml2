 ...
 * @generated
 */
public class ExpansionNodeOperations extends ObjectNodeOperations {
   ...
   * @generated
   */
  public static boolean validateRegionAsInputOrOutput(ExpansionNode expansionNode, DiagnosticChain diagnostics,
        ...
        diagnostics.add(new BasicDiagnostic(Diagnostic.ERROR, UMLValidator.DIAGNOSTIC_SOURCE,
            ...
            org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", //$NON-NLS-1$
                new Object[] { "validateRegionAsInputOrOutput", //$NON-NLS-1$
                    org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(expansionNode, context) }), new Object[] { expansionNode }));
      }
      return false;
    }
    return true;
