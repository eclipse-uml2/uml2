...
public class InstanceValueImpl extends ValueSpecificationImpl implements InstanceValue {
    ...
    if (instance != null && instance.eIsProxy()) {
      ...
      if (instance != oldInstance) {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, UMLPackage.INSTANCE_VALUE__INSTANCE, oldInstance,
              instance));
      }
    }
    return instance;
  ...
  public void setInstance(InstanceSpecification newInstance) {
    ...
    if (eNotificationRequired())
      eNotify(
          new ENotificationImpl(this, Notification.SET, UMLPackage.INSTANCE_VALUE__INSTANCE, oldInstance, instance));
  }
