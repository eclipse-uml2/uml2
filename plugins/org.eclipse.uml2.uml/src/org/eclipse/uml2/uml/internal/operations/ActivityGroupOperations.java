 ...
 * @generated
 */
public class ActivityGroupOperations extends NamedElementOperations {
  ...
  public static Activity containingActivity(ActivityGroup activityGroup) {
    ...
    return superGroup != null ? superGroup.containingActivity() : activityGroup.getInActivity();
  }
   ...
   * @generated
   */
  public static boolean validateNodesAndEdges(ActivityGroup activityGroup, DiagnosticChain diagnostics,
        ...
        diagnostics.add(new BasicDiagnostic(Diagnostic.ERROR, UMLValidator.DIAGNOSTIC_SOURCE,
            ...
            org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", //$NON-NLS-1$
                new Object[] { "validateNodesAndEdges", //$NON-NLS-1$
                    org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(activityGroup, context) }), new Object[] { activityGroup }));
      }
      return false;
    }
    return true;
   ...
   * @generated
   */
  public static boolean validateNotContained(ActivityGroup activityGroup, DiagnosticChain diagnostics,
      Map<Object, Object> context) {
    // TODO: implement this method
    // -> specify the condition that violates the invariant
    // -> verify the details of the diagnostic, including severity and message
