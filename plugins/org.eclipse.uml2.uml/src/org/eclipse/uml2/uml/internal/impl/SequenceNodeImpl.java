...
public class SequenceNodeImpl extends StructuredActivityNodeImpl implements SequenceNode {
  ...
  public EList<ExecutableNode> getExecutableNodes() {
    if (executableNodes == null) {
      executableNodes = new EObjectContainmentEList.Resolving<ExecutableNode>(ExecutableNode.class, this,
   ...
   * @generated
   */
  public ExecutableNode getExecutableNode(String name, boolean ignoreCase, EClass eClass, boolean createOnDemand) {
    executableNodeLoop: for (ExecutableNode executableNode : getExecutableNodes()) {
      ...
      if (name != null
          && !(ignoreCase ? name.equalsIgnoreCase(executableNode.getName()) : name.equals(executableNode.getName())))
        continue executableNodeLoop;
