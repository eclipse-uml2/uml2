...
public class CollaborationUseImpl extends NamedElementImpl implements CollaborationUse {
  ...
  public EList<Element> getOwnedElements() {
    ...
    return new DerivedUnionEObjectEList<Element>(Element.class, this, UMLPackage.COLLABORATION_USE__OWNED_ELEMENT,
  ...
  public EList<Dependency> getRoleBindings() {
    if (roleBindings == null) {
      roleBindings = new EObjectContainmentEList.Resolving<Dependency>(Dependency.class, this,
   ...
   * @generated
   */
  public Dependency getRoleBinding(String name, boolean ignoreCase, EClass eClass, boolean createOnDemand) {
    roleBindingLoop: for (Dependency roleBinding : getRoleBindings()) {
      ...
      if (name != null
          && !(ignoreCase ? name.equalsIgnoreCase(roleBinding.getName()) : name.equals(roleBinding.getName())))
        continue roleBindingLoop;
      return roleBinding;
    }
   ...
   * @generated
   */
  public boolean validateClientElements(DiagnosticChain diagnostics, Map<Object, Object> context) {
   ...
   * @generated
   */
  public boolean validateEveryRole(DiagnosticChain diagnostics, Map<Object, Object> context) {
   ...
   * @generated
   */
  public boolean validateConnectors(DiagnosticChain diagnostics, Map<Object, Object> context) {
   ...
   * @ordered
   */
  protected static final int[] OWNED_ELEMENT_ESUBSETS = new int[] { UMLPackage.COLLABORATION_USE__OWNED_COMMENT,
      UMLPackage.COLLABORATION_USE__NAME_EXPRESSION, UMLPackage.COLLABORATION_USE__ROLE_BINDING };
  ...
  public boolean isSetOwnedElements() {
    return super.isSetOwnedElements() || eIsSet(UMLPackage.COLLABORATION_USE__ROLE_BINDING);
  }
