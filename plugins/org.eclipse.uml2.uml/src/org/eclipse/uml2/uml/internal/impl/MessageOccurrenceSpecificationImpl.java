 ...
 * @generated
 */
public class MessageOccurrenceSpecificationImpl extends OccurrenceSpecificationImpl
      ...
      if (message != oldMessage) {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE,
              UMLPackage.MESSAGE_OCCURRENCE_SPECIFICATION__MESSAGE, oldMessage, message));
      }
    }
    return message;
  }
  ...
  public void setMessage(Message newMessage) {
    ...
    message = newMessage;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, UMLPackage.MESSAGE_OCCURRENCE_SPECIFICATION__MESSAGE,
          oldMessage, message));
  }
  ...
  public EList<InteractionFragment> enclosingFragment() {
    ...
    if (cache != null) {
      @SuppressWarnings("unchecked")
      EList<InteractionFragment> result = (EList<InteractionFragment>) cache.get(this,
          UMLPackage.Literals.MESSAGE_END___ENCLOSING_FRAGMENT);
      if (result == null) {
        cache.put(this, UMLPackage.Literals.MESSAGE_END___ENCLOSING_FRAGMENT,
