...
public class MultiplicityElementOperations extends ElementOperations {
    ...
    if (lowerBound < 0) {
      ...
      if (diagnostics != null) {
        diagnostics.add(new BasicDiagnostic(Diagnostic.WARNING, UMLValidator.DIAGNOSTIC_SOURCE,
            ...
            UMLPlugin.INSTANCE.getString("_UI_MultiplicityElement_LowerGE0_diagnostic", //$NON-NLS-1$
      ...
      if (upperBound < lowerBound) {
        ...
        if (diagnostics != null) {
          diagnostics.add(new BasicDiagnostic(Diagnostic.WARNING, UMLValidator.DIAGNOSTIC_SOURCE,
              ...
              UMLPlugin.INSTANCE.getString("_UI_MultiplicityElement_UpperGELower_diagnostic", //$NON-NLS-1$
                  getMessageSubstitutions(context, multiplicityElement)),
        ...
        diagnostics.add(new BasicDiagnostic(Diagnostic.ERROR, UMLValidator.DIAGNOSTIC_SOURCE,
            ...
            org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", //$NON-NLS-1$
                new Object[] { "validateValueSpecificationNoSideEffects", //$NON-NLS-1$
                    org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(multiplicityElement, context) }), new Object[] { multiplicityElement }));
      }
      return false;
    }
    return true;
  ...
  public static boolean isMultivalued(MultiplicityElement multiplicityElement) {
    ...
    return upperBound == LiteralUnlimitedNatural.UNLIMITED || upperBound > 1;
  }
  ...
  public static boolean includesMultiplicity(MultiplicityElement multiplicityElement, MultiplicityElement M) {
    ...
    if (multiplicityElement.lowerBound() <= M.lowerBound()) {
      ...
      if (upperBound == LiteralUnlimitedNatural.UNLIMITED) {
        ...
        return mUpperBound == LiteralUnlimitedNatural.UNLIMITED ? false : upperBound >= mUpperBound;
      }
    } else {
      return false;
    }
  ...
  public static void setLower(MultiplicityElement multiplicityElement, int newLower) {
    ...
    ((LiteralInteger) (lowerValue instanceof LiteralInteger ? lowerValue
        : multiplicityElement.createLowerValue(null, null, UMLPackage.Literals.LITERAL_INTEGER))).setValue(newLower);
  }
  ...
  public static void setUpper(MultiplicityElement multiplicityElement, int newUpper) {
    ...
    ((LiteralUnlimitedNatural) (upperValue instanceof LiteralUnlimitedNatural ? upperValue
