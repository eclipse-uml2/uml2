 ...
 * @generated
 */
public class PackageableElementOperations extends NamedElementOperations {
   ...
   * @generated
   */
  public static boolean validateNamespaceNeedsVisibility(PackageableElement packageableElement,
        ...
        diagnostics.add(new BasicDiagnostic(Diagnostic.ERROR, UMLValidator.DIAGNOSTIC_SOURCE,
            ...
            org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", //$NON-NLS-1$
                new Object[] { "validateNamespaceNeedsVisibility", //$NON-NLS-1$
                    org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(packageableElement, context) }), new Object[] { packageableElement }));
      }
      return false;
    }
    return true;
