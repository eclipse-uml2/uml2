...
public class DurationIntervalImpl extends IntervalImpl implements DurationInterval {
    ...
    if (min != null && min.eIsProxy()) {
      ...
      if (min != oldMin) {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, UMLPackage.DURATION_INTERVAL__MIN, oldMin, min));
      }
    }
    return min;
  }
  ...
  public void setMin(ValueSpecification newMin) {
    ...
    min = newMin;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, UMLPackage.DURATION_INTERVAL__MIN, oldMin, min));
  }
  ...
  public ValueSpecification getMax() {
    if (max != null && max.eIsProxy()) {
      ...
      if (max != oldMax) {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, UMLPackage.DURATION_INTERVAL__MAX, oldMax, max));
      }
    }
    return max;
  }
  ...
  public void setMax(ValueSpecification newMax) {
    ...
    max = newMax;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, UMLPackage.DURATION_INTERVAL__MAX, oldMax, max));
  }
