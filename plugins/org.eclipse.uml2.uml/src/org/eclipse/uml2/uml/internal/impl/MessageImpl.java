...
public class MessageImpl extends NamedElementImpl implements Message {
  ...
  public EList<Element> getOwnedElements() {
    ...
    return new DerivedUnionEObjectEList<Element>(Element.class, this, UMLPackage.MESSAGE__OWNED_ELEMENT,
  ...
  public void setMessageSort(MessageSort newMessageSort) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, UMLPackage.MESSAGE__MESSAGE_SORT, oldMessageSort,
          newMessageSort));
  }
  ...
  public MessageEnd getReceiveEvent() {
    if (receiveEvent != null && receiveEvent.eIsProxy()) {
      ...
      if (receiveEvent != oldReceiveEvent) {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, UMLPackage.MESSAGE__RECEIVE_EVENT, oldReceiveEvent,
              receiveEvent));
      }
    }
    return receiveEvent;
  ...
  public void setReceiveEvent(MessageEnd newReceiveEvent) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, UMLPackage.MESSAGE__RECEIVE_EVENT, oldReceiveEvent,
          receiveEvent));
  }
  ...
  public MessageEnd getSendEvent() {
    if (sendEvent != null && sendEvent.eIsProxy()) {
      ...
      if (sendEvent != oldSendEvent) {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, UMLPackage.MESSAGE__SEND_EVENT, oldSendEvent,
              sendEvent));
      }
    }
    return sendEvent;
  ...
  public Connector getConnector() {
    if (connector != null && connector.eIsProxy()) {
      ...
      if (connector != oldConnector) {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, UMLPackage.MESSAGE__CONNECTOR, oldConnector,
              connector));
      }
    }
    return connector;
  ...
  public void setInteraction(Interaction newInteraction) {
    if (newInteraction != eInternalContainer()
      ...
      if (newInteraction != null)
        msgs = ((InternalEObject) newInteraction).eInverseAdd(this, UMLPackage.INTERACTION__MESSAGE, Interaction.class,
            msgs);
      msgs = basicSetInteraction(newInteraction, msgs);
      if (msgs != null)
        msgs.dispatch();
    } else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, UMLPackage.MESSAGE__INTERACTION, newInteraction,
          newInteraction));
  }
  ...
  public NamedElement getSignature() {
    if (signature != null && signature.eIsProxy()) {
      ...
      if (signature != oldSignature) {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, UMLPackage.MESSAGE__SIGNATURE, oldSignature,
              signature));
      }
    }
    return signature;
  ...
  public void setSignature(NamedElement newSignature) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, UMLPackage.MESSAGE__SIGNATURE, oldSignature, signature));
  }
   ...
   * @generated
   */
  public boolean validateSignatureIsOperationRequest(DiagnosticChain diagnostics, Map<Object, Object> context) {
   ...
   * @generated
   */
  public boolean validateSignatureIsOperationReply(DiagnosticChain diagnostics, Map<Object, Object> context) {
  ...
  public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
    ...
    case UMLPackage.MESSAGE___VALIDATE_SENDING_RECEIVING_MESSAGE_EVENT__DIAGNOSTICCHAIN_MAP:
      return validateSendingReceivingMessageEvent((DiagnosticChain) arguments.get(0),
          (Map<Object, Object>) arguments.get(1));
    ...
    case UMLPackage.MESSAGE___VALIDATE_OCCURRENCE_SPECIFICATIONS__DIAGNOSTICCHAIN_MAP:
      return validateOccurrenceSpecifications((DiagnosticChain) arguments.get(0),
          (Map<Object, Object>) arguments.get(1));
    ...
    case UMLPackage.MESSAGE___VALIDATE_SIGNATURE_IS_OPERATION_REQUEST__DIAGNOSTICCHAIN_MAP:
      return validateSignatureIsOperationRequest((DiagnosticChain) arguments.get(0),
          (Map<Object, Object>) arguments.get(1));
    case UMLPackage.MESSAGE___VALIDATE_SIGNATURE_IS_OPERATION_REPLY__DIAGNOSTICCHAIN_MAP:
      return validateSignatureIsOperationReply((DiagnosticChain) arguments.get(0),
          (Map<Object, Object>) arguments.get(1));
   ...
   * @ordered
   */
  protected static final int[] OWNED_ELEMENT_ESUBSETS = new int[] { UMLPackage.MESSAGE__OWNED_COMMENT,
      UMLPackage.MESSAGE__NAME_EXPRESSION, UMLPackage.MESSAGE__ARGUMENT };
