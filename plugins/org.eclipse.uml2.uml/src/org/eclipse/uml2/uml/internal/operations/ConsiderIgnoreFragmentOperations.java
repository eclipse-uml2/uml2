...
public class ConsiderIgnoreFragmentOperations extends CombinedFragmentOperations {
   ...
   * @generated
   */
  public static boolean validateConsiderOrIgnore(ConsiderIgnoreFragment considerIgnoreFragment,
        ...
        diagnostics.add(new BasicDiagnostic(Diagnostic.ERROR, UMLValidator.DIAGNOSTIC_SOURCE,
            ...
            org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", //$NON-NLS-1$
                new Object[] { "validateConsiderOrIgnore", //$NON-NLS-1$
                    org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(considerIgnoreFragment, context) }), new Object[] { considerIgnoreFragment }));
      }
      return false;
    }
    return true;
   ...
   * @generated
   */
  public static boolean validateType(ConsiderIgnoreFragment considerIgnoreFragment, DiagnosticChain diagnostics,
