 ...
 * @generated
 */
public class RemoveVariableValueActionOperations extends WriteVariableActionOperations {
   ...
   * @generated
   */
  public static boolean validateRemoveAtAndValue(RemoveVariableValueAction removeVariableValueAction,
        ...
        diagnostics.add(new BasicDiagnostic(Diagnostic.ERROR, UMLValidator.DIAGNOSTIC_SOURCE,
            ...
            org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", //$NON-NLS-1$
                new Object[] { "validateRemoveAtAndValue", //$NON-NLS-1$
                    org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(removeVariableValueAction, context) }), new Object[] { removeVariableValueAction }));
      }
      return false;
    }
    return true;
