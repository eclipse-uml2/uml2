...
public class GeneralOrderingOperations extends NamedElementOperations {
   ...
   * @generated
   */
  public static boolean validateIrreflexiveTransitiveClosure(GeneralOrdering generalOrdering,
        ...
        diagnostics.add(new BasicDiagnostic(Diagnostic.ERROR, UMLValidator.DIAGNOSTIC_SOURCE,
            ...
            org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", //$NON-NLS-1$
                new Object[] { "validateIrreflexiveTransitiveClosure", //$NON-NLS-1$
                    org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(generalOrdering, context) }), new Object[] { generalOrdering }));
      }
      return false;
    }
    return true;
