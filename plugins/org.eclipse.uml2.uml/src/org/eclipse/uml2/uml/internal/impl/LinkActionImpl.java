...
public abstract class LinkActionImpl extends ActionImpl implements LinkAction {
  ...
  public EList<Element> getOwnedElements() {
    ...
    return new DerivedUnionEObjectEList<Element>(Element.class, this, UMLPackage.LINK_ACTION__OWNED_ELEMENT,
   ...
   * @ordered
   */
  protected static final int[] OWNED_ELEMENT_ESUBSETS = new int[] { UMLPackage.LINK_ACTION__OWNED_COMMENT,
      UMLPackage.LINK_ACTION__NAME_EXPRESSION, UMLPackage.LINK_ACTION__HANDLER, UMLPackage.LINK_ACTION__INPUT,
      UMLPackage.LINK_ACTION__LOCAL_POSTCONDITION, UMLPackage.LINK_ACTION__LOCAL_PRECONDITION,
    ...
    if (cache != null) {
      ...
      if (inputs == null) {
        cache.put(eResource, this, UMLPackage.Literals.ACTION__INPUT,
            inputs = new DerivedUnionEObjectEList<InputPin>(InputPin.class, this, UMLPackage.LINK_ACTION__INPUT,
                INPUT_ESUBSETS));
      }
      return inputs;
    }
  ...
  public EList<LinkEndData> getEndData() {
    if (endData == null) {
      endData = new EObjectContainmentEList.Resolving<LinkEndData>(LinkEndData.class, this,
   ...
   * @generated
   */
  public boolean validateSameAssociation(DiagnosticChain diagnostics, Map<Object, Object> context) {
   ...
   * @generated
   */
  public boolean validateSamePins(DiagnosticChain diagnostics, Map<Object, Object> context) {
  ...
  public boolean isSetOwnedElements() {
    return super.isSetOwnedElements() || eIsSet(UMLPackage.LINK_ACTION__END_DATA);
  }
  ...
  public boolean isSetInputs() {
    return super.isSetInputs() || eIsSet(UMLPackage.LINK_ACTION__INPUT_VALUE);
  }
