...
public class StartObjectBehaviorActionOperations extends CallActionOperations {
   ...
   * @generated
   */
  public static boolean validateTypeOfObject(StartObjectBehaviorAction startObjectBehaviorAction,
        ...
        diagnostics.add(new BasicDiagnostic(Diagnostic.ERROR, UMLValidator.DIAGNOSTIC_SOURCE,
            ...
            org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", //$NON-NLS-1$
                new Object[] { "validateTypeOfObject", //$NON-NLS-1$
                    org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(startObjectBehaviorAction, context) }), new Object[] { startObjectBehaviorAction }));
      }
      return false;
    }
    return true;
   ...
   * @generated
   */
  public static boolean validateNoOnport(StartObjectBehaviorAction startObjectBehaviorAction,
      DiagnosticChain diagnostics, Map<Object, Object> context) {
    // TODO: implement this method
    // -> specify the condition that violates the invariant
    // -> verify the details of the diagnostic, including severity and message
  ...
  public static Behavior behavior(StartObjectBehaviorAction startObjectBehaviorAction) {
    ...
    if (type instanceof Behavior) {
      ...
      return type instanceof BehavioredClassifier ? ((BehavioredClassifier) type).getClassifierBehavior() : null;
    }
  }
   ...
   * @generated
   */
  public static boolean validateMultiplicityOfObject(StartObjectBehaviorAction startObjectBehaviorAction,
      DiagnosticChain diagnostics, Map<Object, Object> context) {
    // TODO: implement this method
    // -> specify the condition that violates the invariant
    // -> verify the details of the diagnostic, including severity and message
