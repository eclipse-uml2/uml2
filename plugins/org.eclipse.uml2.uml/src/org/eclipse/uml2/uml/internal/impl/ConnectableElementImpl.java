...
public abstract class ConnectableElementImpl extends TypedElementImpl implements ConnectableElement {
    ...
    if (templateParameter != null && templateParameter.eIsProxy()) {
      ...
      if (templateParameter != oldTemplateParameter) {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, UMLPackage.CONNECTABLE_ELEMENT__TEMPLATE_PARAMETER,
  ...
  public NotificationChain basicSetTemplateParameterGen(TemplateParameter newTemplateParameter,
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          UMLPackage.CONNECTABLE_ELEMENT__TEMPLATE_PARAMETER, oldTemplateParameter, newTemplateParameter);
      if (msgs == null)
        msgs = notification;
      else
  ...
  public void setTemplateParameter(TemplateParameter newTemplateParameter) {
    ...
    if (newTemplateParameter != templateParameter) {
      ...
      eNotify(new ENotificationImpl(this, Notification.SET, UMLPackage.CONNECTABLE_ELEMENT__TEMPLATE_PARAMETER,
  ...
  public void setOwningTemplateParameter(TemplateParameter newOwningTemplateParameter) {
    if (newOwningTemplateParameter != eInternalContainer()
      ...
      eNotify(new ENotificationImpl(this, Notification.SET, UMLPackage.CONNECTABLE_ELEMENT__OWNING_TEMPLATE_PARAMETER,
