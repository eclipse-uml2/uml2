...
public class AssociationClassImpl extends ClassImpl implements AssociationClass {
  ...
  public EList<Element> getRelatedElements() {
    ...
    if (cache != null) {
      ...
      if (relatedElements == null) {
        cache.put(eResource, this, UMLPackage.Literals.RELATIONSHIP__RELATED_ELEMENT,
            relatedElements = new DerivedUnionEObjectEList<Element>(Element.class, this,
                UMLPackage.ASSOCIATION_CLASS__RELATED_ELEMENT, RELATED_ELEMENT_ESUBSETS));
      }
      return relatedElements;
    }
    return new DerivedUnionEObjectEList<Element>(Element.class, this, UMLPackage.ASSOCIATION_CLASS__RELATED_ELEMENT,
  ...
  public EList<NamedElement> getMembers() {
    ...
    return new DerivedUnionEObjectEList<NamedElement>(NamedElement.class, this, UMLPackage.ASSOCIATION_CLASS__MEMBER,
        MEMBER_ESUBSETS);
  }
    ...
    if (cache != null) {
      ...
      if (features == null) {
        cache.put(eResource, this, UMLPackage.Literals.CLASSIFIER__FEATURE,
            features = new DerivedUnionEObjectEList<Feature>(Feature.class, this, UMLPackage.ASSOCIATION_CLASS__FEATURE,
                FEATURE_ESUBSETS));
      }
      return features;
    }
    return new DerivedUnionEObjectEList<Feature>(Feature.class, this, UMLPackage.ASSOCIATION_CLASS__FEATURE,
        FEATURE_ESUBSETS);
  }
  ...
  private EList<Property> createMemberEndsList() {
    return new SubsetSupersetEObjectWithInverseResolvingEList<Property>(Property.class, this,
        UMLPackage.ASSOCIATION_CLASS__MEMBER_END, null, MEMBER_END_ESUBSETS, UMLPackage.PROPERTY__ASSOCIATION);
  }
  ...
  private EList<Property> createOwnedEndsList() {
    return new SubsetSupersetEObjectContainmentWithInverseEList.Resolving<Property>(Property.class, this,
        UMLPackage.ASSOCIATION_CLASS__OWNED_END, OWNED_END_ESUPERSETS, OWNED_END_ESUBSETS,
  ...
  public void setIsDerived(boolean newIsDerived) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, UMLPackage.ASSOCIATION_CLASS__IS_DERIVED, oldIsDerived,
          newIsDerived));
  }
  ...
  private EList<Property> createNavigableOwnedEndsList() {
    return new SubsetSupersetEObjectResolvingEList<Property>(Property.class, this,
        UMLPackage.ASSOCIATION_CLASS__NAVIGABLE_OWNED_END, NAVIGABLE_OWNED_END_ESUPERSETS, null);
  }
   ...
   * @generated
   */
  public boolean validateCannotBeDefined(DiagnosticChain diagnostics, Map<Object, Object> context) {
   ...
   * @generated
   */
  public boolean validateDisjointAttributesEnds(DiagnosticChain diagnostics, Map<Object, Object> context) {
    ...
    case UMLPackage.ASSOCIATION_CLASS__OWNED_TEMPLATE_SIGNATURE:
      if (ownedTemplateSignature != null)
        msgs = ((InternalEObject) ownedTemplateSignature).eInverseRemove(this,
            EOPPOSITE_FEATURE_BASE - UMLPackage.ASSOCIATION_CLASS__OWNED_TEMPLATE_SIGNATURE, null, msgs);
  ...
  public boolean isSetMembers() {
    return super.isSetMembers() || eIsSet(UMLPackage.ASSOCIATION_CLASS__MEMBER_END);
  }
  ...
  public boolean isSetFeatures() {
    return super.isSetFeatures() || eIsSet(UMLPackage.ASSOCIATION_CLASS__OWNED_END);
  }
  ...
  public boolean isSetOwnedMembers() {
    return super.isSetOwnedMembers() || eIsSet(UMLPackage.ASSOCIATION_CLASS__OWNED_END);
  }
   ...
   * @ordered
   */
  protected static final int[] MEMBER_ESUBSETS = new int[] { UMLPackage.ASSOCIATION_CLASS__OWNED_MEMBER,
      UMLPackage.ASSOCIATION_CLASS__IMPORTED_MEMBER, UMLPackage.ASSOCIATION_CLASS__FEATURE,
      UMLPackage.ASSOCIATION_CLASS__INHERITED_MEMBER, UMLPackage.ASSOCIATION_CLASS__ROLE,
   ...
   * @ordered
   */
  protected static final int[] FEATURE_ESUBSETS = new int[] { UMLPackage.ASSOCIATION_CLASS__ATTRIBUTE,
      UMLPackage.ASSOCIATION_CLASS__OWNED_CONNECTOR, UMLPackage.ASSOCIATION_CLASS__OWNED_OPERATION,
      UMLPackage.ASSOCIATION_CLASS__OWNED_RECEPTION, UMLPackage.ASSOCIATION_CLASS__OWNED_END };
   ...
   * @ordered
   */
  protected static final int[] OWNED_MEMBER_ESUBSETS = new int[] { UMLPackage.ASSOCIATION_CLASS__OWNED_RULE,
      UMLPackage.ASSOCIATION_CLASS__OWNED_USE_CASE, UMLPackage.ASSOCIATION_CLASS__OWNED_ATTRIBUTE,
      UMLPackage.ASSOCIATION_CLASS__OWNED_CONNECTOR, UMLPackage.ASSOCIATION_CLASS__OWNED_BEHAVIOR,
      UMLPackage.ASSOCIATION_CLASS__OWNED_OPERATION, UMLPackage.ASSOCIATION_CLASS__NESTED_CLASSIFIER,
      UMLPackage.ASSOCIATION_CLASS__OWNED_RECEPTION, UMLPackage.ASSOCIATION_CLASS__OWNED_END };
