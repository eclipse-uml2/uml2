 ...
 * @generated
 */
public class BroadcastSignalActionOperations extends ActionOperations {
   ...
   * @generated
   */
  public static boolean validateNumberOfArguments(BroadcastSignalAction broadcastSignalAction,
        ...
        diagnostics.add(new BasicDiagnostic(Diagnostic.ERROR, UMLValidator.DIAGNOSTIC_SOURCE,
            ...
            org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", //$NON-NLS-1$
                new Object[] { "validateNumberOfArguments", //$NON-NLS-1$
                    org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(broadcastSignalAction, context) }), new Object[] { broadcastSignalAction }));
      }
      return false;
    }
    return true;
   ...
   * @generated
   */
  public static boolean validateTypeOrderingMultiplicity(BroadcastSignalAction broadcastSignalAction,
      DiagnosticChain diagnostics, Map<Object, Object> context) {
    // TODO: implement this method
    // -> specify the condition that violates the invariant
    // -> verify the details of the diagnostic, including severity and message
   ...
   * @generated
   */
  public static boolean validateNoOnport(BroadcastSignalAction broadcastSignalAction, DiagnosticChain diagnostics,
