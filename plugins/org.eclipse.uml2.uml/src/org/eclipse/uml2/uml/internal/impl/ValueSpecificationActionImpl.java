...
public class ValueSpecificationActionImpl extends ActionImpl implements ValueSpecificationAction {
  ...
  public EList<OutputPin> getOutputs() {
    ...
    return new DerivedUnionEObjectEList<OutputPin>(OutputPin.class, this, UMLPackage.VALUE_SPECIFICATION_ACTION__OUTPUT,
        OUTPUT_ESUBSETS);
  }
    ...
    if (value != null && value.eIsProxy()) {
      ...
      if (value != oldValue) {
        ...
        NotificationChain msgs = oldValue.eInverseRemove(this,
            EOPPOSITE_FEATURE_BASE - UMLPackage.VALUE_SPECIFICATION_ACTION__VALUE, null, null);
        if (newValue.eInternalContainer() == null) {
          msgs = newValue.eInverseAdd(this, EOPPOSITE_FEATURE_BASE - UMLPackage.VALUE_SPECIFICATION_ACTION__VALUE, null,
              msgs);
        }
        if (msgs != null)
          msgs.dispatch();
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, UMLPackage.VALUE_SPECIFICATION_ACTION__VALUE,
              oldValue, value));
      }
    }
    return value;
  ...
  public NotificationChain basicSetValue(ValueSpecification newValue, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          UMLPackage.VALUE_SPECIFICATION_ACTION__VALUE, oldValue, newValue);
      if (msgs == null)
        msgs = notification;
      else
    ...
    if (newValue != value) {
      ...
      if (value != null)
        msgs = ((InternalEObject) value).eInverseRemove(this,
            EOPPOSITE_FEATURE_BASE - UMLPackage.VALUE_SPECIFICATION_ACTION__VALUE, null, msgs);
      if (newValue != null)
      ...
      eNotify(new ENotificationImpl(this, Notification.SET, UMLPackage.VALUE_SPECIFICATION_ACTION__VALUE, newValue,
          newValue));
  }
    ...
    if (result != null && result.eIsProxy()) {
      ...
      if (result != oldResult) {
        ...
        NotificationChain msgs = oldResult.eInverseRemove(this,
            EOPPOSITE_FEATURE_BASE - UMLPackage.VALUE_SPECIFICATION_ACTION__RESULT, null, null);
        if (newResult.eInternalContainer() == null) {
          msgs = newResult.eInverseAdd(this, EOPPOSITE_FEATURE_BASE - UMLPackage.VALUE_SPECIFICATION_ACTION__RESULT,
              null, msgs);
        }
        if (msgs != null)
          msgs.dispatch();
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, UMLPackage.VALUE_SPECIFICATION_ACTION__RESULT,
              oldResult, result));
      }
    }
    return result;
  ...
  public NotificationChain basicSetResult(OutputPin newResult, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          UMLPackage.VALUE_SPECIFICATION_ACTION__RESULT, oldResult, newResult);
      if (msgs == null)
        msgs = notification;
      else
        msgs.add(notification);
    ...
    if (newResult != result) {
      ...
      if (result != null)
        msgs = ((InternalEObject) result).eInverseRemove(this,
            EOPPOSITE_FEATURE_BASE - UMLPackage.VALUE_SPECIFICATION_ACTION__RESULT, null, msgs);
      if (newResult != null)
      ...
      eNotify(new ENotificationImpl(this, Notification.SET, UMLPackage.VALUE_SPECIFICATION_ACTION__RESULT, newResult,
          newResult));
  }
   ...
   * @generated
   */
  public boolean validateCompatibleType(DiagnosticChain diagnostics, Map<Object, Object> context) {
      ...
      if (ownedElements == null) {
        cache.put(eResource, this, UMLPackage.Literals.ELEMENT__OWNED_ELEMENT,
            ownedElements = new DerivedUnionEObjectEList<Element>(Element.class, this,
                UMLPackage.VALUE_SPECIFICATION_ACTION__OWNED_ELEMENT, OWNED_ELEMENT_ESUBSETS));
      }
  ...
  protected static final int[] OWNED_ELEMENT_ESUBSETS = new int[] {
      UMLPackage.VALUE_SPECIFICATION_ACTION__OWNED_COMMENT, UMLPackage.VALUE_SPECIFICATION_ACTION__NAME_EXPRESSION,
      UMLPackage.VALUE_SPECIFICATION_ACTION__HANDLER, UMLPackage.VALUE_SPECIFICATION_ACTION__INPUT,
      UMLPackage.VALUE_SPECIFICATION_ACTION__LOCAL_POSTCONDITION,
      UMLPackage.VALUE_SPECIFICATION_ACTION__LOCAL_PRECONDITION, UMLPackage.VALUE_SPECIFICATION_ACTION__OUTPUT,
  ...
  public boolean isSetOutputs() {
    return super.isSetOutputs() || eIsSet(UMLPackage.VALUE_SPECIFICATION_ACTION__RESULT);
  }
  ...
  public boolean isSetOwnedElements() {
    return super.isSetOwnedElements() || eIsSet(UMLPackage.VALUE_SPECIFICATION_ACTION__VALUE);
  }
