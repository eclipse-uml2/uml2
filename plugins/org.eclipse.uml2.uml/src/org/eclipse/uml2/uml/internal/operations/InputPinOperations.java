 ...
 * @generated
 */
public class InputPinOperations extends PinOperations {
   ...
   * @generated
   */
  public static boolean validateOutgoingEdgesStructuredOnly(InputPin inputPin, DiagnosticChain diagnostics,
        ...
        diagnostics.add(new BasicDiagnostic(Diagnostic.ERROR, UMLValidator.DIAGNOSTIC_SOURCE,
            ...
            org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", //$NON-NLS-1$
                new Object[] { "validateOutgoingEdgesStructuredOnly", //$NON-NLS-1$
                    org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(inputPin, context) }), new Object[] { inputPin }));
      }
      return false;
    }
    return true;
