...
public class RaiseExceptionActionImpl extends ActionImpl implements RaiseExceptionAction {
  ...
  public EList<InputPin> getInputs() {
    ...
    return new DerivedUnionEObjectEList<InputPin>(InputPin.class, this, UMLPackage.RAISE_EXCEPTION_ACTION__INPUT,
        INPUT_ESUBSETS);
  }
    ...
    if (exception != null && exception.eIsProxy()) {
      ...
      if (exception != oldException) {
        ...
        NotificationChain msgs = oldException.eInverseRemove(this,
            EOPPOSITE_FEATURE_BASE - UMLPackage.RAISE_EXCEPTION_ACTION__EXCEPTION, null, null);
        if (newException.eInternalContainer() == null) {
          msgs = newException.eInverseAdd(this, EOPPOSITE_FEATURE_BASE - UMLPackage.RAISE_EXCEPTION_ACTION__EXCEPTION,
              null, msgs);
        }
        if (msgs != null)
          msgs.dispatch();
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, UMLPackage.RAISE_EXCEPTION_ACTION__EXCEPTION,
  ...
  public NotificationChain basicSetException(InputPin newException, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          UMLPackage.RAISE_EXCEPTION_ACTION__EXCEPTION, oldException, newException);
      if (msgs == null)
        msgs = notification;
      else
    ...
    if (newException != exception) {
      ...
      if (exception != null)
        msgs = ((InternalEObject) exception).eInverseRemove(this,
            EOPPOSITE_FEATURE_BASE - UMLPackage.RAISE_EXCEPTION_ACTION__EXCEPTION, null, msgs);
      ...
      eNotify(new ENotificationImpl(this, Notification.SET, UMLPackage.RAISE_EXCEPTION_ACTION__EXCEPTION, newException,
          newException));
  }
  ...
  public boolean isSetInputs() {
    return super.isSetInputs() || eIsSet(UMLPackage.RAISE_EXCEPTION_ACTION__EXCEPTION);
  }
