...
public class BehaviorOperations extends ClassOperations {
   ...
   * @generated
   */
  public static boolean validateMostOneBehavior(Behavior behavior, DiagnosticChain diagnostics,
        ...
        diagnostics.add(new BasicDiagnostic(Diagnostic.ERROR, UMLValidator.DIAGNOSTIC_SOURCE,
            ...
            org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", //$NON-NLS-1$
                new Object[] { "validateMostOneBehavior", //$NON-NLS-1$
                    org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(behavior, context) }), new Object[] { behavior }));
      }
      return false;
    }
    return true;
   ...
   * @generated NOT
   */
  public static boolean validateParametersMatch(Behavior behavior, DiagnosticChain diagnostics,
      Map<Object, Object> context) {
    boolean result = true;
    ...
    if (specification != null) {
      ...
      if (behaviorOwnedParameters.size() != specificationOwnedParameters.size()) {
        ...
        Iterator<Parameter> sop = specificationOwnedParameters.iterator();
      ...
      if (!result && diagnostics != null) {
        diagnostics.add(new BasicDiagnostic(Diagnostic.WARNING, UMLValidator.DIAGNOSTIC_SOURCE,
            ...
            UMLPlugin.INSTANCE.getString("_UI_Behavior_ParametersMatch_diagnostic", //$NON-NLS-1$
   ...
   * @generated NOT
   */
  public static boolean validateFeatureOfContextClassifier(Behavior behavior, DiagnosticChain diagnostics,
      Map<Object, Object> context) {
    BehavioralFeature specification = behavior.getSpecification();
    ...
    if (specification != null) {
      ...
      if (contextClassifier == null || !contextClassifier.allFeatures().contains(specification)) {

        if (diagnostics != null) {
          diagnostics.add(new BasicDiagnostic(Diagnostic.WARNING, UMLValidator.DIAGNOSTIC_SOURCE,
              UMLValidator.BEHAVIOR__FEATURE_OF_CONTEXT_CLASSIFIER,
              UMLPlugin.INSTANCE.getString("_UI_Behavior_FeatureOfContextClassifier_diagnostic", //$NON-NLS-1$
                  getMessageSubstitutions(context, behavior)),
              new Object[] { behavior }));
        }
  ...
  public static BehavioredClassifier getContext(Behavior behavior) {
    ...
    if (containmentFeature != UMLPackage.Literals.CLASS__NESTED_CLASSIFIER
      ...
      BehavioredClassifier b = behavior.behavioredClassifier(behavior.getOwner());
  ...
  public static EList<Parameter> outputParameters(Behavior behavior) {
    ...
    for (Parameter ownedParameter : behavior.getOwnedParameters()) {
      ...
      if (direction == ParameterDirectionKind.OUT_LITERAL || direction == ParameterDirectionKind.INOUT_LITERAL
