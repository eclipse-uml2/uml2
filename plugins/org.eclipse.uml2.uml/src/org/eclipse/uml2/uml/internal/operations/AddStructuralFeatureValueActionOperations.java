...
public class AddStructuralFeatureValueActionOperations extends WriteStructuralFeatureActionOperations {
   ...
   * @generated NOT
   */
  public static boolean validateRequiredValue(AddStructuralFeatureValueAction addStructuralFeatureValueAction,
    ...
    if (!result && diagnostics != null) {
      diagnostics.add(new BasicDiagnostic(Diagnostic.WARNING, UMLValidator.DIAGNOSTIC_SOURCE,
          ...
          UMLPlugin.INSTANCE.getString("_UI_AddStructuralFeatureValueAction_RequiredValue_diagnostic", //$NON-NLS-1$
              getMessageSubstitutions(context, addStructuralFeatureValueAction)),
   ...
   * @generated
   */
  public static boolean validateInsertAtPin(AddStructuralFeatureValueAction addStructuralFeatureValueAction,
      DiagnosticChain diagnostics, Map<Object, Object> context) {
        ...
        diagnostics.add(new BasicDiagnostic(Diagnostic.ERROR, UMLValidator.DIAGNOSTIC_SOURCE,
            ...
            org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", //$NON-NLS-1$
                new Object[] { "validateInsertAtPin", //$NON-NLS-1$
                    org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(addStructuralFeatureValueAction,
