...
public class StartObjectBehaviorActionImpl extends CallActionImpl implements StartObjectBehaviorAction {
  ...
  public EList<InputPin> getInputs() {
    ...
    return new DerivedUnionEObjectEList<InputPin>(InputPin.class, this, UMLPackage.START_OBJECT_BEHAVIOR_ACTION__INPUT,
        INPUT_ESUBSETS);
  }
   ...
   * @ordered
   */
  protected static final int[] INPUT_ESUBSETS = new int[] { UMLPackage.START_OBJECT_BEHAVIOR_ACTION__ARGUMENT,
    ...
    if (object != null && object.eIsProxy()) {
      ...
      if (object != oldObject) {
        ...
        NotificationChain msgs = oldObject.eInverseRemove(this,
            EOPPOSITE_FEATURE_BASE - UMLPackage.START_OBJECT_BEHAVIOR_ACTION__OBJECT, null, null);
        if (newObject.eInternalContainer() == null) {
          msgs = newObject.eInverseAdd(this, EOPPOSITE_FEATURE_BASE - UMLPackage.START_OBJECT_BEHAVIOR_ACTION__OBJECT,
              null, msgs);
        }
        if (msgs != null)
          msgs.dispatch();
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, UMLPackage.START_OBJECT_BEHAVIOR_ACTION__OBJECT,
              oldObject, object));
      }
    }
    return object;
  ...
  public NotificationChain basicSetObject(InputPin newObject, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          UMLPackage.START_OBJECT_BEHAVIOR_ACTION__OBJECT, oldObject, newObject);
      if (msgs == null)
        msgs = notification;
      else
    ...
    if (newObject != object) {
      ...
      if (object != null)
        msgs = ((InternalEObject) object).eInverseRemove(this,
            EOPPOSITE_FEATURE_BASE - UMLPackage.START_OBJECT_BEHAVIOR_ACTION__OBJECT, null, msgs);
      if (newObject != null)
      ...
      eNotify(new ENotificationImpl(this, Notification.SET, UMLPackage.START_OBJECT_BEHAVIOR_ACTION__OBJECT, newObject,
          newObject));
  }
    ...
    if (cache != null) {
      ...
      if (result == null) {
        cache.put(this, UMLPackage.Literals.CALL_ACTION___OUTPUT_PARAMETERS,
            result = StartObjectBehaviorActionOperations.outputParameters(this));
      }
      return result;
    }
    ...
    if (cache != null) {
      ...
      if (result == null) {
        cache.put(this, UMLPackage.Literals.CALL_ACTION___INPUT_PARAMETERS,
            result = StartObjectBehaviorActionOperations.inputParameters(this));
      }
      return result;
    }
  ...
  public boolean isSetInputs() {
    return super.isSetInputs() || eIsSet(UMLPackage.START_OBJECT_BEHAVIOR_ACTION__OBJECT);
  }
