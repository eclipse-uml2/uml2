 ...
 * @generated
 */
public class GeneralizationSetOperations extends PackageableElementOperations {
   ...
   * @generated
   */
  public static boolean validateGeneralizationSameClassifier(GeneralizationSet generalizationSet,
        ...
        diagnostics.add(new BasicDiagnostic(Diagnostic.ERROR, UMLValidator.DIAGNOSTIC_SOURCE,
            ...
            org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", //$NON-NLS-1$
                new Object[] { "validateGeneralizationSameClassifier", //$NON-NLS-1$
                    org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(generalizationSet, context) }), new Object[] { generalizationSet }));
      }
      return false;
    }
    return true;
   ...
   * @generated
   */
  public static boolean validateMapsToGeneralizationSet(GeneralizationSet generalizationSet,
      DiagnosticChain diagnostics, Map<Object, Object> context) {
    // TODO: implement this method
    // -> specify the condition that violates the invariant
    // -> verify the details of the diagnostic, including severity and message
