...
public class TemplateParameterOperations extends ElementOperations {
   ...
   * @generated
   */
  public static boolean validateMustBeCompatible(TemplateParameter templateParameter, DiagnosticChain diagnostics,
        ...
        diagnostics.add(new BasicDiagnostic(Diagnostic.ERROR, UMLValidator.DIAGNOSTIC_SOURCE,
            ...
            org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", //$NON-NLS-1$
                new Object[] { "validateMustBeCompatible", //$NON-NLS-1$
                    org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(templateParameter, context) }), new Object[] { templateParameter }));
      }
      return false;
    }
    return true;
