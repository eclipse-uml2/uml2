...
/**
 * <!-- begin-user-doc -->
 * A static utility class that provides operations related to '<em><b>Clear Association Action</b></em>' model objects.
 * <!-- end-user-doc -->
 *
 * <p>
 ...
 * @generated
 */
public class ClearAssociationActionOperations extends ActionOperations {
   ...
   * @generated
   */
  protected ClearAssociationActionOperations() {
    super();
  }
   ...
   * @param clearAssociationAction The receiving '<em><b>Clear Association Action</b></em>' model object.
   * @param diagnostics The chain of diagnostics to which problems are to be appended.
   * @param context The cache of context-specific information.
   * <!-- end-model-doc -->
   * @generated
   */
  public static boolean validateSameType(ClearAssociationAction clearAssociationAction, DiagnosticChain diagnostics,
        ...
        diagnostics.add(new BasicDiagnostic(Diagnostic.ERROR, UMLValidator.DIAGNOSTIC_SOURCE,
            ...
            org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", //$NON-NLS-1$
                new Object[] { "validateSameType", //$NON-NLS-1$
                    org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(clearAssociationAction, context) }), new Object[] { clearAssociationAction }));
      }
      return false;
    }
    return true;
   ...
   * @generated
   */
  public static boolean validateMultiplicity(ClearAssociationAction clearAssociationAction, DiagnosticChain diagnostics,
      Map<Object, Object> context) {
    // TODO: implement this method
    // -> specify the condition that violates the invariant
    // -> verify the details of the diagnostic, including severity and message
...
} // ClearAssociationActionOperations