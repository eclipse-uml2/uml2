 ...
 * @generated
 */
public class ObjectNodeOperations extends ActivityNodeOperations {
   ...
   * @generated
   */
  public static boolean validateObjectFlowEdges(ObjectNode objectNode, DiagnosticChain diagnostics,
        ...
        diagnostics.add(new BasicDiagnostic(Diagnostic.ERROR, UMLValidator.DIAGNOSTIC_SOURCE,
            ...
            org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", //$NON-NLS-1$
                new Object[] { "validateObjectFlowEdges", //$NON-NLS-1$
                    org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(objectNode, context) }), new Object[] { objectNode }));
      }
      return false;
    }
    return true;
   ...
   * @generated
   */
  public static boolean validateSelectionBehavior(ObjectNode objectNode, DiagnosticChain diagnostics,
      Map<Object, Object> context) {
    // TODO: implement this method
    // -> specify the condition that violates the invariant
    // -> verify the details of the diagnostic, including severity and message
   ...
   * @generated
   */
  public static boolean validateInputOutputParameter(ObjectNode objectNode, DiagnosticChain diagnostics,
      Map<Object, Object> context) {
    // TODO: implement this method
    // -> specify the condition that violates the invariant
    // -> verify the details of the diagnostic, including severity and message
