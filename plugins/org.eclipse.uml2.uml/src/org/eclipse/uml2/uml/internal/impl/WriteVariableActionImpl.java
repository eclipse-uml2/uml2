...
public abstract class WriteVariableActionImpl extends VariableActionImpl implements WriteVariableAction {
  ...
  public EList<InputPin> getInputs() {
    ...
    return new DerivedUnionEObjectEList<InputPin>(InputPin.class, this, UMLPackage.WRITE_VARIABLE_ACTION__INPUT,
        INPUT_ESUBSETS);
  }
    ...
    if (value != null && value.eIsProxy()) {
      ...
      if (value != oldValue) {
        ...
        NotificationChain msgs = oldValue.eInverseRemove(this,
            EOPPOSITE_FEATURE_BASE - UMLPackage.WRITE_VARIABLE_ACTION__VALUE, null, null);
        if (newValue.eInternalContainer() == null) {
          msgs = newValue.eInverseAdd(this, EOPPOSITE_FEATURE_BASE - UMLPackage.WRITE_VARIABLE_ACTION__VALUE, null,
              msgs);
        }
        if (msgs != null)
          msgs.dispatch();
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, UMLPackage.WRITE_VARIABLE_ACTION__VALUE, oldValue,
              value));
      }
    }
    return value;
  ...
  public NotificationChain basicSetValue(InputPin newValue, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          UMLPackage.WRITE_VARIABLE_ACTION__VALUE, oldValue, newValue);
      if (msgs == null)
        msgs = notification;
      else
    ...
    if (newValue != value) {
      ...
      if (value != null)
        msgs = ((InternalEObject) value).eInverseRemove(this,
            EOPPOSITE_FEATURE_BASE - UMLPackage.WRITE_VARIABLE_ACTION__VALUE, null, msgs);
      if (newValue != null)
      ...
      eNotify(
          new ENotificationImpl(this, Notification.SET, UMLPackage.WRITE_VARIABLE_ACTION__VALUE, newValue, newValue));
  }
   ...
   * @generated
   */
  public boolean validateValueType(DiagnosticChain diagnostics, Map<Object, Object> context) {
  ...
  public boolean isSetInputs() {
    return super.isSetInputs() || eIsSet(UMLPackage.WRITE_VARIABLE_ACTION__VALUE);
  }
