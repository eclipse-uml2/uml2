...
public class ExtensionOperations extends AssociationOperations {
   ...
   * @generated
   */
  public static boolean validateNonOwnedEnd(Extension extension, DiagnosticChain diagnostics,
    ...
    if (false) {
      if (diagnostics != null) {
        diagnostics.add(
            new BasicDiagnostic(Diagnostic.ERROR, UMLValidator.DIAGNOSTIC_SOURCE, UMLValidator.EXTENSION__NON_OWNED_END,
                org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", //$NON-NLS-1$
                    new Object[] { "validateNonOwnedEnd", //$NON-NLS-1$
                        org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(extension, context) }), new Object[] { extension }));
      }
      return false;
    }
    return true;
   ...
   * @generated
   */
  public static boolean validateIsBinary(Extension extension, DiagnosticChain diagnostics,
      Map<Object, Object> context) {
    // TODO: implement this method
    // -> specify the condition that violates the invariant
    // -> verify the details of the diagnostic, including severity and message
    ...
    if (false) {
      if (diagnostics != null) {
        diagnostics.add(
            new BasicDiagnostic(Diagnostic.ERROR, UMLValidator.DIAGNOSTIC_SOURCE, UMLValidator.EXTENSION__IS_BINARY,
                org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", //$NON-NLS-1$
  ...
  public static Property getStereotypeEnd(Extension extension) {
    ...
    return ownedEnds.size() > 0 ? ownedEnds.get(0) : null;
  }
  ...
  public static org.eclipse.uml2.uml.Class getMetaclass(Extension extension) {
    ...
    if (metaclassEnd != null) {
      Object type = metaclassEnd.eGet(UMLPackage.Literals.TYPED_ELEMENT__TYPE, false);
