...
public class RedefinableElementOperations extends NamedElementOperations {
      ...
      if (!redefinableElement.isRedefinitionContextValid(redefinedElement)) {
        ...
        if (diagnostics == null) {
          ...
          diagnostics.add(new BasicDiagnostic(Diagnostic.WARNING, UMLValidator.DIAGNOSTIC_SOURCE,
              ...
              UMLPlugin.INSTANCE.getString("_UI_RedefinableElement_RedefinitionContextValid_diagnostic", //$NON-NLS-1$
                  getMessageSubstitutions(context, redefinableElement, redefinedElement)),
      ...
      if (!redefinedElement.isConsistentWith(redefinableElement)) {
        ...
        if (diagnostics == null) {
          ...
          diagnostics.add(new BasicDiagnostic(Diagnostic.WARNING, UMLValidator.DIAGNOSTIC_SOURCE,
              ...
              UMLPlugin.INSTANCE.getString("_UI_RedefinableElement_RedefinitionConsistent_diagnostic", //$NON-NLS-1$
                  getMessageSubstitutions(context, redefinableElement, redefinedElement)),
              new Object[] { redefinableElement, redefinedElement }));
        }
      }
   ...
   * @generated
   */
  public static boolean validateNonLeafRedefinition(RedefinableElement redefinableElement, DiagnosticChain diagnostics,
        ...
        diagnostics.add(new BasicDiagnostic(Diagnostic.ERROR, UMLValidator.DIAGNOSTIC_SOURCE,
            ...
            org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", //$NON-NLS-1$
                new Object[] { "validateNonLeafRedefinition", //$NON-NLS-1$
                    org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(redefinableElement, context) }), new Object[] { redefinableElement }));
      }
      return false;
    }
    return true;
  ...
  public static boolean isRedefinitionContextValid(RedefinableElement redefinableElement,
    ...
    for (Classifier redefinitionContext : redefinableElement.getRedefinitionContexts()) {
      ...
      if (redefinitionContext.allParents().containsAll(redefinedRedefinitionContexts)) {
  ...
  protected static EList<RedefinableElement> getAllRedefinedElements(RedefinableElement redefinableElement) {
    return getAllRedefinedElements(redefinableElement, new UniqueEList.FastCompare<RedefinableElement>());
  }
  ...
  protected static <E extends Element> EList<E> excludeRedefinedElements(EList<E> redefineableElements) {
    ...
    for (Element redefinableElement : redefineableElements) {
      ...
      if (redefinableElement instanceof RedefinableElement) {
        getAllRedefinedElements((RedefinableElement) redefinableElement, allRedefinedElements);
      }
    }
