 ...
 * @generated
 */
public class CallOperationActionOperations extends CallActionOperations {
   ...
   * @generated
   */
  public static boolean validateTypeTargetPin(CallOperationAction callOperationAction, DiagnosticChain diagnostics,
        ...
        diagnostics.add(new BasicDiagnostic(Diagnostic.ERROR, UMLValidator.DIAGNOSTIC_SOURCE,
            ...
            org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", //$NON-NLS-1$
                new Object[] { "validateTypeTargetPin", //$NON-NLS-1$
                    org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(callOperationAction, context) }), new Object[] { callOperationAction }));
      }
      return false;
    }
    return true;
   ...
   * @generated NOT
   */
  public static EList<Parameter> outputParameters(CallOperationAction callOperationAction) {
   ...
   * @generated NOT
   */
  public static EList<Parameter> inputParameters(CallOperationAction callOperationAction) {
    Operation operation = callOperationAction.getOperation();
