 ...
 * @generated
 */
public class ActivityEdgeOperations extends RedefinableElementOperations {
   ...
   * @generated
   */
  public static boolean validateSourceAndTarget(ActivityEdge activityEdge, DiagnosticChain diagnostics,
        ...
        diagnostics.add(new BasicDiagnostic(Diagnostic.ERROR, UMLValidator.DIAGNOSTIC_SOURCE,
            ...
            org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", //$NON-NLS-1$
                new Object[] { "validateSourceAndTarget", //$NON-NLS-1$
                    org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(activityEdge, context) }), new Object[] { activityEdge }));
      }
      return false;
    }
    return true;
   ...
   * @generated NOT
   */
  public static boolean isConsistentWith(ActivityEdge activityEdge, RedefinableElement redefiningElement) {
