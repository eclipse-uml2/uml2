...
public class OperationTemplateParameterImpl extends TemplateParameterImpl implements OperationTemplateParameter {
      ...
      if (parameteredElement != oldParameteredElement) {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE,
              UMLPackage.OPERATION_TEMPLATE_PARAMETER__PARAMETERED_ELEMENT, oldParameteredElement, parameteredElement));
      }
    }
  ...
  public NotificationChain basicSetParameteredElementGen(ParameterableElement newParameteredElement,
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          UMLPackage.OPERATION_TEMPLATE_PARAMETER__PARAMETERED_ELEMENT, oldParameteredElement, newParameteredElement);
      if (msgs == null)
        msgs = notification;
      else
  ...
  public void setParameteredElement(ParameterableElement newParameteredElement) {
    ...
    if (newParameteredElement != parameteredElement) {
      ...
      eNotify(new ENotificationImpl(this, Notification.SET,
          UMLPackage.OPERATION_TEMPLATE_PARAMETER__PARAMETERED_ELEMENT, newParameteredElement, newParameteredElement));
  }
   ...
   * @generated
   */
  public boolean validateMatchDefaultSignature(DiagnosticChain diagnostics, Map<Object, Object> context) {
    ...
    case UMLPackage.OPERATION_TEMPLATE_PARAMETER__OWNED_PARAMETERED_ELEMENT:
      if (ownedParameteredElement != null)
        msgs = ((InternalEObject) ownedParameteredElement).eInverseRemove(this,
            EOPPOSITE_FEATURE_BASE - UMLPackage.OPERATION_TEMPLATE_PARAMETER__OWNED_PARAMETERED_ELEMENT, null, msgs);
