...
public abstract class EncapsulatedClassifierImpl extends StructuredClassifierImpl implements EncapsulatedClassifier {
  ...
  public EList<Port> getOwnedPorts() {
    ...
    if (cache != null) {
      ...
      if (ownedPorts == null) {
        cache.put(eResource, this, UMLPackage.Literals.ENCAPSULATED_CLASSIFIER__OWNED_PORT,
            ownedPorts = new DerivedSubsetEObjectEList<Port>(Port.class, this,
                UMLPackage.ENCAPSULATED_CLASSIFIER__OWNED_PORT, OWNED_PORT_ESUPERSETS));
      }
      return ownedPorts;
    }
    return new DerivedSubsetEObjectEList<Port>(Port.class, this, UMLPackage.ENCAPSULATED_CLASSIFIER__OWNED_PORT,
  ...
  public Port getOwnedPort(String name, Type type, boolean ignoreCase, boolean createOnDemand) {
    ...
    return createOnDemand ? createOwnedPort(name, type) : null;
  }
