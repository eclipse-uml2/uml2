...
public class ReadLinkObjectEndActionImpl extends ActionImpl implements ReadLinkObjectEndAction {
  ...
  public EList<InputPin> getInputs() {
    ...
    return new DerivedUnionEObjectEList<InputPin>(InputPin.class, this, UMLPackage.READ_LINK_OBJECT_END_ACTION__INPUT,
        INPUT_ESUBSETS);
  }
    ...
    if (object != null && object.eIsProxy()) {
      ...
      if (object != oldObject) {
        ...
        NotificationChain msgs = oldObject.eInverseRemove(this,
            EOPPOSITE_FEATURE_BASE - UMLPackage.READ_LINK_OBJECT_END_ACTION__OBJECT, null, null);
        if (newObject.eInternalContainer() == null) {
          msgs = newObject.eInverseAdd(this, EOPPOSITE_FEATURE_BASE - UMLPackage.READ_LINK_OBJECT_END_ACTION__OBJECT,
              null, msgs);
        }
        if (msgs != null)
          msgs.dispatch();
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, UMLPackage.READ_LINK_OBJECT_END_ACTION__OBJECT,
              oldObject, object));
      }
    }
    return object;
  ...
  public NotificationChain basicSetObject(InputPin newObject, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          UMLPackage.READ_LINK_OBJECT_END_ACTION__OBJECT, oldObject, newObject);
      if (msgs == null)
        msgs = notification;
      else
    ...
    if (newObject != object) {
      ...
      if (object != null)
        msgs = ((InternalEObject) object).eInverseRemove(this,
            EOPPOSITE_FEATURE_BASE - UMLPackage.READ_LINK_OBJECT_END_ACTION__OBJECT, null, msgs);
      if (newObject != null)
      ...
      eNotify(new ENotificationImpl(this, Notification.SET, UMLPackage.READ_LINK_OBJECT_END_ACTION__OBJECT, newObject,
          newObject));
  }
  ...
  public Property getEnd() {
    if (end != null && end.eIsProxy()) {
      ...
      if (end != oldEnd) {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, UMLPackage.READ_LINK_OBJECT_END_ACTION__END, oldEnd,
              end));
      }
    }
    return end;
    ...
    if (result != null && result.eIsProxy()) {
      ...
      if (result != oldResult) {
        ...
        NotificationChain msgs = oldResult.eInverseRemove(this,
            EOPPOSITE_FEATURE_BASE - UMLPackage.READ_LINK_OBJECT_END_ACTION__RESULT, null, null);
        if (newResult.eInternalContainer() == null) {
          msgs = newResult.eInverseAdd(this, EOPPOSITE_FEATURE_BASE - UMLPackage.READ_LINK_OBJECT_END_ACTION__RESULT,
              null, msgs);
        }
        if (msgs != null)
          msgs.dispatch();
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, UMLPackage.READ_LINK_OBJECT_END_ACTION__RESULT,
              oldResult, result));
      }
    }
    return result;
  ...
  public NotificationChain basicSetResult(OutputPin newResult, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          UMLPackage.READ_LINK_OBJECT_END_ACTION__RESULT, oldResult, newResult);
      if (msgs == null)
        msgs = notification;
      else
        msgs.add(notification);
    ...
    if (newResult != result) {
      ...
      if (result != null)
        msgs = ((InternalEObject) result).eInverseRemove(this,
            EOPPOSITE_FEATURE_BASE - UMLPackage.READ_LINK_OBJECT_END_ACTION__RESULT, null, msgs);
      if (newResult != null)
      ...
      eNotify(new ENotificationImpl(this, Notification.SET, UMLPackage.READ_LINK_OBJECT_END_ACTION__RESULT, newResult,
          newResult));
  }
   ...
   * @generated
   */
  public boolean validateProperty(DiagnosticChain diagnostics, Map<Object, Object> context) {
   ...
   * @generated
   */
  public boolean validateAssociationOfAssociation(DiagnosticChain diagnostics, Map<Object, Object> context) {
   ...
   * @generated
   */
  public boolean validateEndsOfAssociation(DiagnosticChain diagnostics, Map<Object, Object> context) {
   ...
   * @generated
   */
  public boolean validateTypeOfObject(DiagnosticChain diagnostics, Map<Object, Object> context) {
   ...
   * @generated
   */
  public boolean validateMultiplicityOfObject(DiagnosticChain diagnostics, Map<Object, Object> context) {
   ...
   * @generated
   */
  public boolean validateTypeOfResult(DiagnosticChain diagnostics, Map<Object, Object> context) {
   ...
   * @generated
   */
  public boolean validateMultiplicityOfResult(DiagnosticChain diagnostics, Map<Object, Object> context) {
  ...
  public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
    ...
    case UMLPackage.READ_LINK_OBJECT_END_ACTION___VALIDATE_ASSOCIATION_OF_ASSOCIATION__DIAGNOSTICCHAIN_MAP:
      return validateAssociationOfAssociation((DiagnosticChain) arguments.get(0),
          (Map<Object, Object>) arguments.get(1));
    }
  ...
  public boolean isSetInputs() {
    return super.isSetInputs() || eIsSet(UMLPackage.READ_LINK_OBJECT_END_ACTION__OBJECT);
  }
  ...
  public boolean isSetOutputs() {
    return super.isSetOutputs() || eIsSet(UMLPackage.READ_LINK_OBJECT_END_ACTION__RESULT);
  }
