...
public class ReduceActionImpl extends ActionImpl implements ReduceAction {
    ...
    if (cache != null) {
      ...
      if (outputs == null) {
        cache.put(eResource, this, UMLPackage.Literals.ACTION__OUTPUT,
            outputs = new DerivedUnionEObjectEList<OutputPin>(OutputPin.class, this, UMLPackage.REDUCE_ACTION__OUTPUT,
                OUTPUT_ESUBSETS));
      }
      return outputs;
    }
    return new DerivedUnionEObjectEList<OutputPin>(OutputPin.class, this, UMLPackage.REDUCE_ACTION__OUTPUT,
        OUTPUT_ESUBSETS);
  }
    ...
    if (cache != null) {
      ...
      if (inputs == null) {
        cache.put(eResource, this, UMLPackage.Literals.ACTION__INPUT,
            inputs = new DerivedUnionEObjectEList<InputPin>(InputPin.class, this, UMLPackage.REDUCE_ACTION__INPUT,
                INPUT_ESUBSETS));
      }
      return inputs;
    }
    return new DerivedUnionEObjectEList<InputPin>(InputPin.class, this, UMLPackage.REDUCE_ACTION__INPUT,
        INPUT_ESUBSETS);
  }
    ...
    if (reducer != null && reducer.eIsProxy()) {
      ...
      if (reducer != oldReducer) {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, UMLPackage.REDUCE_ACTION__REDUCER, oldReducer,
              reducer));
      }
    }
    return reducer;
    ...
    if (result != null && result.eIsProxy()) {
      ...
      if (result != oldResult) {
        ...
        NotificationChain msgs = oldResult.eInverseRemove(this,
            EOPPOSITE_FEATURE_BASE - UMLPackage.REDUCE_ACTION__RESULT, null, null);
        if (newResult.eInternalContainer() == null) {
          msgs = newResult.eInverseAdd(this, EOPPOSITE_FEATURE_BASE - UMLPackage.REDUCE_ACTION__RESULT, null, msgs);
        }
        if (msgs != null)
          msgs.dispatch();
        if (eNotificationRequired())
          eNotify(
              new ENotificationImpl(this, Notification.RESOLVE, UMLPackage.REDUCE_ACTION__RESULT, oldResult, result));
      }
    }
    return result;
  }
  ...
  public NotificationChain basicSetResult(OutputPin newResult, NotificationChain msgs) {
    ...
    result = newResult;
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, UMLPackage.REDUCE_ACTION__RESULT,
          oldResult, newResult);
      if (msgs == null)
        msgs = notification;
      else
    ...
    if (newResult != result) {
      ...
      if (result != null)
        msgs = ((InternalEObject) result).eInverseRemove(this,
            EOPPOSITE_FEATURE_BASE - UMLPackage.REDUCE_ACTION__RESULT, null, msgs);
      if (newResult != null)
    ...
    if (collection != null && collection.eIsProxy()) {
      ...
      if (collection != oldCollection) {
        ...
        NotificationChain msgs = oldCollection.eInverseRemove(this,
            EOPPOSITE_FEATURE_BASE - UMLPackage.REDUCE_ACTION__COLLECTION, null, null);
        if (newCollection.eInternalContainer() == null) {
          msgs = newCollection.eInverseAdd(this, EOPPOSITE_FEATURE_BASE - UMLPackage.REDUCE_ACTION__COLLECTION, null,
              msgs);
        }
        if (msgs != null)
          msgs.dispatch();
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, UMLPackage.REDUCE_ACTION__COLLECTION, oldCollection,
              collection));
      }
    }
    return collection;
  ...
  public NotificationChain basicSetCollection(InputPin newCollection, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          UMLPackage.REDUCE_ACTION__COLLECTION, oldCollection, newCollection);
      if (msgs == null)
        msgs = notification;
      else
        msgs.add(notification);
    ...
    if (newCollection != collection) {
      ...
      if (collection != null)
        msgs = ((InternalEObject) collection).eInverseRemove(this,
            EOPPOSITE_FEATURE_BASE - UMLPackage.REDUCE_ACTION__COLLECTION, null, msgs);
      ...
      eNotify(new ENotificationImpl(this, Notification.SET, UMLPackage.REDUCE_ACTION__COLLECTION, newCollection,
          newCollection));
  }
  ...
  public void setIsOrdered(boolean newIsOrdered) {
    ...
    if (newIsOrdered)
      ...
      eFlags &= ~IS_ORDERED_EFLAG;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, UMLPackage.REDUCE_ACTION__IS_ORDERED, oldIsOrdered,
          newIsOrdered));
  }
   ...
   * @generated
   */
  public boolean validateInputTypeIsCollection(DiagnosticChain diagnostics, Map<Object, Object> context) {
   ...
   * @generated
   */
  public boolean validateOutputTypesAreCompatible(DiagnosticChain diagnostics, Map<Object, Object> context) {
   ...
   * @generated
   */
  public boolean validateReducerInputsOutput(DiagnosticChain diagnostics, Map<Object, Object> context) {
  ...
  public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
    ...
    case UMLPackage.REDUCE_ACTION___VALIDATE_OUTPUT_TYPES_ARE_COMPATIBLE__DIAGNOSTICCHAIN_MAP:
      return validateOutputTypesAreCompatible((DiagnosticChain) arguments.get(0),
          (Map<Object, Object>) arguments.get(1));
    }
  ...
  public boolean isSetInputs() {
    return super.isSetInputs() || eIsSet(UMLPackage.REDUCE_ACTION__COLLECTION);
  }
