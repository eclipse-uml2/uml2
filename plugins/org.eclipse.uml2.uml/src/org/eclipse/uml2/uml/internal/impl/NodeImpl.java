...
public class NodeImpl extends ClassImpl implements Node {
    ...
    if (cache != null) {
      ...
      if (ownedElements == null) {
        cache.put(eResource, this, UMLPackage.Literals.ELEMENT__OWNED_ELEMENT,
            ownedElements = new DerivedUnionEObjectEList<Element>(Element.class, this, UMLPackage.NODE__OWNED_ELEMENT,
                OWNED_ELEMENT_ESUBSETS));
      }
      return ownedElements;
    }
    return new DerivedUnionEObjectEList<Element>(Element.class, this, UMLPackage.NODE__OWNED_ELEMENT,
        OWNED_ELEMENT_ESUBSETS);
  }
  ...
  public EList<Deployment> getDeployments() {
    if (deployments == null) {
      deployments = new EObjectContainmentWithInverseEList.Resolving<Deployment>(Deployment.class, this,
          UMLPackage.NODE__DEPLOYMENT, UMLPackage.DEPLOYMENT__LOCATION);
    }
    return deployments;
  }
  ...
  public EList<NamedElement> getOwnedMembers() {
    ...
    return new DerivedUnionEObjectEList<NamedElement>(NamedElement.class, this, UMLPackage.NODE__OWNED_MEMBER,
  ...
  public EList<Node> getNestedNodes() {
    if (nestedNodes == null) {
      nestedNodes = new EObjectContainmentEList.Resolving<Node>(Node.class, this, UMLPackage.NODE__NESTED_NODE);
    }
    return nestedNodes;
  }
   ...
   * @generated
   */
  public Node getNestedNode(String name, boolean ignoreCase, EClass eClass, boolean createOnDemand) {
    nestedNodeLoop: for (Node nestedNode : getNestedNodes()) {
      if (eClass != null && !eClass.isInstance(nestedNode))
        continue nestedNodeLoop;
      if (name != null
          && !(ignoreCase ? name.equalsIgnoreCase(nestedNode.getName()) : name.equals(nestedNode.getName())))
        continue nestedNodeLoop;
      return nestedNode;
    }
   ...
   * @generated
   */
  public boolean validateInternalStructure(DiagnosticChain diagnostics, Map<Object, Object> context) {
   ...
   * @generated
   */
  public CommunicationPath createCommunicationPath(boolean end1IsNavigable, AggregationKind end1Aggregation,
      String end1Name, int end1Lower, int end1Upper, Node end1Node, boolean end2IsNavigable,
      AggregationKind end2Aggregation, String end2Name, int end2Lower, int end2Upper) {
    return NodeOperations.createCommunicationPath(this, end1IsNavigable, end1Aggregation, end1Name, end1Lower,
        end1Upper, end1Node, end2IsNavigable, end2Aggregation, end2Name, end2Lower, end2Upper);
  }
  ...
  public EList<CommunicationPath> getCommunicationPaths() {
    ...
    if (cache != null) {
      @SuppressWarnings("unchecked")
      EList<CommunicationPath> result = (EList<CommunicationPath>) cache.get(this,
          UMLPackage.Literals.NODE___GET_COMMUNICATION_PATHS);
      if (result == null) {
        cache.put(this, UMLPackage.Literals.NODE___GET_COMMUNICATION_PATHS,
    ...
    case UMLPackage.NODE__OWNED_TEMPLATE_SIGNATURE:
      if (ownedTemplateSignature != null)
        msgs = ((InternalEObject) ownedTemplateSignature).eInverseRemove(this,
            EOPPOSITE_FEATURE_BASE - UMLPackage.NODE__OWNED_TEMPLATE_SIGNATURE, null, msgs);
  ...
  public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
    ...
    case UMLPackage.NODE___CREATE_COMMUNICATION_PATH__BOOLEAN_AGGREGATIONKIND_STRING_INT_INT_NODE_BOOLEAN_AGGREGATIONKIND_STRING_INT_INT:
      return createCommunicationPath((Boolean) arguments.get(0), (AggregationKind) arguments.get(1),
          (String) arguments.get(2), (Integer) arguments.get(3), (Integer) arguments.get(4), (Node) arguments.get(5),
          (Boolean) arguments.get(6), (AggregationKind) arguments.get(7), (String) arguments.get(8),
          (Integer) arguments.get(9), (Integer) arguments.get(10));
   ...
   * @ordered
   */
  protected static final int[] OWNED_ELEMENT_ESUBSETS = new int[] { UMLPackage.NODE__OWNED_COMMENT,
      UMLPackage.NODE__NAME_EXPRESSION, UMLPackage.NODE__ELEMENT_IMPORT, UMLPackage.NODE__PACKAGE_IMPORT,
      UMLPackage.NODE__OWNED_MEMBER, UMLPackage.NODE__TEMPLATE_BINDING, UMLPackage.NODE__OWNED_TEMPLATE_SIGNATURE,
      UMLPackage.NODE__COLLABORATION_USE, UMLPackage.NODE__GENERALIZATION, UMLPackage.NODE__SUBSTITUTION,
  ...
  public boolean isSetOwnedElements() {
    return super.isSetOwnedElements() || eIsSet(UMLPackage.NODE__DEPLOYMENT);
  }
   ...
   * @ordered
   */
  protected static final int[] OWNED_MEMBER_ESUBSETS = new int[] { UMLPackage.NODE__OWNED_RULE,
      UMLPackage.NODE__OWNED_USE_CASE, UMLPackage.NODE__OWNED_ATTRIBUTE, UMLPackage.NODE__OWNED_CONNECTOR,
      UMLPackage.NODE__OWNED_BEHAVIOR, UMLPackage.NODE__OWNED_OPERATION, UMLPackage.NODE__NESTED_CLASSIFIER,
  ...
  public boolean isSetOwnedMembers() {
    return super.isSetOwnedMembers() || eIsSet(UMLPackage.NODE__NESTED_NODE);
  }
