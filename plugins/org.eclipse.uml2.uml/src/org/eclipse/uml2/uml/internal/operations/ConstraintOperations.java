 ...
 * @generated
 */
public class ConstraintOperations extends PackageableElementOperations {
   ...
   * @generated NOT
   */
  public static boolean validateNotApplyToSelf(Constraint constraint, DiagnosticChain diagnostics,
    ...
    if (constraint.getConstrainedElements().contains(constraint)) {
      ...
      if (diagnostics != null) {
        diagnostics.add(new BasicDiagnostic(Diagnostic.WARNING, UMLValidator.DIAGNOSTIC_SOURCE,
            ...
            UMLPlugin.INSTANCE.getString("_UI_Constraint_NotApplyToSelf_diagnostic", //$NON-NLS-1$
   ...
   * @generated
   */
  public static boolean validateBooleanValue(Constraint constraint, DiagnosticChain diagnostics,
      Map<Object, Object> context) {
        ...
        diagnostics.add(new BasicDiagnostic(Diagnostic.ERROR, UMLValidator.DIAGNOSTIC_SOURCE,
            ...
            org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", //$NON-NLS-1$
                new Object[] { "validateBooleanValue", //$NON-NLS-1$
                    org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(constraint, context) }), new Object[] { constraint }));
      }
      return false;
    }
    return true;
   ...
   * @generated
   */
  public static boolean validateNoSideEffects(Constraint constraint, DiagnosticChain diagnostics,
      Map<Object, Object> context) {
    // TODO: implement this method
    // -> specify the condition that violates the invariant
    // -> verify the details of the diagnostic, including severity and message
