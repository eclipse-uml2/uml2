...
public class ReplyActionImpl extends ActionImpl implements ReplyAction {
    ...
    if (cache != null) {
      ...
      if (inputs == null) {
        cache.put(eResource, this, UMLPackage.Literals.ACTION__INPUT,
            inputs = new DerivedUnionEObjectEList<InputPin>(InputPin.class, this, UMLPackage.REPLY_ACTION__INPUT,
                INPUT_ESUBSETS));
      }
      return inputs;
    }
    ...
    if (replyToCall != null && replyToCall.eIsProxy()) {
      ...
      if (replyToCall != oldReplyToCall) {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, UMLPackage.REPLY_ACTION__REPLY_TO_CALL,
  ...
  public void setReplyToCall(Trigger newReplyToCall) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, UMLPackage.REPLY_ACTION__REPLY_TO_CALL, oldReplyToCall,
          replyToCall));
  }
  ...
  public InputPin getReturnInformation() {
    if (returnInformation != null && returnInformation.eIsProxy()) {
      ...
      if (returnInformation != oldReturnInformation) {
        ...
        NotificationChain msgs = oldReturnInformation.eInverseRemove(this,
            EOPPOSITE_FEATURE_BASE - UMLPackage.REPLY_ACTION__RETURN_INFORMATION, null, null);
        if (newReturnInformation.eInternalContainer() == null) {
          msgs = newReturnInformation.eInverseAdd(this,
              EOPPOSITE_FEATURE_BASE - UMLPackage.REPLY_ACTION__RETURN_INFORMATION, null, msgs);
        }
        if (msgs != null)
          msgs.dispatch();
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, UMLPackage.REPLY_ACTION__RETURN_INFORMATION,
  ...
  public NotificationChain basicSetReturnInformation(InputPin newReturnInformation, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          UMLPackage.REPLY_ACTION__RETURN_INFORMATION, oldReturnInformation, newReturnInformation);
      if (msgs == null)
        msgs = notification;
      else
  ...
  public void setReturnInformation(InputPin newReturnInformation) {
    if (newReturnInformation != returnInformation) {
      ...
      if (returnInformation != null)
        msgs = ((InternalEObject) returnInformation).eInverseRemove(this,
            EOPPOSITE_FEATURE_BASE - UMLPackage.REPLY_ACTION__RETURN_INFORMATION, null, msgs);
      if (newReturnInformation != null)
        msgs = ((InternalEObject) newReturnInformation).eInverseAdd(this,
            EOPPOSITE_FEATURE_BASE - UMLPackage.REPLY_ACTION__RETURN_INFORMATION, null, msgs);
      msgs = basicSetReturnInformation(newReturnInformation, msgs);
      if (msgs != null)
        msgs.dispatch();
    } else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, UMLPackage.REPLY_ACTION__RETURN_INFORMATION,
   ...
   * @generated
   */
  public InputPin createReturnInformation(String name, Type type, EClass eClass) {
  ...
  public EList<InputPin> getReplyValues() {
    if (replyValues == null) {
      replyValues = new EObjectContainmentEList.Resolving<InputPin>(InputPin.class, this,
   ...
   * @generated
   */
  public InputPin getReplyValue(String name, Type type, boolean ignoreCase, EClass eClass, boolean createOnDemand) {
    replyValueLoop: for (InputPin replyValue : getReplyValues()) {
      if (eClass != null && !eClass.isInstance(replyValue))
        continue replyValueLoop;
      if (name != null
          && !(ignoreCase ? name.equalsIgnoreCase(replyValue.getName()) : name.equals(replyValue.getName())))
        continue replyValueLoop;
   ...
   * @generated
   */
  public boolean validatePinsMatchParameter(DiagnosticChain diagnostics, Map<Object, Object> context) {
   ...
   * @generated
   */
  public boolean validateEventOnReplyToCallTrigger(DiagnosticChain diagnostics, Map<Object, Object> context) {
  ...
  public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
    ...
    case UMLPackage.REPLY_ACTION___VALIDATE_EVENT_ON_REPLY_TO_CALL_TRIGGER__DIAGNOSTICCHAIN_MAP:
      return validateEventOnReplyToCallTrigger((DiagnosticChain) arguments.get(0),
          (Map<Object, Object>) arguments.get(1));
    }
   ...
   * @ordered
   */
  protected static final int[] INPUT_ESUBSETS = new int[] { UMLPackage.REPLY_ACTION__REPLY_VALUE,
  ...
  public boolean isSetInputs() {
    return super.isSetInputs() || eIsSet(UMLPackage.REPLY_ACTION__REPLY_VALUE)
