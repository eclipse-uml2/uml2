...
public class DeploymentImpl extends DependencyImpl implements Deployment {
  ...
  public EList<Element> getOwnedElements() {
    ...
    return new DerivedUnionEObjectEList<Element>(Element.class, this, UMLPackage.DEPLOYMENT__OWNED_ELEMENT,
  ...
  private EList<NamedElement> createSuppliersList() {
    return new SubsetSupersetEObjectResolvingEList<NamedElement>(NamedElement.class, this,
        UMLPackage.DEPLOYMENT__SUPPLIER, null, SUPPLIER_ESUBSETS);
  }
  ...
  private EList<NamedElement> createClientsList() {
    return new SubsetSupersetEObjectResolvingEList<NamedElement>(NamedElement.class, this,
        UMLPackage.DEPLOYMENT__CLIENT, null, CLIENT_ESUBSETS);
  }
  ...
  private EList<DeployedArtifact> createDeployedArtifactsList() {
    return new SubsetSupersetEObjectResolvingEList<DeployedArtifact>(DeployedArtifact.class, this,
        UMLPackage.DEPLOYMENT__DEPLOYED_ARTIFACT, DEPLOYED_ARTIFACT_ESUPERSETS, null);
  }
  ...
  public EList<DeploymentSpecification> getConfigurations() {
    if (configurations == null) {
      configurations = new EObjectContainmentWithInverseEList.Resolving<DeploymentSpecification>(
          DeploymentSpecification.class, this, UMLPackage.DEPLOYMENT__CONFIGURATION,
   ...
   * @generated
   */
  public DeploymentSpecification getConfiguration(String name, boolean ignoreCase, boolean createOnDemand) {
    configurationLoop: for (DeploymentSpecification configuration : getConfigurations()) {
      if (name != null
          && !(ignoreCase ? name.equalsIgnoreCase(configuration.getName()) : name.equals(configuration.getName())))
  ...
  public void setLocation(DeploymentTarget newLocation) {
    if (newLocation != eInternalContainer()
      ...
      if (newLocation != null)
        msgs = ((InternalEObject) newLocation).eInverseAdd(this, UMLPackage.DEPLOYMENT_TARGET__DEPLOYMENT,
  ...
  public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
    ...
    case UMLPackage.DEPLOYMENT__LOCATION:
      return eInternalContainer().eInverseRemove(this, UMLPackage.DEPLOYMENT_TARGET__DEPLOYMENT, DeploymentTarget.class,
          msgs);
    }
   ...
   * @ordered
   */
  protected static final int[] OWNED_ELEMENT_ESUBSETS = new int[] { UMLPackage.DEPLOYMENT__OWNED_COMMENT,
      UMLPackage.DEPLOYMENT__NAME_EXPRESSION, UMLPackage.DEPLOYMENT__CONFIGURATION };
  ...
  public DeployedArtifact getDeployedArtifact(String name, boolean ignoreCase, EClass eClass) {
    deployedArtifactLoop: for (DeployedArtifact deployedArtifact : getDeployedArtifacts()) {
      ...
      if (name != null && !(ignoreCase ? name.equalsIgnoreCase(deployedArtifact.getName())
  ...
  public boolean isSetOwnedElements() {
    return super.isSetOwnedElements() || eIsSet(UMLPackage.DEPLOYMENT__CONFIGURATION);
  }
