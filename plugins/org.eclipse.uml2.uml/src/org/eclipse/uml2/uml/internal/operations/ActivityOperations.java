 ...
 * @generated
 */
public class ActivityOperations extends BehaviorOperations {
   ...
   * @generated
   */
  public static boolean validateMaximumOneParameterNode(Activity activity, DiagnosticChain diagnostics,
        ...
        diagnostics.add(new BasicDiagnostic(Diagnostic.ERROR, UMLValidator.DIAGNOSTIC_SOURCE,
            ...
            org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", //$NON-NLS-1$
                new Object[] { "validateMaximumOneParameterNode", //$NON-NLS-1$
                    org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(activity, context) }), new Object[] { activity }));
      }
      return false;
    }
    return true;
   ...
   * @generated
   */
  public static boolean validateMaximumTwoParameterNodes(Activity activity, DiagnosticChain diagnostics,
      Map<Object, Object> context) {
    // TODO: implement this method
    // -> specify the condition that violates the invariant
    // -> verify the details of the diagnostic, including severity and message
