...
public class ManifestationImpl extends AbstractionImpl implements Manifestation {
  ...
  private EList<NamedElement> createSuppliersList() {
    return new SubsetSupersetEObjectResolvingEList<NamedElement>(NamedElement.class, this,
        UMLPackage.MANIFESTATION__SUPPLIER, null, SUPPLIER_ESUBSETS);
  }
    ...
    if (utilizedElement != null && utilizedElement.eIsProxy()) {
      ...
      if (utilizedElement != oldUtilizedElement) {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, UMLPackage.MANIFESTATION__UTILIZED_ELEMENT,
  ...
  public void setUtilizedElement(PackageableElement newUtilizedElement) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, UMLPackage.MANIFESTATION__UTILIZED_ELEMENT,
          oldUtilizedElement, utilizedElement));
