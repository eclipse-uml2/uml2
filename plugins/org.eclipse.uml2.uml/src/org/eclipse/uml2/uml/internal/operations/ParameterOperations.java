...
public class ParameterOperations extends ConnectableElementOperations {
  ...
  public static boolean validateConnectorEnd(Parameter parameter, DiagnosticChain diagnostics,
    ...
    if (false) {
      if (diagnostics != null) {
        diagnostics.add(
            new BasicDiagnostic(Diagnostic.ERROR, UMLValidator.DIAGNOSTIC_SOURCE, UMLValidator.PARAMETER__CONNECTOR_END,
                org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", //$NON-NLS-1$
                    new Object[] { "validateConnectorEnd", //$NON-NLS-1$
                        org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(parameter, context) }), new Object[] { parameter }));
      }
      return false;
    }
    return true;
  ...
  public static boolean validateObjectEffect(Parameter parameter, DiagnosticChain diagnostics,
    ...
    if (false) {
      if (diagnostics != null) {
        diagnostics.add(
            new BasicDiagnostic(Diagnostic.ERROR, UMLValidator.DIAGNOSTIC_SOURCE, UMLValidator.PARAMETER__OBJECT_EFFECT,
                org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", //$NON-NLS-1$
  ...
  public static boolean validateNotException(Parameter parameter, DiagnosticChain diagnostics,
    ...
    if (false) {
      if (diagnostics != null) {
        diagnostics.add(
            new BasicDiagnostic(Diagnostic.ERROR, UMLValidator.DIAGNOSTIC_SOURCE, UMLValidator.PARAMETER__NOT_EXCEPTION,
                org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", //$NON-NLS-1$
  ...
  public static boolean validateInAndOut(Parameter parameter, DiagnosticChain diagnostics,
    ...
    if (false) {
      if (diagnostics != null) {
        diagnostics.add(
            new BasicDiagnostic(Diagnostic.ERROR, UMLValidator.DIAGNOSTIC_SOURCE, UMLValidator.PARAMETER__IN_AND_OUT,
                org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", //$NON-NLS-1$
  ...
  public static void setBooleanDefaultValue(Parameter parameter, boolean value) {
    ...
    ((LiteralBoolean) (defaultValue instanceof LiteralBoolean ? defaultValue
        : parameter.createDefaultValue(null, null, UMLPackage.Literals.LITERAL_BOOLEAN))).setValue(value);
  }
  ...
  public static void setIntegerDefaultValue(Parameter parameter, int value) {
    ...
    ((LiteralInteger) (defaultValue instanceof LiteralInteger ? defaultValue
        : parameter.createDefaultValue(null, null, UMLPackage.Literals.LITERAL_INTEGER))).setValue(value);
  }
  ...
  public static void setStringDefaultValue(Parameter parameter, String value) {
    ...
    ((LiteralString) (defaultValue instanceof LiteralString ? defaultValue
        : parameter.createDefaultValue(null, null, UMLPackage.Literals.LITERAL_STRING))).setValue(value);
  }
  ...
  public static void setUnlimitedNaturalDefaultValue(Parameter parameter, int value) {
    ...
    ((LiteralUnlimitedNatural) (defaultValue instanceof LiteralUnlimitedNatural ? defaultValue
        : parameter.createDefaultValue(null, null, UMLPackage.Literals.LITERAL_UNLIMITED_NATURAL))).setValue(value);
  }
  ...
  public static void setRealDefaultValue(Parameter parameter, double value) {
    ...
    ((LiteralReal) (defaultValue instanceof LiteralReal ? defaultValue
        : parameter.createDefaultValue(null, null, UMLPackage.Literals.LITERAL_REAL))).setValue(value);
  }

  protected static boolean matches(Parameter parameter, Parameter otherParameter) {
    Type type = parameter.getType();
    Type otherType = otherParameter.getType();

    return safeEquals(parameter.getName(), otherParameter.getName())
        && (type == null ? otherType == null : type.conformsTo(otherType))
        && safeEquals(parameter.getEffect(), otherParameter.getEffect())
        && safeEquals(parameter.getDirection(), otherParameter.getDirection())
        && parameter.isException() == otherParameter.isException()
        && parameter.isOrdered() == otherParameter.isOrdered() && parameter.isStream() == otherParameter.isStream()
        && parameter.isUnique() == otherParameter.isUnique() && parameter.getLower() == otherParameter.getLower()
