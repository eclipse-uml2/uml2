...
public class OccurrenceSpecificationImpl extends InteractionFragmentImpl implements OccurrenceSpecification {
  ...
  public EList<GeneralOrdering> getToBefores() {
    if (toBefores == null) {
      toBefores = new EObjectWithInverseResolvingEList<GeneralOrdering>(GeneralOrdering.class, this,
          UMLPackage.OCCURRENCE_SPECIFICATION__TO_BEFORE, UMLPackage.GENERAL_ORDERING__AFTER);
    }
    return toBefores;
  }
  ...
  public EList<GeneralOrdering> getToAfters() {
    if (toAfters == null) {
      toAfters = new EObjectWithInverseResolvingEList<GeneralOrdering>(GeneralOrdering.class, this,
          UMLPackage.OCCURRENCE_SPECIFICATION__TO_AFTER, UMLPackage.GENERAL_ORDERING__BEFORE);
    }
    return toAfters;
  }
  ...
  public EList<Lifeline> getCovereds() {
    if (covereds == null) {
      covereds = new EObjectWithInverseResolvingEList.ManyInverse<Lifeline>(Lifeline.class, this,
          UMLPackage.OCCURRENCE_SPECIFICATION__COVERED, UMLPackage.LIFELINE__COVERED_BY);
    }
    return covereds;
  }
