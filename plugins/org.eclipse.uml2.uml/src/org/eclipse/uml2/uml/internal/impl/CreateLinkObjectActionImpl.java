...
public class CreateLinkObjectActionImpl extends CreateLinkActionImpl implements CreateLinkObjectAction {
  ...
  public EList<OutputPin> getOutputs() {
    ...
    return new DerivedUnionEObjectEList<OutputPin>(OutputPin.class, this, UMLPackage.CREATE_LINK_OBJECT_ACTION__OUTPUT,
        OUTPUT_ESUBSETS);
  }
    ...
    if (result != null && result.eIsProxy()) {
      ...
      if (result != oldResult) {
        ...
        NotificationChain msgs = oldResult.eInverseRemove(this,
            EOPPOSITE_FEATURE_BASE - UMLPackage.CREATE_LINK_OBJECT_ACTION__RESULT, null, null);
        if (newResult.eInternalContainer() == null) {
          msgs = newResult.eInverseAdd(this, EOPPOSITE_FEATURE_BASE - UMLPackage.CREATE_LINK_OBJECT_ACTION__RESULT,
              null, msgs);
        }
        if (msgs != null)
          msgs.dispatch();
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, UMLPackage.CREATE_LINK_OBJECT_ACTION__RESULT,
              oldResult, result));
      }
    }
    return result;
  ...
  public NotificationChain basicSetResult(OutputPin newResult, NotificationChain msgs) {
    ...
    if (eNotificationRequired()) {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
          UMLPackage.CREATE_LINK_OBJECT_ACTION__RESULT, oldResult, newResult);
      if (msgs == null)
        msgs = notification;
      else
    ...
    if (newResult != result) {
      ...
      if (result != null)
        msgs = ((InternalEObject) result).eInverseRemove(this,
            EOPPOSITE_FEATURE_BASE - UMLPackage.CREATE_LINK_OBJECT_ACTION__RESULT, null, msgs);
      if (newResult != null)
      ...
      eNotify(new ENotificationImpl(this, Notification.SET, UMLPackage.CREATE_LINK_OBJECT_ACTION__RESULT, newResult,
          newResult));
  }
   ...
   * @generated
   */
  public boolean validateAssociationClass(DiagnosticChain diagnostics, Map<Object, Object> context) {
  ...
  public boolean isSetOutputs() {
    return super.isSetOutputs() || eIsSet(UMLPackage.CREATE_LINK_OBJECT_ACTION__RESULT);
  }
