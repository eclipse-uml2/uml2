...
public class ClassOperations extends EncapsulatedClassifierOperations {
  ...
  public static boolean validatePassiveClass(org.eclipse.uml2.uml.Class class_, DiagnosticChain diagnostics,
    ...
    if (!class_.isActive() && !(class_.getOwnedReceptions().isEmpty() && class_.getClassifierBehavior() == null)) {

      if (diagnostics != null) {
        diagnostics.add(new BasicDiagnostic(Diagnostic.WARNING, UMLValidator.DIAGNOSTIC_SOURCE,
            UMLValidator.CLASS__PASSIVE_CLASS, UMLPlugin.INSTANCE.getString("_UI_Class_PassiveClass_diagnostic", //$NON-NLS-1$
  ...
  public static EList<Extension> getExtensions(org.eclipse.uml2.uml.Class class_) {
    ...
    return new UnionEObjectEList<Extension>((InternalEObject) class_, UMLPackage.Literals.CLASS__EXTENSION,
        extensions.size(), extensions.toArray());
  }

  protected static EList<Extension> getExtensions(org.eclipse.uml2.uml.Class class_, EList<Extension> extensions) {
  ...
  public static Operation createOwnedOperation(org.eclipse.uml2.uml.Class class_, String name,
    ...
    return TypeOperations.createOwnedOperation(class_, name, parameterNames, parameterTypes, returnType);
  }
