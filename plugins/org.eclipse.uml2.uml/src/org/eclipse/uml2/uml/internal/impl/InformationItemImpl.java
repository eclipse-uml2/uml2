...
public class InformationItemImpl extends ClassifierImpl implements InformationItem {
  ...
  public EList<Classifier> getRepresenteds() {
    if (representeds == null) {
      representeds = new EObjectResolvingEList<Classifier>(Classifier.class, this,
  ...
  public Classifier getRepresented(String name, boolean ignoreCase, EClass eClass) {
    representedLoop: for (Classifier represented : getRepresenteds()) {
      ...
      if (name != null
          && !(ignoreCase ? name.equalsIgnoreCase(represented.getName()) : name.equals(represented.getName())))
        continue representedLoop;
      return represented;
    }
    return null;
   ...
   * @generated
   */
  public boolean validateSourcesAndTargets(DiagnosticChain diagnostics, Map<Object, Object> context) {
   ...
   * @generated
   */
  public boolean validateHasNo(DiagnosticChain diagnostics, Map<Object, Object> context) {
   ...
   * @generated
   */
  public boolean validateNotInstantiable(DiagnosticChain diagnostics, Map<Object, Object> context) {
