...
public class StereotypeImpl extends ClassImpl implements Stereotype {
  ...
  public EList<Element> getOwnedElements() {
    ...
    return new DerivedUnionEObjectEList<Element>(Element.class, this, UMLPackage.STEREOTYPE__OWNED_ELEMENT,
   ...
   * @ordered
   */
  protected static final int[] OWNED_ELEMENT_ESUBSETS = new int[] { UMLPackage.STEREOTYPE__OWNED_COMMENT,
      UMLPackage.STEREOTYPE__NAME_EXPRESSION, UMLPackage.STEREOTYPE__ELEMENT_IMPORT,
      UMLPackage.STEREOTYPE__PACKAGE_IMPORT, UMLPackage.STEREOTYPE__OWNED_MEMBER,
      UMLPackage.STEREOTYPE__TEMPLATE_BINDING, UMLPackage.STEREOTYPE__OWNED_TEMPLATE_SIGNATURE,
      UMLPackage.STEREOTYPE__COLLABORATION_USE, UMLPackage.STEREOTYPE__GENERALIZATION,
      UMLPackage.STEREOTYPE__SUBSTITUTION, UMLPackage.STEREOTYPE__INTERFACE_REALIZATION, UMLPackage.STEREOTYPE__ICON };
  ...
  public EList<Image> getIcons() {
    if (icons == null) {
      icons = new EObjectContainmentEList.Resolving<Image>(Image.class, this, UMLPackage.STEREOTYPE__ICON);
    }
    return icons;
  }
   ...
   * @generated
   */
  public boolean validateNameNotClash(DiagnosticChain diagnostics, Map<Object, Object> context) {
   ...
   * @generated
   */
  public boolean validateAssociationEndOwnership(DiagnosticChain diagnostics, Map<Object, Object> context) {
   ...
   * @generated
   */
  public boolean validateBasePropertyUpperBound(DiagnosticChain diagnostics, Map<Object, Object> context) {
   ...
   * @generated
   */
  public boolean validateBasePropertyMultiplicitySingleExtension(DiagnosticChain diagnostics,
   ...
   * @generated
   */
  public boolean validateBasePropertyMultiplicityMultipleExtension(DiagnosticChain diagnostics,
      Map<Object, Object> context) {
   ...
   * @generated
   */
  public boolean validateGeneralize(DiagnosticChain diagnostics, Map<Object, Object> context) {
   ...
   * @generated
   */
  public Extension createExtension(org.eclipse.uml2.uml.Class metaclass, boolean isRequired) {
   ...
   * @generated
   */
  public boolean validateBinaryAssociationsOnly(DiagnosticChain diagnostics, Map<Object, Object> context) {
  ...
  public EList<org.eclipse.uml2.uml.Class> getExtendedMetaclasses() {
    ...
    if (cache != null) {
      @SuppressWarnings("unchecked")
      EList<org.eclipse.uml2.uml.Class> result = (EList<org.eclipse.uml2.uml.Class>) cache.get(this,
          UMLPackage.Literals.STEREOTYPE___GET_EXTENDED_METACLASSES);
      if (result == null) {
        cache.put(this, UMLPackage.Literals.STEREOTYPE___GET_EXTENDED_METACLASSES,
  ...
  public EList<org.eclipse.uml2.uml.Class> getAllExtendedMetaclasses() {
    ...
    if (cache != null) {
      ...
      if (result == null) {
        cache.put(this, UMLPackage.Literals.STEREOTYPE___GET_ALL_EXTENDED_METACLASSES,
            result = StereotypeOperations.getAllExtendedMetaclasses(this));
      }
      return result;
    }
  ...
  public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
    ...
    case UMLPackage.STEREOTYPE___VALIDATE_ASSOCIATION_END_OWNERSHIP__DIAGNOSTICCHAIN_MAP:
      return validateAssociationEndOwnership((DiagnosticChain) arguments.get(0),
          (Map<Object, Object>) arguments.get(1));
    ...
    case UMLPackage.STEREOTYPE___VALIDATE_BASE_PROPERTY_MULTIPLICITY_SINGLE_EXTENSION__DIAGNOSTICCHAIN_MAP:
      return validateBasePropertyMultiplicitySingleExtension((DiagnosticChain) arguments.get(0),
          (Map<Object, Object>) arguments.get(1));
    case UMLPackage.STEREOTYPE___VALIDATE_BASE_PROPERTY_MULTIPLICITY_MULTIPLE_EXTENSION__DIAGNOSTICCHAIN_MAP:
      return validateBasePropertyMultiplicityMultipleExtension((DiagnosticChain) arguments.get(0),
          (Map<Object, Object>) arguments.get(1));
  ...
  public boolean isSetOwnedElements() {
    return super.isSetOwnedElements() || eIsSet(UMLPackage.STEREOTYPE__ICON);
  }
