...
public class NodeOperations extends ClassOperations {
   ...
   * @generated
   */
  public static boolean validateInternalStructure(Node node, DiagnosticChain diagnostics, Map<Object, Object> context) {
    ...
    if (false) {
      if (diagnostics != null) {
        diagnostics.add(
            new BasicDiagnostic(Diagnostic.ERROR, UMLValidator.DIAGNOSTIC_SOURCE, UMLValidator.NODE__INTERNAL_STRUCTURE,
                org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", //$NON-NLS-1$
                    new Object[] { "validateInternalStructure", //$NON-NLS-1$
                        org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(node, context) }), new Object[] { node }));
      }
      return false;
    }
    return true;
   ...
   * @generated NOT
   */
  public static CommunicationPath createCommunicationPath(Node node, boolean end1IsNavigable,
      AggregationKind end1Aggregation, String end1Name, int end1Lower, int end1Upper, Node end1Node,
      boolean end2IsNavigable, AggregationKind end2Aggregation, String end2Name, int end2Lower, int end2Upper) {
    return (CommunicationPath) TypeOperations.createAssociation(node, end1IsNavigable, end1Aggregation, end1Name,
        end1Lower, end1Upper, end1Node, end2IsNavigable, end2Aggregation, end2Name, end2Lower, end2Upper,
        UMLPackage.Literals.COMMUNICATION_PATH);
  }
