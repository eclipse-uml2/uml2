/*
 * Copyright (c) 2005, 2024 IBM Corporation, CEA, and others.
...
public abstract class ElementImpl extends EModelElementImpl implements Element {
  ...
  public EList<Element> getOwnedElements() {
    ...
    return new DerivedUnionEObjectEList<Element>(Element.class, this, UMLPackage.ELEMENT__OWNED_ELEMENT,
  ...
  public EList<Comment> getOwnedComments() {
    if (ownedComments == null) {
      ownedComments = new EObjectContainmentEList.Resolving<Comment>(Comment.class, this,
  ...
  public EList<EObject> getStereotypeApplications() {
    StereotypeApplicationStorage storage = UMLUtil.isStereotypeApplicationStorageEnabled()
  ...
  public EList<Stereotype> getAppliedStereotypes() {
    ...
    if (storage != null) {
      ...
      for (EObject stereotypeApplication : storage.getStereotypeApplications(this)) {
        appliedStereotypes.add(UMLUtil.getStereotype(stereotypeApplication));
      }
  ...
  static {
    ...
    try {
      changeDescriptionClass = CommonPlugin.loadClass("org.eclipse.emf.ecore.change", //$NON-NLS-1$
  ...
  public NotificationChain eBasicSetContainer(InternalEObject newContainer, int newContainerFeatureID,
    ...
    if (CHANGE_DESCRIPTION_CLASS == null || !(CHANGE_DESCRIPTION_CLASS.isInstance(newContainer))) {
