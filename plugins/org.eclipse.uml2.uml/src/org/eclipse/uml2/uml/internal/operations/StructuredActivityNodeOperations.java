...
public class StructuredActivityNodeOperations extends ActionOperations {
   ...
   * @generated
   */
  public static boolean validateOutputPinEdges(StructuredActivityNode structuredActivityNode,
        ...
        diagnostics.add(new BasicDiagnostic(Diagnostic.ERROR, UMLValidator.DIAGNOSTIC_SOURCE,
            ...
            org.eclipse.emf.ecore.plugin.EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", //$NON-NLS-1$
                new Object[] { "validateOutputPinEdges", //$NON-NLS-1$
                    org.eclipse.emf.ecore.util.EObjectValidator.getObjectLabel(structuredActivityNode, context) }), new Object[] { structuredActivityNode }));
      }
      return false;
    }
    return true;
   ...
   * @generated
   */
  public static boolean validateEdges(StructuredActivityNode structuredActivityNode, DiagnosticChain diagnostics,
   ...
   * @generated
   */
  public static boolean validateInputPinEdges(StructuredActivityNode structuredActivityNode,
      DiagnosticChain diagnostics, Map<Object, Object> context) {
    // TODO: implement this method
    // -> specify the condition that violates the invariant
    // -> verify the details of the diagnostic, including severity and message
  ...
  public static EList<ActivityNode> allOwnedNodes(StructuredActivityNode structuredActivityNode) {
    ...
    allOwnedNodes.addAll(ActionOperations.allOwnedNodes(structuredActivityNode));
