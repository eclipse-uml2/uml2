...
public class LinkEndDestructionDataImpl extends LinkEndDataImpl implements LinkEndDestructionData {
  ...
  public void setIsDestroyDuplicates(boolean newIsDestroyDuplicates) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, UMLPackage.LINK_END_DESTRUCTION_DATA__IS_DESTROY_DUPLICATES,
   ...
   * @generated
   */
  public boolean validateDestroyAtPin(DiagnosticChain diagnostics, Map<Object, Object> context) {
  ...
  public InputPin getDestroyAt() {
    if (destroyAt != null && destroyAt.eIsProxy()) {
      ...
      if (destroyAt != oldDestroyAt) {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, UMLPackage.LINK_END_DESTRUCTION_DATA__DESTROY_AT,
  ...
  public void setDestroyAt(InputPin newDestroyAt) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, UMLPackage.LINK_END_DESTRUCTION_DATA__DESTROY_AT,
          oldDestroyAt, destroyAt));
  }
