 ...
 * @generated
 */
public interface Artifact extends Classifier, DeployedArtifact, AttributeOwner, OperationOwner {
   ...
   * @generated
   */
  Manifestation getManifestation(String name, PackageableElement utilizedElement, boolean ignoreCase,
