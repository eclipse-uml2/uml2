...
public interface Operation extends BehavioralFeature, ParameterableElement, TemplateableElement {
   ...
   * @generated
   */
  Operation getRedefinedOperation(String name, EList<String> ownedParameterNames, EList<Type> ownedParameterTypes);
   ...
   * @generated
   */
  boolean validateAtMostOneReturn(DiagnosticChain diagnostics, Map<Object, Object> context);
   ...
   * @generated
   */
  boolean validateOnlyBodyForQuery(DiagnosticChain diagnostics, Map<Object, Object> context);
