...
public class AbstractionItemProvider
	...
	public Object getImage(Object object) {
		return overlayImage(object,
			getResourceLocator().getImage("full/obj16/Abstraction")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		StringBuffer text = appendType(
			appendKeywords(new StringBuffer(), object), "_UI_Abstraction_type"); //$NON-NLS-1$
		...
		if (!UML2Util.isEmpty(label)) {
			...
			for (Iterator<NamedElement> suppliers = abstraction.getSuppliers()
