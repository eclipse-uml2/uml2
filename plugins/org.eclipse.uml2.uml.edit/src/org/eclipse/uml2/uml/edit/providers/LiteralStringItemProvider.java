 ...
 *   Kenn Hussey - 323181
 *   Kenn Hussey (CEA) - 414970, 370089, 464702
 *
 */
...
/**
 * This is the item provider adapter for a {@link org.eclipse.uml2.uml.LiteralString} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LiteralStringItemProvider
	...
	public Object getImage(Object object) {
		return overlayImage(object,
			getResourceLocator().getImage("full/obj16/LiteralString")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		StringBuffer text = appendType(
			...
			"_UI_LiteralString_type"); //$NON-NLS-1$

		LiteralString literalString = (LiteralString) object;
		String label = literalString.getLabel(shouldTranslate());
