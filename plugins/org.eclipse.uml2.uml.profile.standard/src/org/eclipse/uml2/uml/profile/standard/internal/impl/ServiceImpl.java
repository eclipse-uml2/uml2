 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.uml2.uml.profile.standard.internal.impl.ServiceImpl#getBase_Component <em>Base Component</em>}</li>
 * </ul>
 *
 * @generated
 */
			...
			if (base_Component != oldBase_Component) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
						StandardPackage.SERVICE__BASE_COMPONENT,
	...
	public void setBase_Component(Component newBase_Component) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
				StandardPackage.SERVICE__BASE_COMPONENT, oldBase_Component,
				base_Component));
	}
