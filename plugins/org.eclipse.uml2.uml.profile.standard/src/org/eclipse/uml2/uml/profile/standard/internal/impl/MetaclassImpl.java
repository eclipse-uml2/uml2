 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.uml2.uml.profile.standard.internal.impl.MetaclassImpl#getBase_Class <em>Base Class</em>}</li>
 * </ul>
 *
 * @generated
 */
			...
			if (base_Class != oldBase_Class) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
						StandardPackage.METACLASS__BASE_CLASS, oldBase_Class,
						base_Class));
			}
		}
		return base_Class;
