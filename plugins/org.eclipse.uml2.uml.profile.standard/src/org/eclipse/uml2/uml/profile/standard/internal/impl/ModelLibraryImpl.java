 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.uml2.uml.profile.standard.internal.impl.ModelLibraryImpl#getBase_Package <em>Base Package</em>}</li>
 * </ul>
 *
 * @generated
 */
			...
			if (base_Package != oldBase_Package) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
						StandardPackage.MODEL_LIBRARY__BASE_PACKAGE,
	...
	public void setBase_Package(org.eclipse.uml2.uml.Package newBase_Package) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
				StandardPackage.MODEL_LIBRARY__BASE_PACKAGE, oldBase_Package,
				base_Package));
	}
